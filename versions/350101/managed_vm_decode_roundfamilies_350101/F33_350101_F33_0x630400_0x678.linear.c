...
L_000b:
    /* +0x00108 op=0x01 09 09 5b 00 XOR_IMM16: s9 = s9 ^ 0x5b */
    S[9] = S[9] ^ 0x5b;
...
L_000e:
    /* +0x00150 op=0x01 09 09 8d 00 XOR_IMM16: s9 = s9 ^ 0x8d */
    S[9] = S[9] ^ 0x8d;
...
L_0011:
    /* +0x00198 op=0x01 09 09 63 00 XOR_IMM16: s9 = s9 ^ 0x63 */
    S[9] = S[9] ^ 0x63;
...
L_0014:
    /* +0x001e0 op=0x01 08 08 d4 00 XOR_IMM16: s8 = s8 ^ 0xd4 */
    S[8] = S[8] ^ 0xd4;
...
L_0017:
    /* +0x00228 op=0x54 02 01 63 d4 CONST_HI16: s1 = sign_extend_32(0xd463 << 16) */
    S[1] = (int32_t)(0xd463 << 16);
...
L_001c:
    /* +0x002a0 op=0x85 06 06 84 04 ADD64_IMM16: s6 = s6 +0x484 */
    S[6] = S[6] + 0x484;

L_001d:
    /* +0x002b8 op=0x33 01 07 5b 8d OR_IMM16: s7 = s1 | 0x8d5b */
    S[7] = S[1] | 0x8d5b;
...
L_0029:
    /* +0x003d8 op=0x84 06 09 09 14 ADD64: s9 = s6 + s9 */
    S[9] = S[6] + S[9];

L_002a:
    /* +0x003f0 op=0x84 06 08 0a 00 ADD64: s10 = s6 + s8 */
    S[10] = S[6] + S[8];
...
L_002c:
    /* +0x00420 op=0x84 06 01 01 04 ADD64: s1 = s6 + s1 */
    S[1] = S[6] + S[1];
...
L_0038:
    /* +0x00540 op=0x02 01 0b 01 00 XOR64: s1 = s11 ^ s1 */
    S[1] = S[11] ^ S[1];
...
L_003a:
    /* +0x00570 op=0x02 0c 0a 0a 01 XOR64: s10 = s10 ^ s12 */
    S[10] = S[10] ^ S[12];
