...
0007  +0x000a8  op=34  1d 00 1e 01  OR64             s30 = s29 | s0
...
000d  +0x00138  op=5e  87 00 00 00  CALL_CF_INDEX    call native_binding[index=0x87] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
0011  +0x00198  op=5e  88 00 00 00  CALL_CF_INDEX    call native_binding[index=0x88] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0012  +0x001b0  op=34  11 00 04 01  OR64             s4 = s17 | s0
0013  +0x001c8  op=5e  89 00 00 00  CALL_CF_INDEX    call native_binding[index=0x89] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0014  +0x001e0  op=b2  12 01 ff 00  AND64_IMM16      s1 = s18 & 0xff
0015  +0x001f8  op=ae  01 13 08 00  BR_EQ64          if (s1 == s19) goto record +30
0016  +0x00210  op=34  11 00 04 00  OR64             s4 = s17 | s0
0017  +0x00228  op=5e  8a 00 00 00  CALL_CF_INDEX    call native_binding[index=0x8a] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0018  +0x00240  op=34  12 00 04 01  OR64             s4 = s18 | s0
0019  +0x00258  op=34  11 00 05 00  OR64             s5 = s17 | s0
001a  +0x00270  op=34  10 00 06 01  OR64             s6 = s16 | s0
001b  +0x00288  op=5e  87 00 00 00  CALL_CF_INDEX    call native_binding[index=0x87] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
0020  +0x00300  op=34  10 00 06 00  OR64             s6 = s16 | s0
0021  +0x00318  op=5e  87 00 00 00  CALL_CF_INDEX    call native_binding[index=0x87] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0022  +0x00330  op=34  1e 00 1d 00  OR64             s29 = s30 | s0
