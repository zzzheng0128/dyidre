...
L_0000:
    /* +0x00000 op=0x53 01 01 08 03 LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0x308 q1=0x125fd408 */
...
L_0007:
    /* +0x000a8 op=0x84 03 05 08 00 ADD64: s8 = s3 + s5 */
    S[8] = S[3] + S[5];
...
L_000b:
    /* +0x00108 op=0x01 09 09 3b 00 XOR_IMM16: s9 = s9 ^ 0x3b */
    S[9] = S[9] ^ 0x3b;
...
L_000e:
    /* +0x00150 op=0x01 09 09 f7 00 XOR_IMM16: s9 = s9 ^ 0xf7 */
    S[9] = S[9] ^ 0xf7;
...
L_0011:
    /* +0x00198 op=0x01 09 09 a5 00 XOR_IMM16: s9 = s9 ^ 0xa5 */
    S[9] = S[9] ^ 0xa5;
...
L_0014:
    /* +0x001e0 op=0x01 08 08 92 00 XOR_IMM16: s8 = s8 ^ 0x92 */
    S[8] = S[8] ^ 0x92;
...
L_0017:
    /* +0x00228 op=0x54 02 01 a5 92 CONST_HI16: s1 = sign_extend_32(0x92a5 << 16) */
    S[1] = (int32_t)(0x92a5 << 16);
...
L_001c:
    /* +0x002a0 op=0x85 06 06 85 05 ADD64_IMM16: s6 = s6 +0x585 */
    S[6] = S[6] + 0x585;

L_001d:
    /* +0x002b8 op=0x33 01 07 3b f7 OR_IMM16: s7 = s1 | 0xf73b */
    S[7] = S[1] | 0xf73b;
...
L_0030:
    /* +0x00480 op=0x84 06 0c 01 14 ADD64: s1 = s6 + s12 */
    S[1] = S[6] + S[12];
...
L_0032:
    /* +0x004b0 op=0x02 09 08 08 00 XOR64: s8 = s8 ^ s9 */
    S[8] = S[8] ^ S[9];
...
L_003b:
    /* +0x00588 op=0x02 0b 09 09 01 XOR64: s9 = s9 ^ s11 */
    S[9] = S[9] ^ S[11];
