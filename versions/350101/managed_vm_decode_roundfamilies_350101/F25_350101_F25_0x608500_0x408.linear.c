 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_roundfamilies_350101_20260831_053127/350101_F25_0x608500_0x408.bin
...
L_000b:
    /* +0x00108 op=0x34 11 00 05 00 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];
...
L_000d:
    /* +0x00138 op=0x5e 87 00 00 00 CALL_CF_INDEX: call native_binding[index=0x87] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x87, (void *)(uintptr_t)0x125fd3c0);
...
L_0011:
    /* +0x00198 op=0x5e 88 00 00 00 CALL_CF_INDEX: call native_binding[index=0x88] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x88, (void *)(uintptr_t)0x125fd3c0);
...
L_0013:
    /* +0x001c8 op=0x5e 89 00 00 00 CALL_CF_INDEX: call native_binding[index=0x89] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x89, (void *)(uintptr_t)0x125fd3c0);
...
L_0017:
    /* +0x00228 op=0x5e 8a 00 00 00 CALL_CF_INDEX: call native_binding[index=0x8a] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x8a, (void *)(uintptr_t)0x125fd3c0);
...
L_001b:
    /* +0x00288 op=0x5e 87 00 00 00 CALL_CF_INDEX: call native_binding[index=0x87] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x87, (void *)(uintptr_t)0x125fd3c0);
...
L_0020:
    /* +0x00300 op=0x34 10 00 06 00 OR64: s6 = s16 | s0 */
    S[6] = S[16] | S[0];

L_0021:
    /* +0x00318 op=0x5e 87 00 00 00 CALL_CF_INDEX: call native_binding[index=0x87] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x87, (void *)(uintptr_t)0x125fd3c0);
