...
001c  +0x002a0  op=85  06 06 3a 03  ADD64_IMM16      s6 = s6 +0x33a
001d  +0x002b8  op=33  01 07 72 de  OR_IMM16         s7 = s1 | 0xde72
...
002a  +0x003f0  op=84  06 08 0a 14  ADD64            s10 = s6 + s8
002b  +0x00408  op=b2  04 08 18 00  AND64_IMM16      s8 = s4 & 0x18
002c  +0x00420  op=84  06 01 01 14  ADD64            s1 = s6 + s1
