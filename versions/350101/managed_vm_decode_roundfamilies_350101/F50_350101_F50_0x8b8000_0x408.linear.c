...
L_000d:
    /* +0x00138 op=0x5e 9a 00 00 00 CALL_CF_INDEX: call native_binding[index=0x9a] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x9a, (void *)(uintptr_t)0x125fd3c0);
...
L_0011:
    /* +0x00198 op=0x5e 9b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x9b] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x9b, (void *)(uintptr_t)0x125fd3c0);
...
L_0013:
    /* +0x001c8 op=0x5e 9c 00 00 00 CALL_CF_INDEX: call native_binding[index=0x9c] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x9c, (void *)(uintptr_t)0x125fd3c0);
...
L_0016:
    /* +0x00210 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];

L_0017:
    /* +0x00228 op=0x5e 9d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x9d] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x9d, (void *)(uintptr_t)0x125fd3c0);
...
L_001b:
    /* +0x00288 op=0x5e 9a 00 00 00 CALL_CF_INDEX: call native_binding[index=0x9a] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x9a, (void *)(uintptr_t)0x125fd3c0);
...
L_0021:
    /* +0x00318 op=0x5e 9a 00 00 00 CALL_CF_INDEX: call native_binding[index=0x9a] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x9a, (void *)(uintptr_t)0x125fd3c0);
