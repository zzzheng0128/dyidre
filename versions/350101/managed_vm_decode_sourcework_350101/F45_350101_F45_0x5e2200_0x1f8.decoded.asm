...
0011  +0x00198  op=59  04 02 07 00  LD8U             s2 = *(uint8_t *)(s4 +0x7)
0012  +0x001b0  op=26  04 02 0f 00  ST8              *(s4 +0xf) = (uint8_t)s2
0013  +0x001c8  op=26  04 01 07 00  ST8              *(s4 +0x7) = (uint8_t)s1
