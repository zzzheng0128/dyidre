...
0012  +0x001b0  op=84  02 03 05 14  ADD64            s5 = s2 + s3
0013  +0x001c8  op=84  16 03 01 00  ADD64            s1 = s22 + s3
0014  +0x001e0  op=85  03 03 04 00  ADD64_IMM16      s3 = s3 +0x4
0015  +0x001f8  op=59  05 06 ff ff  LD8U             s6 = *(uint8_t *)(s5 -0x1)
0016  +0x00210  op=26  01 06 01 00  ST8              *(s1 +0x1) = (uint8_t)s6
0017  +0x00228  op=59  05 06 00 00  LD8U             s6 = *(uint8_t *)(s5 +0x0)
0018  +0x00240  op=26  01 06 03 00  ST8              *(s1 +0x3) = (uint8_t)s6
0019  +0x00258  op=59  05 06 01 00  LD8U             s6 = *(uint8_t *)(s5 +0x1)
001a  +0x00270  op=26  01 06 00 00  ST8              *(s1 +0x0) = (uint8_t)s6
001b  +0x00288  op=59  05 05 02 00  LD8U             s5 = *(uint8_t *)(s5 +0x2)
001c  +0x002a0  op=26  01 05 02 00  ST8              *(s1 +0x2) = (uint8_t)s5
...
0022  +0x00330  op=84  16 11 12 14  ADD64            s18 = s22 + s17
...
0028  +0x003c0  op=34  02 00 14 01  OR64             s20 = s2 | s0
...
0031  +0x00498  op=34  13 00 04 01  OR64             s4 = s19 | s0
0032  +0x004b0  op=84  01 11 11 04  ADD64            s17 = s1 + s17
0033  +0x004c8  op=02  15 14 01 01  XOR64            s1 = s20 ^ s21
0034  +0x004e0  op=02  01 02 14 00  XOR64            s20 = s2 ^ s1
0035  +0x004f8  op=5e  8b 00 00 00  CALL_CF_INDEX    call native_binding[index=0x8b] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0036  +0x00510  op=02  14 02 01 00  XOR64            s1 = s2 ^ s20
...
003e  +0x005d0  op=84  16 17 10 04  ADD64            s16 = s22 + s23
003f  +0x005e8  op=34  11 00 04 01  OR64             s4 = s17 | s0
...
0048  +0x006c0  op=34  02 00 15 00  OR64             s21 = s2 | s0
...
004d  +0x00738  op=34  11 00 04 00  OR64             s4 = s17 | s0
004e  +0x00750  op=84  01 17 17 04  ADD64            s23 = s1 + s23
004f  +0x00768  op=02  15 14 01 00  XOR64            s1 = s20 ^ s21
0050  +0x00780  op=02  01 02 14 00  XOR64            s20 = s2 ^ s1
...
005c  +0x008a0  op=84  16 12 10 00  ADD64            s16 = s22 + s18
005d  +0x008b8  op=34  11 00 04 01  OR64             s4 = s17 | s0
...
0061  +0x00918  op=34  11 00 04 00  OR64             s4 = s17 | s0
...
006e  +0x00a50  op=02  14 02 01 01  XOR64            s1 = s2 ^ s20
006f  +0x00a68  op=26  12 01 00 00  ST8              *(s18 +0x0) = (uint8_t)s1
0070  +0x00a80  op=34  13 00 12 00  OR64             s18 = s19 | s0
...
0082  +0x00c30  op=84  14 17 17 14  ADD64            s23 = s20 + s23
0083  +0x00c48  op=02  02 13 13 00  XOR64            s19 = s19 ^ s2
...
0087  +0x00ca8  op=02  13 02 13 00  XOR64            s19 = s2 ^ s19
