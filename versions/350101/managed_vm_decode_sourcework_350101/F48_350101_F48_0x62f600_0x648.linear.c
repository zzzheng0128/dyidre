 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_adapters_350101_20260831_053000/350101_F48_0x62f600_0x648.bin
...
L_000e:
    /* +0x00150 op=0x34 06 00 10 00 OR64: s16 = s6 | s0 */
    S[16] = S[6] | S[0];
...
L_0019:
    /* +0x00258 op=0x84 02 03 05 14 ADD64: s5 = s2 + s3 */
    S[5] = S[2] + S[3];

L_001a:
    /* +0x00270 op=0x84 12 03 01 04 ADD64: s1 = s18 + s3 */
    S[1] = S[18] + S[3];
...
L_001e:
    /* +0x002d0 op=0x02 05 04 04 00 XOR64: s4 = s4 ^ s5 */
    S[4] = S[4] ^ S[5];
...
L_0021:
    /* +0x00318 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];

L_0022:
    /* +0x00330 op=0x34 11 00 05 01 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];

L_0023:
    /* +0x00348 op=0x5e 99 00 00 00 CALL_CF_INDEX: call native_binding[index=0x99] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x99, (void *)(uintptr_t)0x125fd3c0);
...
L_0027:
    /* +0x003a8 op=0x84 12 02 01 04 ADD64: s1 = s18 + s2 */
    S[1] = S[18] + S[2];
...
L_002b:
    /* +0x00408 op=0x02 04 03 03 01 XOR64: s3 = s3 ^ s4 */
    S[3] = S[3] ^ S[4];
