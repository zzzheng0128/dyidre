 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_f30_f42_350101_20260831_044228/350101_F42_0x60cb00_0x408.bin
...
L_0007:
    /* +0x000a8 op=0x34 1d 00 1e 00 OR64: s30 = s29 | s0 */
    S[30] = S[29] | S[0];
...
L_000c:
    /* +0x00120 op=0x34 10 00 06 01 OR64: s6 = s16 | s0 */
    S[6] = S[16] | S[0];

L_000d:
    /* +0x00138 op=0x5e 94 00 00 00 CALL_CF_INDEX: call native_binding[index=0x94] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x94, (void *)(uintptr_t)0x125fd3c0);
...
L_0010:
    /* +0x00180 op=0x34 11 00 04 00 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];

L_0011:
    /* +0x00198 op=0x5e 95 00 00 00 CALL_CF_INDEX: call native_binding[index=0x95] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x95, (void *)(uintptr_t)0x125fd3c0);
...
L_0013:
    /* +0x001c8 op=0x5e 96 00 00 00 CALL_CF_INDEX: call native_binding[index=0x96] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x96, (void *)(uintptr_t)0x125fd3c0);
...
L_0017:
    /* +0x00228 op=0x5e 97 00 00 00 CALL_CF_INDEX: call native_binding[index=0x97] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x97, (void *)(uintptr_t)0x125fd3c0);
...
L_0019:
    /* +0x00258 op=0x34 11 00 05 01 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];
...
L_001b:
    /* +0x00288 op=0x5e 94 00 00 00 CALL_CF_INDEX: call native_binding[index=0x94] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x94, (void *)(uintptr_t)0x125fd3c0);
...
L_0021:
    /* +0x00318 op=0x5e 94 00 00 00 CALL_CF_INDEX: call native_binding[index=0x94] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x94, (void *)(uintptr_t)0x125fd3c0);

L_0022:
    /* +0x00330 op=0x34 1e 00 1d 00 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];
