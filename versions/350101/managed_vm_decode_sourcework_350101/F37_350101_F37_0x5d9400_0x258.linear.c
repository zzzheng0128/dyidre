 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/unidbg-android/target/managed_program_f32_family_350101_20260831_045757/350101_F37_0x5d9400_0x258.bin
...
L_0010:
    /* +0x00180 op=0x59 04 01 03 00 LD8U: s1 = *(uint8_t *)(s4 +0x3) */
    S[1] = *(uint8_t *)((uint8_t *)S[4] + 0x3);

L_0011:
    /* +0x00198 op=0x59 04 02 0b 00 LD8U: s2 = *(uint8_t *)(s4 +0xb) */
    S[2] = *(uint8_t *)((uint8_t *)S[4] + 0xb);

L_0012:
    /* +0x001b0 op=0x59 04 03 0f 00 LD8U: s3 = *(uint8_t *)(s4 +0xf) */
    S[3] = *(uint8_t *)((uint8_t *)S[4] + 0xf);

L_0013:
    /* +0x001c8 op=0x59 04 05 07 00 LD8U: s5 = *(uint8_t *)(s4 +0x7) */
    S[5] = *(uint8_t *)((uint8_t *)S[4] + 0x7);

L_0014:
    /* +0x001e0 op=0x26 04 05 0f 00 ST8: *(s4 +0xf) = (uint8_t)s5 */
    *(uint8_t *)((uint8_t *)S[4] + 0xf) = (uint8_t)S[5];

L_0015:
    /* +0x001f8 op=0x26 04 03 0b 00 ST8: *(s4 +0xb) = (uint8_t)s3 */
    *(uint8_t *)((uint8_t *)S[4] + 0xb) = (uint8_t)S[3];

L_0016:
    /* +0x00210 op=0x26 04 02 03 00 ST8: *(s4 +0x3) = (uint8_t)s2 */
    *(uint8_t *)((uint8_t *)S[4] + 0x3) = (uint8_t)S[2];

L_0017:
    /* +0x00228 op=0x26 04 01 07 00 ST8: *(s4 +0x7) = (uint8_t)s1 */
    *(uint8_t *)((uint8_t *)S[4] + 0x7) = (uint8_t)S[1];
