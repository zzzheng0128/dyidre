/*
 * Auto-generated linear C-like lift for 350.101 managed program F53.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_roundfamilies_350101_20260831_053127/350101_F53_0x5d9b80_0x228.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F53_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0012:
    /* +0x001b0 op=0x59 04 03 07 00 LD8U: s3 = *(uint8_t *)(s4 +0x7) */
    S[3] = *(uint8_t *)((uint8_t *)S[4] + 0x7);
...
L_0014:
    /* +0x001e0 op=0x26 04 02 07 00 ST8: *(s4 +0x7) = (uint8_t)s2 */
    *(uint8_t *)((uint8_t *)S[4] + 0x7) = (uint8_t)S[2];
