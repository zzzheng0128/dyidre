/*
 * Auto-generated linear C-like lift for 350.101 managed program F54.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_roundfamilies_350101_20260831_053127/350101_F54_0x87f000_0xe70.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F54_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0013:
    /* +0x001c8 op=0x84 16 03 01 04 ADD64: s1 = s22 + s3 */
    S[1] = S[22] + S[3];
...
L_001c:
    /* +0x002a0 op=0x26 01 05 01 00 ST8: *(s1 +0x1) = (uint8_t)s5 */
    *(uint8_t *)((uint8_t *)S[1] + 0x1) = (uint8_t)S[5];
...
L_0034:
    /* +0x004e0 op=0x02 01 02 14 01 XOR64: s20 = s2 ^ s1 */
    S[20] = S[2] ^ S[1];
...
L_0038:
    /* +0x00540 op=0x34 10 00 11 00 OR64: s17 = s16 | s0 */
    S[17] = S[16] | S[0];
...
L_003e:
    /* +0x005d0 op=0x84 16 17 10 00 ADD64: s16 = s22 + s23 */
    S[16] = S[22] + S[23];
...
L_0054:
    /* +0x007e0 op=0x34 12 00 17 00 OR64: s23 = s18 | s0 */
    S[23] = S[18] | S[0];
...
L_0067:
    /* +0x009a8 op=0x84 17 12 12 04 ADD64: s18 = s23 + s18 */
    S[18] = S[23] + S[18];
...
L_0070:
    /* +0x00a80 op=0x34 13 00 12 01 OR64: s18 = s19 | s0 */
    S[18] = S[19] | S[0];
...
L_008d:
    /* +0x00d38 op=0x34 1e 00 1d 00 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];
