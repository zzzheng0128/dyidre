; MetaSec managed bytecode decode: F46
...
0012  +0x001b0  op=84  02 03 05 00  ADD64            s5 = s2 + s3
...
0018  +0x00240  op=26  01 06 02 00  ST8              *(s1 +0x2) = (uint8_t)s6
0019  +0x00258  op=59  05 06 01 00  LD8U             s6 = *(uint8_t *)(s5 +0x1)
001a  +0x00270  op=26  01 06 01 00  ST8              *(s1 +0x1) = (uint8_t)s6
001b  +0x00288  op=59  05 05 02 00  LD8U             s5 = *(uint8_t *)(s5 +0x2)
001c  +0x002a0  op=26  01 05 00 00  ST8              *(s1 +0x0) = (uint8_t)s5
...
002b  +0x00408  op=34  13 00 04 00  OR64             s4 = s19 | s0
...
0052  +0x007b0  op=02  14 02 01 01  XOR64            s1 = s2 ^ s20
...
0062  +0x00930  op=34  02 00 14 00  OR64             s20 = s2 | s0
...
0067  +0x009a8  op=84  17 12 12 00  ADD64            s18 = s23 + s18
...
006c  +0x00a20  op=02  14 02 14 00  XOR64            s20 = s2 ^ s20
...
0077  +0x00b28  op=84  16 17 10 14  ADD64            s16 = s22 + s23
...
007d  +0x00bb8  op=34  02 00 13 00  OR64             s19 = s2 | s0
...
0080  +0x00c00  op=34  11 00 04 01  OR64             s4 = s17 | s0
