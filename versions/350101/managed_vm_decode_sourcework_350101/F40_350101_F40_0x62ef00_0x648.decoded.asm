...
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_f20_f40_f43_46_350101_20260831_042856/350101_F40_0x62ef00_0x648.bin
...
000e  +0x00150  op=34  06 00 10 01  OR64             s16 = s6 | s0
...
0013  +0x001c8  op=34  13 00 02 01  OR64             s2 = s19 | s0
0014  +0x001e0  op=13  17 10 01 00  CMP_LO64         s1 = ((uint64_t)s23 < (uint64_t)s16) ? 1 : 0
0015  +0x001f8  op=ae  01 00 1c 00  BR_EQ64          if (s1 == s0) goto record +50
0016  +0x00210  op=34  05 00 12 01  OR64             s18 = s5 | s0
0017  +0x00228  op=34  15 00 03 01  OR64             s3 = s21 | s0
0018  +0x00240  op=ae  03 16 08 00  BR_EQ64          if (s3 == s22) goto record +33
0019  +0x00258  op=84  02 03 05 00  ADD64            s5 = s2 + s3
...
0022  +0x00330  op=34  11 00 05 00  OR64             s5 = s17 | s0
0023  +0x00348  op=5e  93 00 00 00  CALL_CF_INDEX    call native_binding[index=0x93] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0024  +0x00360  op=34  15 00 02 01  OR64             s2 = s21 | s0
0025  +0x00378  op=ae  02 16 08 00  BR_EQ64          if (s2 == s22) goto record +46
0026  +0x00390  op=84  14 02 04 04  ADD64            s4 = s20 + s2
0027  +0x003a8  op=84  12 02 01 14  ADD64            s1 = s18 + s2
...
002b  +0x00408  op=02  04 03 03 00  XOR64            s3 = s3 ^ s4
