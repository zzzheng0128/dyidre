...
0004  +0x00060  op=85  01 05 85 05  ADD64_IMM16      s5 = s1 +0x585
...
000a  +0x000f0  op=59  01 08 04 00  LD8U             s8 = *(uint8_t *)(s1 +0x4)
...
000e  +0x00150  op=84  05 08 08 04  ADD64            s8 = s5 + s8
...
0016  +0x00210  op=26  01 06 04 00  ST8              *(s1 +0x4) = (uint8_t)s6
