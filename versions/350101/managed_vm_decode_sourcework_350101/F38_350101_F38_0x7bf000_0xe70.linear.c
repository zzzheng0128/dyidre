...
L_0012:
    /* +0x001b0 op=0x84 02 03 05 04 ADD64: s5 = s2 + s3 */
    S[5] = S[2] + S[3];

L_0013:
    /* +0x001c8 op=0x84 16 03 01 14 ADD64: s1 = s22 + s3 */
    S[1] = S[22] + S[3];
...
L_0018:
    /* +0x00240 op=0x26 01 06 00 00 ST8: *(s1 +0x0) = (uint8_t)s6 */
...
L_001a:
    /* +0x00270 op=0x26 01 06 02 00 ST8: *(s1 +0x2) = (uint8_t)s6 */
...
L_0028:
    /* +0x003c0 op=0x34 02 00 14 00 OR64: s20 = s2 | s0 */
    S[20] = S[2] | S[0];
...
L_0033:
    /* +0x004c8 op=0x02 15 14 01 00 XOR64: s1 = s20 ^ s21 */
    S[1] = S[20] ^ S[21];
...
L_0048:
    /* +0x006c0 op=0x34 02 00 15 01 OR64: s21 = s2 | s0 */
    S[21] = S[2] | S[0];
...
L_006e:
    /* +0x00a50 op=0x02 14 02 01 00 XOR64: s1 = s2 ^ s20 */
    S[1] = S[2] ^ S[20];
