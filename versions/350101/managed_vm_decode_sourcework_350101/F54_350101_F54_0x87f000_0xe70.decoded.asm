; MetaSec managed bytecode decode: F54
...
0013  +0x001c8  op=84  16 03 01 04  ADD64            s1 = s22 + s3
...
0038  +0x00540  op=34  10 00 11 00  OR64             s17 = s16 | s0
...
0054  +0x007e0  op=34  12 00 17 00  OR64             s23 = s18 | s0
...
0067  +0x009a8  op=84  17 12 12 04  ADD64            s18 = s23 + s18
