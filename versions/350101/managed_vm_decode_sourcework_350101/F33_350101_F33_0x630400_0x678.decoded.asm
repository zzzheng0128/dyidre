...
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_roundfamilies_350101_20260831_053127/350101_F33_0x630400_0x678.bin
; records: 69  record_size=0x18
; slot base: qword slots=frame->buf+0x8100, f32=+0x8200, f64=+0x8280

0000  +0x00000  op=53  04 01 08 03  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0x308 ; q1=0x125fd408 rt/so-mapped
...
0007  +0x000a8  op=84  03 05 08 04  ADD64            s8 = s3 + s5
...
001c  +0x002a0  op=85  06 06 84 04  ADD64_IMM16      s6 = s6 +0x484
001d  +0x002b8  op=33  01 07 5b 8d  OR_IMM16         s7 = s1 | 0x8d5b
...
0029  +0x003d8  op=84  06 09 09 14  ADD64            s9 = s6 + s9
...
0030  +0x00480  op=84  06 0c 01 04  ADD64            s1 = s6 + s12
0031  +0x00498  op=59  0a 0a 00 00  LD8U             s10 = *(uint8_t *)(s10 +0x0)
0032  +0x004b0  op=02  09 08 08 01  XOR64            s8 = s8 ^ s9
...
0038  +0x00540  op=02  01 0b 01 00  XOR64            s1 = s11 ^ s1
0039  +0x00558  op=59  02 0b ee ff  LD8U             s11 = *(uint8_t *)(s2 -0x12)
003a  +0x00570  op=02  0c 0a 0a 01  XOR64            s10 = s10 ^ s12
003b  +0x00588  op=02  0b 09 09 00  XOR64            s9 = s9 ^ s11
