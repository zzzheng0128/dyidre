...
L_0012:
    /* +0x001b0 op=0x34 15 00 17 01 OR64: s23 = s21 | s0 */
    S[23] = S[21] | S[0];
...
L_0014:
    /* +0x001e0 op=0x13 17 10 01 00 CMP_LO64: s1 = ((uint64_t)s23 < (uint64_t)s16) ? 1 : 0 */
...
L_0016:
    /* +0x00210 op=0x34 05 00 12 01 OR64: s18 = s5 | s0 */
    S[18] = S[5] | S[0];
...
L_001a:
    /* +0x00270 op=0x84 12 03 01 14 ADD64: s1 = s18 + s3 */
    S[1] = S[18] + S[3];
...
L_0023:
    /* +0x00348 op=0x5e 93 00 00 00 CALL_CF_INDEX: call native_binding[index=0x93] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x93, (void *)(uintptr_t)0x125fd3c0);
...
L_0026:
    /* +0x00390 op=0x84 14 02 04 04 ADD64: s4 = s20 + s2 */
    S[4] = S[20] + S[2];
