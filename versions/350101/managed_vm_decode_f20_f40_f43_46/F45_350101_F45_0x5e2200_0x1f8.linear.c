/*
 * Auto-generated linear C-like lift for 350.101 managed program F45.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_f20_f40_f43_46_350101_20260831_042856/350101_F45_0x5e2200_0x1f8.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F45_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0011:
    /* +0x00198 op=0x59 04 02 07 00 LD8U: s2 = *(uint8_t *)(s4 +0x7) */
    S[2] = *(uint8_t *)((uint8_t *)S[4] + 0x7);

L_0012:
    /* +0x001b0 op=0x26 04 02 0f 00 ST8: *(s4 +0xf) = (uint8_t)s2 */
    *(uint8_t *)((uint8_t *)S[4] + 0xf) = (uint8_t)S[2];

L_0013:
    /* +0x001c8 op=0x26 04 01 07 00 ST8: *(s4 +0x7) = (uint8_t)s1 */
