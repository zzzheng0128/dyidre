/*
 * Auto-generated linear C-like lift for 350.101 managed program F46.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_f20_f40_f43_46_350101_20260831_042856/350101_F46_0x87e000_0xe70.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F46_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0012:
    /* +0x001b0 op=0x84 02 03 05 00 ADD64: s5 = s2 + s3 */
    S[5] = S[2] + S[3];
...
L_0016:
    /* +0x00210 op=0x26 01 06 03 00 ST8: *(s1 +0x3) = (uint8_t)s6 */
...
L_0018:
    /* +0x00240 op=0x26 01 06 02 00 ST8: *(s1 +0x2) = (uint8_t)s6 */
    *(uint8_t *)((uint8_t *)S[1] + 0x2) = (uint8_t)S[6];
...
L_001a:
    /* +0x00270 op=0x26 01 06 01 00 ST8: *(s1 +0x1) = (uint8_t)s6 */
...
L_001c:
    /* +0x002a0 op=0x26 01 05 00 00 ST8: *(s1 +0x0) = (uint8_t)s5 */
...
L_0022:
    /* +0x00330 op=0x84 16 11 12 00 ADD64: s18 = s22 + s17 */
    S[18] = S[22] + S[17];
...
L_002b:
    /* +0x00408 op=0x34 13 00 04 00 OR64: s4 = s19 | s0 */
    S[4] = S[19] | S[0];
...
L_0031:
    /* +0x00498 op=0x34 13 00 04 00 OR64: s4 = s19 | s0 */
    S[4] = S[19] | S[0];

L_0032:
    /* +0x004b0 op=0x84 01 11 11 00 ADD64: s17 = s1 + s17 */
    S[17] = S[1] + S[17];
...
L_0036:
    /* +0x00510 op=0x02 14 02 01 01 XOR64: s1 = s2 ^ s20 */
    S[1] = S[2] ^ S[20];
...
L_003f:
    /* +0x005e8 op=0x34 11 00 04 00 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_004d:
    /* +0x00738 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];

L_004e:
    /* +0x00750 op=0x84 01 17 17 14 ADD64: s23 = s1 + s23 */
    S[23] = S[1] + S[23];

L_004f:
    /* +0x00768 op=0x02 15 14 01 01 XOR64: s1 = s20 ^ s21 */
    S[1] = S[20] ^ S[21];

L_0050:
    /* +0x00780 op=0x02 01 02 14 01 XOR64: s20 = s2 ^ s1 */
    S[20] = S[2] ^ S[1];
...
L_0052:
    /* +0x007b0 op=0x02 14 02 01 01 XOR64: s1 = s2 ^ s20 */
    S[1] = S[2] ^ S[20];
...
L_005c:
    /* +0x008a0 op=0x84 16 12 10 04 ADD64: s16 = s22 + s18 */
    S[16] = S[22] + S[18];

L_005d:
    /* +0x008b8 op=0x34 11 00 04 00 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_0061:
    /* +0x00918 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];

L_0062:
    /* +0x00930 op=0x34 02 00 14 00 OR64: s20 = s2 | s0 */
    S[20] = S[2] | S[0];
...
L_0067:
    /* +0x009a8 op=0x84 17 12 12 00 ADD64: s18 = s23 + s18 */
    S[18] = S[23] + S[18];
...
L_006c:
    /* +0x00a20 op=0x02 14 02 14 00 XOR64: s20 = s2 ^ s20 */
    S[20] = S[2] ^ S[20];
...
L_0077:
    /* +0x00b28 op=0x84 16 17 10 14 ADD64: s16 = s22 + s23 */
    S[16] = S[22] + S[23];
...
L_007d:
    /* +0x00bb8 op=0x34 02 00 13 00 OR64: s19 = s2 | s0 */
    S[19] = S[2] | S[0];
...
L_0080:
    /* +0x00c00 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_0082:
    /* +0x00c30 op=0x84 14 17 17 00 ADD64: s23 = s20 + s23 */
    S[23] = S[20] + S[23];

L_0083:
    /* +0x00c48 op=0x02 02 13 13 01 XOR64: s19 = s19 ^ s2 */
    S[19] = S[19] ^ S[2];
...
L_0087:
    /* +0x00ca8 op=0x02 13 02 13 01 XOR64: s19 = s2 ^ s19 */
    S[19] = S[2] ^ S[19];
