...
0008  +0x000c0  op=5e  8c 00 00 00  CALL_CF_INDEX    call native_binding[index=0x8c] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
000d  +0x00138  op=34  1e 00 1d 00  OR64             s29 = s30 | s0
