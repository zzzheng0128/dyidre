...
001a  +0x00270  op=84  12 03 01 00  ADD64            s1 = s18 + s3
...
0023  +0x00348  op=5e  86 00 00 00  CALL_CF_INDEX    call native_binding[index=0x86] via q1 table ; q1=0x125fd3c0 rt/so-mapped
