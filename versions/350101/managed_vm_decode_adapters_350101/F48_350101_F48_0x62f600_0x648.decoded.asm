...
0012  +0x001b0  op=34  15 00 17 00  OR64             s23 = s21 | s0
...
0019  +0x00258  op=84  02 03 05 14  ADD64            s5 = s2 + s3
001a  +0x00270  op=84  12 03 01 04  ADD64            s1 = s18 + s3
...
001e  +0x002d0  op=02  05 04 04 00  XOR64            s4 = s4 ^ s5
001f  +0x002e8  op=26  01 04 00 00  ST8              *(s1 +0x0) = (uint8_t)s4
0020  +0x00300  op=a7  03 16 f8 ff  BR_NE64          if (s3 != s22) goto record +25
0021  +0x00318  op=34  12 00 04 01  OR64             s4 = s18 | s0
0022  +0x00330  op=34  11 00 05 01  OR64             s5 = s17 | s0
0023  +0x00348  op=5e  99 00 00 00  CALL_CF_INDEX    call native_binding[index=0x99] via q1 table ; q1=0x125fd3c0 rt/so-mapped
