...
L_0004:
    /* +0x00060 op=0x34 1d 00 1e 01 OR64: s30 = s29 | s0 */
    S[30] = S[29] | S[0];

L_0005:
    /* +0x00078 op=0x54 02 01 22 20 CONST_HI16: s1 = sign_extend_32(0x2022 << 16) */
...
L_0009:
    /* +0x000d8 op=0x34 06 00 05 01 OR64: s5 = s6 | s0 */
    S[5] = S[6] | S[0];

L_000a:
    /* +0x000f0 op=0x33 01 04 20 04 OR_IMM16: s4 = s1 | 0x420 */
    S[4] = S[1] | 0x420;
...
L_000e:
    /* +0x00150 op=0x18 00 04 01 07 SHL32_IMM: s1 = (int32_t)(s4 << 7) */
...
L_0011:
    /* +0x00198 op=0x02 01 04 01 00 XOR64: s1 = s4 ^ s1 */
    S[1] = S[4] ^ S[1];
...
L_0016:
    /* +0x00210 op=0x18 10 04 06 0b SHL32_IMM: s6 = (int32_t)(s4 << 11) */
...
L_0019:
    /* +0x00258 op=0x02 04 06 04 01 XOR64: s4 = s6 ^ s4 */
    S[4] = S[6] ^ S[4];

L_001a:
    /* +0x00270 op=0x02 04 01 01 01 XOR64: s1 = s1 ^ s4 */
    S[1] = S[1] ^ S[4];
...
L_0023:
    /* +0x00348 op=0x5e 05 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5] via q1 table q1=0x125fd420 */
