...
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_child_f4_20260904/350101_F4_0x8b8f00_0x438.bin
...
0005  +0x00078  op=54  05 01 22 20  CONST_HI16       s1 = sign_extend_32(0x2022 << 16)
...
0018  +0x00240  op=0e  0d 04 06 05  LSR32_IMM        s6 = sign_extend_32((uint32_t)s4 >> 5)
