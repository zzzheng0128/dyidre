 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_f1_reachable_20260904/350101_F17_0x609e00_0x498.bin
...
L_0018:
    /* +0x00240 op=0x5e 4e 00 00 00 CALL_CF_INDEX: call native_binding[index=0x4e] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x4e, (void *)(uintptr_t)0x125fd360);
...
L_001c:
    /* +0x002a0 op=0x5e 4f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x4f] via q1 table q1=0x125fd360 */
...
L_001f:
    /* +0x002e8 op=0x5e 50 00 00 00 CALL_CF_INDEX: call native_binding[index=0x50] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x50, (void *)(uintptr_t)0x125fd360);
...
L_0021:
    /* +0x00318 op=0x84 10 11 01 04 ADD64: s1 = s16 + s17 */
    S[1] = S[16] + S[17];
...
L_0025:
    /* +0x00378 op=0x34 1e 00 1d 01 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];
