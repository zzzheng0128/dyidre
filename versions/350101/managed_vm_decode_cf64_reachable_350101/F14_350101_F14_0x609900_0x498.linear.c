...
L_000f:
    /* +0x00168 op=0x34 05 00 15 00 OR64: s21 = s5 | s0 */
    S[21] = S[5] | S[0];
...
L_0018:
    /* +0x00240 op=0x5e 47 00 00 00 CALL_CF_INDEX: call native_binding[index=0x47] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x47, (void *)(uintptr_t)0x125fd360);
...
L_001c:
    /* +0x002a0 op=0x5e 48 00 00 00 CALL_CF_INDEX: call native_binding[index=0x48] via q1 table q1=0x125fd360 */
...
L_001f:
    /* +0x002e8 op=0x5e 49 00 00 00 CALL_CF_INDEX: call native_binding[index=0x49] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x49, (void *)(uintptr_t)0x125fd360);
