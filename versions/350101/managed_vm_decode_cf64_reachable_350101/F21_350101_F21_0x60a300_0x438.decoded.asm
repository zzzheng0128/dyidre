; MetaSec managed bytecode decode: F21
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_f1_reachable_20260904/350101_F21_0x60a300_0x438.bin
...
0004  +0x00060  op=34  1d 00 1e 00  OR64             s30 = s29 | s0
0005  +0x00078  op=34  04 00 10 01  OR64             s16 = s4 | s0
0006  +0x00090  op=54  05 01 22 20  CONST_HI16       s1 = sign_extend_32(0x2022 << 16)
0007  +0x000a8  op=b5  00 02 00 00  ADD32_IMM16      s2 = int32(s0 +0x0)
0008  +0x000c0  op=b5  00 03 0c 00  ADD32_IMM16      s3 = int32(s0 +0xc)
0009  +0x000d8  op=33  01 04 20 04  OR_IMM16         s4 = s1 | 0x420
000a  +0x000f0  op=34  10 00 05 01  OR64             s5 = s16 | s0
...
000e  +0x00150  op=18  10 04 01 07  SHL32_IMM        s1 = (int32_t)(s4 << 7)
000f  +0x00168  op=02  01 04 01 01  XOR64            s1 = s4 ^ s1
0010  +0x00180  op=0e  0d 04 04 03  LSR32_IMM        s4 = sign_extend_32((uint32_t)s4 >> 3)
0011  +0x00198  op=02  01 04 01 01  XOR64            s1 = s4 ^ s1
0012  +0x001b0  op=59  05 04 00 00  LD8U             s4 = *(uint8_t *)(s5 +0x0)
0013  +0x001c8  op=02  01 04 04 00  XOR64            s4 = s4 ^ s1
...
0016  +0x00210  op=18  11 04 06 0b  SHL32_IMM        s6 = (int32_t)(s4 << 11)
0017  +0x00228  op=34  06 01 01 01  OR64             s1 = s6 | s1
0018  +0x00240  op=0e  0b 04 06 05  LSR32_IMM        s6 = sign_extend_32((uint32_t)s4 >> 5)
0019  +0x00258  op=02  04 06 04 00  XOR64            s4 = s6 ^ s4
001a  +0x00270  op=02  04 01 01 00  XOR64            s1 = s1 ^ s4
001b  +0x00288  op=36  01 00 04 01  NOR64            s4 = ~(s1 | s0)
...
0023  +0x00348  op=5e  0e 00 00 00  CALL_CF_INDEX    call native_binding[index=0xe] via q1 table ; q1=0x125fd360 rt/so-mapped
