...
000e  +0x00150  op=34  06 00 14 00  OR64             s20 = s6 | s0
...
0013  +0x001c8  op=34  11 00 05 00  OR64             s5 = s17 | s0
0014  +0x001e0  op=34  12 00 06 00  OR64             s6 = s18 | s0
0015  +0x001f8  op=5e  0d 00 00 00  CALL_CF_INDEX    call native_binding[index=0xd] via q1 table ; q1=0x125fd360 rt/so-mapped
0016  +0x00210  op=34  10 00 04 00  OR64             s4 = s16 | s0
0017  +0x00228  op=25  1e 14 60 00  ST64             *(s30 +0x60) = s20
0018  +0x00240  op=5e  39 00 00 00  CALL_CF_INDEX    call native_binding[index=0x39] via q1 table ; q1=0x125fd360 rt/so-mapped
...
001c  +0x002a0  op=5e  3a 00 00 00  CALL_CF_INDEX    call native_binding[index=0x3a] via q1 table ; q1=0x125fd360 rt/so-mapped
001d  +0x002b8  op=34  10 00 04 01  OR64             s4 = s16 | s0
001e  +0x002d0  op=34  13 00 05 01  OR64             s5 = s19 | s0
001f  +0x002e8  op=5e  3b 00 00 00  CALL_CF_INDEX    call native_binding[index=0x3b] via q1 table ; q1=0x125fd360 rt/so-mapped
0020  +0x00300  op=ae  11 12 04 00  BR_EQ64          if (s17 == s18) goto record +37
0021  +0x00318  op=84  10 11 01 00  ADD64            s1 = s16 + s17
