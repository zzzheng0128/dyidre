 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_f1_reachable_20260904/350101_F11_0x609400_0x498.bin
...
L_000e:
    /* +0x00150 op=0x34 06 00 14 01 OR64: s20 = s6 | s0 */
    S[20] = S[6] | S[0];
...
L_0011:
    /* +0x00198 op=0x34 07 00 13 00 OR64: s19 = s7 | s0 */
    S[19] = S[7] | S[0];
...
L_0013:
    /* +0x001c8 op=0x34 11 00 05 01 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];

L_0014:
    /* +0x001e0 op=0x34 12 00 06 01 OR64: s6 = s18 | s0 */
    S[6] = S[18] | S[0];
...
L_0016:
    /* +0x00210 op=0x34 10 00 04 01 OR64: s4 = s16 | s0 */
    S[4] = S[16] | S[0];
...
L_0018:
    /* +0x00240 op=0x5e 40 00 00 00 CALL_CF_INDEX: call native_binding[index=0x40] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x40, (void *)(uintptr_t)0x125fd360);
...
L_001c:
    /* +0x002a0 op=0x5e 41 00 00 00 CALL_CF_INDEX: call native_binding[index=0x41] via q1 table q1=0x125fd360 */
...
L_001e:
    /* +0x002d0 op=0x34 13 00 05 00 OR64: s5 = s19 | s0 */
    S[5] = S[19] | S[0];

L_001f:
    /* +0x002e8 op=0x5e 42 00 00 00 CALL_CF_INDEX: call native_binding[index=0x42] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x42, (void *)(uintptr_t)0x125fd360);
...
L_0021:
    /* +0x00318 op=0x84 10 11 01 14 ADD64: s1 = s16 + s17 */
    S[1] = S[16] + S[17];
