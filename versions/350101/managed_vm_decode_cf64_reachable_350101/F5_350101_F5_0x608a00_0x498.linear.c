 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_f1_reachable_20260904/350101_F5_0x608a00_0x498.bin
...
L_0018:
    /* +0x00240 op=0x5e 32 00 00 00 CALL_CF_INDEX: call native_binding[index=0x32] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x32, (void *)(uintptr_t)0x125fd360);
...
L_001c:
    /* +0x002a0 op=0x5e 33 00 00 00 CALL_CF_INDEX: call native_binding[index=0x33] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x33, (void *)(uintptr_t)0x125fd360);

L_001d:
    /* +0x002b8 op=0x34 10 00 04 00 OR64: s4 = s16 | s0 */
    S[4] = S[16] | S[0];
...
L_001f:
    /* +0x002e8 op=0x5e 34 00 00 00 CALL_CF_INDEX: call native_binding[index=0x34] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x34, (void *)(uintptr_t)0x125fd360);
