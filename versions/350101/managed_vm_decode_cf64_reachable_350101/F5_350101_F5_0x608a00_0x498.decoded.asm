...
0018  +0x00240  op=5e  32 00 00 00  CALL_CF_INDEX    call native_binding[index=0x32] via q1 table ; q1=0x125fd360 rt/so-mapped
...
001c  +0x002a0  op=5e  33 00 00 00  CALL_CF_INDEX    call native_binding[index=0x33] via q1 table ; q1=0x125fd360 rt/so-mapped
001d  +0x002b8  op=34  10 00 04 00  OR64             s4 = s16 | s0
001e  +0x002d0  op=34  13 00 05 01  OR64             s5 = s19 | s0
001f  +0x002e8  op=5e  34 00 00 00  CALL_CF_INDEX    call native_binding[index=0x34] via q1 table ; q1=0x125fd360 rt/so-mapped
