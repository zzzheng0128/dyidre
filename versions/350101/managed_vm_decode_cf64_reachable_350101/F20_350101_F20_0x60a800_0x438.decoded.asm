...
0006  +0x00090  op=54  02 01 22 20  CONST_HI16       s1 = sign_extend_32(0x2022 << 16)
0007  +0x000a8  op=b5  00 02 00 00  ADD32_IMM16      s2 = int32(s0 +0x0)
0008  +0x000c0  op=b5  00 03 08 00  ADD32_IMM16      s3 = int32(s0 +0x8)
0009  +0x000d8  op=33  01 04 20 04  OR_IMM16         s4 = s1 | 0x420
000a  +0x000f0  op=34  10 00 05 00  OR64             s5 = s16 | s0
...
000e  +0x00150  op=18  11 04 01 07  SHL32_IMM        s1 = (int32_t)(s4 << 7)
...
0016  +0x00210  op=18  00 04 06 0b  SHL32_IMM        s6 = (int32_t)(s4 << 11)
0017  +0x00228  op=34  06 01 01 01  OR64             s1 = s6 | s1
0018  +0x00240  op=0e  00 04 06 05  LSR32_IMM        s6 = sign_extend_32((uint32_t)s4 >> 5)
...
0025  +0x00378  op=b2  01 01 fb 00  AND64_IMM16      s1 = s1 & 0xfb
