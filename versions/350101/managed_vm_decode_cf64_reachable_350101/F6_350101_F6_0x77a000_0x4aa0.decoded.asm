...
002f  +0x00468  op=17  04 0a 0a 17  SHL32_VAR        s10 = (int32_t)((uint32_t)s10 << ((uint32_t)s4 & 31))
...
01bc  +0x029a0  op=17  04 07 07 07  SHL32_VAR        s7 = (int32_t)((uint32_t)s7 << ((uint32_t)s4 & 31))
