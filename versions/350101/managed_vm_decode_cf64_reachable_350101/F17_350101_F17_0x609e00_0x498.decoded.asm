...
0018  +0x00240  op=5e  4e 00 00 00  CALL_CF_INDEX    call native_binding[index=0x4e] via q1 table ; q1=0x125fd360 rt/so-mapped
...
001c  +0x002a0  op=5e  4f 00 00 00  CALL_CF_INDEX    call native_binding[index=0x4f] via q1 table ; q1=0x125fd360 rt/so-mapped
001d  +0x002b8  op=34  10 00 04 01  OR64             s4 = s16 | s0
001e  +0x002d0  op=34  13 00 05 01  OR64             s5 = s19 | s0
001f  +0x002e8  op=5e  50 00 00 00  CALL_CF_INDEX    call native_binding[index=0x50] via q1 table ; q1=0x125fd360 rt/so-mapped
0020  +0x00300  op=ae  11 12 04 00  BR_EQ64          if (s17 == s18) goto record +37
0021  +0x00318  op=84  10 11 01 04  ADD64            s1 = s16 + s17
