; MetaSec managed bytecode decode: F11
...
000f  +0x00168  op=34  05 00 15 01  OR64             s21 = s5 | s0
0010  +0x00180  op=34  04 00 16 01  OR64             s22 = s4 | s0
0011  +0x00198  op=34  07 00 13 00  OR64             s19 = s7 | s0
...
0018  +0x00240  op=5e  40 00 00 00  CALL_CF_INDEX    call native_binding[index=0x40] via q1 table ; q1=0x125fd360 rt/so-mapped
...
001c  +0x002a0  op=5e  41 00 00 00  CALL_CF_INDEX    call native_binding[index=0x41] via q1 table ; q1=0x125fd360 rt/so-mapped
001d  +0x002b8  op=34  10 00 04 01  OR64             s4 = s16 | s0
001e  +0x002d0  op=34  13 00 05 00  OR64             s5 = s19 | s0
001f  +0x002e8  op=5e  42 00 00 00  CALL_CF_INDEX    call native_binding[index=0x42] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0025  +0x00378  op=34  1e 00 1d 00  OR64             s29 = s30 | s0
