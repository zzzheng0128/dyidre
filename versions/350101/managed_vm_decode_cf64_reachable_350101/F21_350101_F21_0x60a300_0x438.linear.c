/*
 * Auto-generated linear C-like lift for 350.101 managed program F21.
...
void managed_F21_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0006:
    /* +0x00090 op=0x54 05 01 22 20 CONST_HI16: s1 = sign_extend_32(0x2022 << 16) */
...
L_0008:
    /* +0x000c0 op=0xb5 00 03 0c 00 ADD32_IMM16: s3 = int32(s0 +0xc) */
    S[3] = (int32_t)((uint32_t)S[0] + 0xc);
...
L_000a:
    /* +0x000f0 op=0x34 10 00 05 01 OR64: s5 = s16 | s0 */
    S[5] = S[16] | S[0];
...
L_000e:
    /* +0x00150 op=0x18 10 04 01 07 SHL32_IMM: s1 = (int32_t)(s4 << 7) */
...
L_0010:
    /* +0x00180 op=0x0e 0d 04 04 03 LSR32_IMM: s4 = sign_extend_32((uint32_t)s4 >> 3) */
...
L_0013:
    /* +0x001c8 op=0x02 01 04 04 00 XOR64: s4 = s4 ^ s1 */
    S[4] = S[4] ^ S[1];
...
L_0016:
    /* +0x00210 op=0x18 11 04 06 0b SHL32_IMM: s6 = (int32_t)(s4 << 11) */
...
L_0018:
    /* +0x00240 op=0x0e 0b 04 06 05 LSR32_IMM: s6 = sign_extend_32((uint32_t)s4 >> 5) */
...
L_001b:
    /* +0x00288 op=0x36 01 00 04 01 NOR64: s4 = ~(s1 | s0) */
    S[4] = ~(S[1] | S[0]);
...
L_0025:
    /* +0x00378 op=0x33 01 01 04 00 OR_IMM16: s1 = s1 | 0x4 */
    S[1] = S[1] | 0x4;
