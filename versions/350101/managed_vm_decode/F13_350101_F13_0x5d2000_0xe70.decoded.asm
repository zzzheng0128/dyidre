...
0002  +0x00030  op=25  1d 1e 10 01  ST64             *(s29 +0x110) = s30
...
000a  +0x000f0  op=25  1d 10 d0 00  ST64             *(s29 +0xd0) = s16
...
0012  +0x001b0  op=58  04 01 20 00  LD64             s1 = *(uint64_t *)(s4 +0x20)
0013  +0x001c8  op=25  1e 01 10 00  ST64             *(s30 +0x10) = s1
0014  +0x001e0  op=53  03 01 08 03  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0x308 ; q1=0x125fd408 rt/so-mapped
...
0018  +0x00240  op=34  10 00 05 01  OR64             s5 = s16 | s0
0019  +0x00258  op=08  1e 02 cc 00  ST32             *(s30 +0xcc) = (uint32_t)s2
001a  +0x00270  op=34  12 00 04 01  OR64             s4 = s18 | s0
...
0028  +0x003c0  op=34  12 00 04 01  OR64             s4 = s18 | s0
0029  +0x003d8  op=34  15 00 06 00  OR64             s6 = s21 | s0
002a  +0x003f0  op=34  13 00 10 00  OR64             s16 = s19 | s0
...
0034  +0x004e0  op=34  15 00 05 01  OR64             s5 = s21 | s0
0035  +0x004f8  op=34  14 00 06 01  OR64             s6 = s20 | s0
0036  +0x00510  op=34  11 00 04 00  OR64             s4 = s17 | s0
...
003a  +0x00570  op=34  11 00 05 00  OR64             s5 = s17 | s0
003b  +0x00588  op=34  13 00 04 00  OR64             s4 = s19 | s0
...
004a  +0x006f0  op=34  15 00 04 01  OR64             s4 = s21 | s0
...
0058  +0x00840  op=34  11 00 04 01  OR64             s4 = s17 | s0
...
005a  +0x00870  op=85  1e 17 38 00  ADD64_IMM16      s23 = s30 +0x38
...
005e  +0x008d0  op=34  11 00 04 00  OR64             s4 = s17 | s0
005f  +0x008e8  op=5e  0c 00 00 00  CALL_CF_INDEX    call native_binding[index=0xc] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0060  +0x00900  op=53  04 01 79 00  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0x79 ; q1=0x125fd408 rt/so-mapped
0061  +0x00918  op=53  03 02 6d 00  LD_POOL_PTR      s2 = *(uint64_t *)q1 + 0x6d ; q1=0x125fd408 rt/so-mapped
0062  +0x00930  op=85  00 11 03 00  ADD64_IMM16      s17 = s0 +0x3
0063  +0x00948  op=85  1e 04 20 00  ADD64_IMM16      s4 = s30 +0x20
0064  +0x00960  op=59  01 03 02 00  LD8U             s3 = *(uint8_t *)(s1 +0x2)
0065  +0x00978  op=55  01 01 00 00  LD16U            s1 = *(uint16_t *)(s1 +0x0)
0066  +0x00990  op=34  11 00 05 01  OR64             s5 = s17 | s0
0067  +0x009a8  op=26  1e 03 26 00  ST8              *(s30 +0x26) = (uint8_t)s3
0068  +0x009c0  op=19  1e 01 24 00  ST16             *(s30 +0x24) = (uint16_t)s1
0069  +0x009d8  op=59  10 01 5e 01  LD8U             s1 = *(uint8_t *)(s16 +0x15e)
006a  +0x009f0  op=26  1e 01 22 00  ST8              *(s30 +0x22) = (uint8_t)s1
006b  +0x00a08  op=55  10 01 5c 01  LD16U            s1 = *(uint16_t *)(s16 +0x15c)
006c  +0x00a20  op=19  1e 01 20 00  ST16             *(s30 +0x20) = (uint16_t)s1
006d  +0x00a38  op=58  02 01 00 00  LD64             s1 = *(uint64_t *)(s2 +0x0)
006e  +0x00a50  op=59  02 02 08 00  LD8U             s2 = *(uint8_t *)(s2 +0x8)
006f  +0x00a68  op=26  1e 02 30 00  ST8              *(s30 +0x30) = (uint8_t)s2
0070  +0x00a80  op=25  1e 01 28 00  ST64             *(s30 +0x28) = s1
0071  +0x00a98  op=5e  2f 00 00 00  CALL_CF_INDEX    call native_binding[index=0x2f] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0072  +0x00ab0  op=85  1e 04 28 00  ADD64_IMM16      s4 = s30 +0x28
0073  +0x00ac8  op=85  00 05 09 00  ADD64_IMM16      s5 = s0 +0x9
0074  +0x00ae0  op=34  02 00 13 00  OR64             s19 = s2 | s0
0075  +0x00af8  op=5e  19 00 00 00  CALL_CF_INDEX    call native_binding[index=0x19] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0076  +0x00b10  op=58  1e 04 10 00  LD64             s4 = *(uint64_t *)(s30 +0x10)
0077  +0x00b28  op=34  02 00 06 00  OR64             s6 = s2 | s0
0078  +0x00b40  op=34  13 00 05 01  OR64             s5 = s19 | s0
0079  +0x00b58  op=5e  2e 00 00 00  CALL_CF_INDEX    call native_binding[index=0x2e] via q1 table ; q1=0x125fd3c0 rt/so-mapped  ; runtime: CF98 formatAllocString
007a  +0x00b70  op=85  1e 04 24 00  ADD64_IMM16      s4 = s30 +0x24
007b  +0x00b88  op=34  11 00 05 01  OR64             s5 = s17 | s0
007c  +0x00ba0  op=5e  20 00 00 00  CALL_CF_INDEX    call native_binding[index=0x20] via q1 table ; q1=0x125fd3c0 rt/so-mapped
007d  +0x00bb8  op=58  1e 06 48 00  LD64             s6 = *(uint64_t *)(s30 +0x48)
007e  +0x00bd0  op=58  1e 04 18 00  LD64             s4 = *(uint64_t *)(s30 +0x18)
007f  +0x00be8  op=34  02 00 05 01  OR64             s5 = s2 | s0
0080  +0x00c00  op=5e  2e 00 00 00  CALL_CF_INDEX    call native_binding[index=0x2e] via q1 table ; q1=0x125fd3c0 rt/so-mapped  ; runtime: CF98 formatAllocString
0081  +0x00c18  op=34  17 00 04 00  OR64             s4 = s23 | s0
0082  +0x00c30  op=5e  07 00 00 00  CALL_CF_INDEX    call native_binding[index=0x7] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0083  +0x00c48  op=34  16 00 04 00  OR64             s4 = s22 | s0
0084  +0x00c60  op=5e  07 00 00 00  CALL_CF_INDEX    call native_binding[index=0x7] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0085  +0x00c78  op=34  15 00 04 00  OR64             s4 = s21 | s0
0086  +0x00c90  op=5e  07 00 00 00  CALL_CF_INDEX    call native_binding[index=0x7] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0087  +0x00ca8  op=34  14 00 04 01  OR64             s4 = s20 | s0
0088  +0x00cc0  op=5e  07 00 00 00  CALL_CF_INDEX    call native_binding[index=0x7] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0089  +0x00cd8  op=34  12 00 04 01  OR64             s4 = s18 | s0
008a  +0x00cf0  op=5e  07 00 00 00  CALL_CF_INDEX    call native_binding[index=0x7] via q1 table ; q1=0x125fd3c0 rt/so-mapped
008b  +0x00d08  op=58  1e 04 08 00  LD64             s4 = *(uint64_t *)(s30 +0x8)
008c  +0x00d20  op=5e  07 00 00 00  CALL_CF_INDEX    call native_binding[index=0x7] via q1 table ; q1=0x125fd3c0 rt/so-mapped
008d  +0x00d38  op=34  1e 00 1d 01  OR64             s29 = s30 | s0
008e  +0x00d50  op=58  1d 10 d0 00  LD64             s16 = *(uint64_t *)(s29 +0xd0)
008f  +0x00d68  op=58  1d 11 d8 00  LD64             s17 = *(uint64_t *)(s29 +0xd8)
0090  +0x00d80  op=58  1d 12 e0 00  LD64             s18 = *(uint64_t *)(s29 +0xe0)
0091  +0x00d98  op=58  1d 13 e8 00  LD64             s19 = *(uint64_t *)(s29 +0xe8)
0092  +0x00db0  op=58  1d 14 f0 00  LD64             s20 = *(uint64_t *)(s29 +0xf0)
0093  +0x00dc8  op=58  1d 15 f8 00  LD64             s21 = *(uint64_t *)(s29 +0xf8)
0094  +0x00de0  op=58  1d 16 00 01  LD64             s22 = *(uint64_t *)(s29 +0x100)
0095  +0x00df8  op=58  1d 17 08 01  LD64             s23 = *(uint64_t *)(s29 +0x108)
0096  +0x00e10  op=58  1d 1e 10 01  LD64             s30 = *(uint64_t *)(s29 +0x110)
0097  +0x00e28  op=58  1d 1f 18 01  LD64             s31 = *(uint64_t *)(s29 +0x118)
0098  +0x00e40  op=85  1d 1d 20 01  ADD64_IMM16      s29 = s29 +0x120
