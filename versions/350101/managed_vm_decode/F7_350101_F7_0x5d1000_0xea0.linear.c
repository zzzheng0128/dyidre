...
L_0002:
    /* +0x00030 op=0x25 1d 1e 10 01 ST64: *(s29 +0x110) = s30 q1=0x12274848 */
...
L_000a:
    /* +0x000f0 op=0x25 1d 10 d0 00 ST64: *(s29 +0xd0) = s16 q1=0x12274848 */
...
L_0012:
    /* +0x001b0 op=0x58 04 01 20 00 LD64: s1 = *(uint64_t *)(s4 +0x20) q1=0x12274848 */
...
L_0014:
    /* +0x001e0 op=0x53 04 01 08 03 LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0x308 q1=0x125fd408 */
...
L_0018:
    /* +0x00240 op=0x34 10 00 05 00 OR64: s5 = s16 | s0 */
    S[5] = S[16] | S[0];
...
L_001a:
    /* +0x00270 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 q1=0x12274848 */
    S[4] = S[18] | S[0];
...
L_0020:
    /* +0x00300 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_0022:
    /* +0x00330 op=0x85 1e 12 98 00 ADD64_IMM16: s18 = s30 +0x98 q1=0x12274848 */
    S[18] = S[30] + 0x98;
...
L_0028:
    /* +0x003c0 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];

L_0029:
    /* +0x003d8 op=0x34 15 00 06 01 OR64: s6 = s21 | s0 */
    S[6] = S[21] | S[0];

L_002a:
    /* +0x003f0 op=0x34 13 00 10 01 OR64: s16 = s19 | s0 q1=0x12274848 */
    S[16] = S[19] | S[0];
...
L_0034:
    /* +0x004e0 op=0x34 15 00 05 00 OR64: s5 = s21 | s0 */
    S[5] = S[21] | S[0];

L_0035:
    /* +0x004f8 op=0x34 14 00 06 00 OR64: s6 = s20 | s0 */
    S[6] = S[20] | S[0];

L_0036:
    /* +0x00510 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_003a:
    /* +0x00570 op=0x34 11 00 05 00 OR64: s5 = s17 | s0 q1=0x12274848 */
    S[5] = S[17] | S[0];

L_003b:
    /* +0x00588 op=0x34 13 00 04 01 OR64: s4 = s19 | s0 */
    S[4] = S[19] | S[0];
...
L_003f:
    /* +0x005e8 op=0x34 14 00 04 00 OR64: s4 = s20 | s0 */
    S[4] = S[20] | S[0];
...
L_0041:
    /* +0x00618 op=0x34 13 00 04 01 OR64: s4 = s19 | s0 */
    S[4] = S[19] | S[0];
...
L_004a:
    /* +0x006f0 op=0x34 15 00 04 01 OR64: s4 = s21 | s0 q1=0x12274848 */
    S[4] = S[21] | S[0];
...
L_004d:
    /* +0x00738 op=0x34 16 00 04 00 OR64: s4 = s22 | s0 */
    S[4] = S[22] | S[0];
...
L_004f:
    /* +0x00768 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_0058:
    /* +0x00840 op=0x34 11 00 04 00 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_005a:
    /* +0x00870 op=0x85 1e 17 38 00 ADD64_IMM16: s23 = s30 +0x38 q1=0x12274848 */
    S[23] = S[30] + 0x38;
...
L_005e:
    /* +0x008d0 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_0060:
    /* +0x00900 op=0x59 10 03 f8 00 LD8U: s3 = *(uint8_t *)(s16 +0xf8) */
    S[3] = *(uint8_t *)((uint8_t *)S[16] + 0xf8);

L_0061:
    /* +0x00918 op=0x54 00 01 8f b1 CONST_HI16: s1 = sign_extend_32(0xb18f << 16) */
    S[1] = (int32_t)(0xb18f << 16);

L_0062:
    /* +0x00930 op=0x53 01 02 58 00 LD_POOL_PTR: s2 = *(uint64_t *)q1 + 0x58 q1=0x125fd408 */
    S[2] = *(uint64_t *)(uintptr_t)0x125fd408 + 0x58;

L_0063:
    /* +0x00948 op=0x85 00 11 03 00 ADD64_IMM16: s17 = s0 +0x3 */
    S[17] = S[0] + 0x3;

L_0064:
    /* +0x00960 op=0x85 1e 04 20 00 ADD64_IMM16: s4 = s30 +0x20 */
    S[4] = S[30] + 0x20;

L_0065:
    /* +0x00978 op=0x33 01 01 35 ff OR_IMM16: s1 = s1 | 0xff35 */
    S[1] = S[1] | 0xff35;
...
L_0068:
    /* +0x009c0 op=0x6e 00 01 01 10 SHL64_IMM: s1 = s1 << 16 */
    S[1] = S[1] << 16;

L_0069:
    /* +0x009d8 op=0x55 10 03 f6 00 LD16U: s3 = *(uint16_t *)(s16 +0xf6) */
    S[3] = *(uint16_t *)((uint8_t *)S[16] + 0xf6);

L_006a:
    /* +0x009f0 op=0x85 01 01 3d a6 ADD64_IMM16: s1 = s1 -0x59c3 q1=0x12274848 */
    S[1] = S[1] + (-0x59c3);

L_006b:
    /* +0x00a08 op=0x6e 12 01 01 10 SHL64_IMM: s1 = s1 << 16 */
    S[1] = S[1] << 16;

L_006c:
    /* +0x00a20 op=0x19 1e 03 24 00 ST16: *(s30 +0x24) = (uint16_t)s3 */
    *(uint16_t *)((uint8_t *)S[30] + 0x24) = (uint16_t)S[3];

L_006d:
    /* +0x00a38 op=0x59 02 03 02 00 LD8U: s3 = *(uint8_t *)(s2 +0x2) */
    S[3] = *(uint8_t *)((uint8_t *)S[2] + 0x2);

L_006e:
    /* +0x00a50 op=0x55 02 02 00 00 LD16U: s2 = *(uint16_t *)(s2 +0x0) */
    S[2] = *(uint16_t *)((uint8_t *)S[2] + 0x0);

L_006f:
    /* +0x00a68 op=0x85 01 01 fd 3d ADD64_IMM16: s1 = s1 +0x3dfd */
    S[1] = S[1] + 0x3dfd;
...
L_0071:
    /* +0x00a98 op=0x26 1e 03 22 00 ST8: *(s30 +0x22) = (uint8_t)s3 */
    *(uint8_t *)((uint8_t *)S[30] + 0x22) = (uint8_t)S[3];

L_0072:
    /* +0x00ab0 op=0x19 1e 02 20 00 ST16: *(s30 +0x20) = (uint16_t)s2 q1=0x12274848 */
    *(uint16_t *)((uint8_t *)S[30] + 0x20) = (uint16_t)S[2];

L_0073:
    /* +0x00ac8 op=0x5e 19 00 00 00 CALL_CF_INDEX: call native_binding[index=0x19] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x19, (void *)(uintptr_t)0x125fd3c0);

L_0074:
    /* +0x00ae0 op=0x85 1e 04 28 00 ADD64_IMM16: s4 = s30 +0x28 */
    S[4] = S[30] + 0x28;

L_0075:
    /* +0x00af8 op=0x85 00 05 08 00 ADD64_IMM16: s5 = s0 +0x8 */
    S[5] = S[0] + 0x8;

L_0076:
    /* +0x00b10 op=0x34 02 00 13 00 OR64: s19 = s2 | s0 */
    S[19] = S[2] | S[0];

L_0077:
    /* +0x00b28 op=0x5e 20 00 00 00 CALL_CF_INDEX: call native_binding[index=0x20] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x20, (void *)(uintptr_t)0x125fd3c0);

L_0078:
    /* +0x00b40 op=0x58 1e 04 10 00 LD64: s4 = *(uint64_t *)(s30 +0x10) */
    S[4] = *(uint64_t *)((uint8_t *)S[30] + 0x10);

L_0079:
    /* +0x00b58 op=0x34 02 00 06 00 OR64: s6 = s2 | s0 */
    S[6] = S[2] | S[0];

L_007a:
    /* +0x00b70 op=0x34 13 00 05 00 OR64: s5 = s19 | s0 q1=0x12274848 */
    S[5] = S[19] | S[0];

L_007b:
    /* +0x00b88 op=0x5e 2e 00 00 00 CALL_CF_INDEX: call native_binding[index=0x2e] via q1 table runtime: CF98 formatAllocString q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x2e, (void *)(uintptr_t)0x125fd3c0);

L_007c:
    /* +0x00ba0 op=0x85 1e 04 24 00 ADD64_IMM16: s4 = s30 +0x24 */
    S[4] = S[30] + 0x24;

L_007d:
    /* +0x00bb8 op=0x34 11 00 05 00 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];

L_007e:
    /* +0x00bd0 op=0x5e 2c 00 00 00 CALL_CF_INDEX: call native_binding[index=0x2c] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x2c, (void *)(uintptr_t)0x125fd3c0);

L_007f:
    /* +0x00be8 op=0x58 1e 06 48 00 LD64: s6 = *(uint64_t *)(s30 +0x48) */
    S[6] = *(uint64_t *)((uint8_t *)S[30] + 0x48);

L_0080:
    /* +0x00c00 op=0x58 1e 04 18 00 LD64: s4 = *(uint64_t *)(s30 +0x18) */
    S[4] = *(uint64_t *)((uint8_t *)S[30] + 0x18);

L_0081:
    /* +0x00c18 op=0x34 02 00 05 01 OR64: s5 = s2 | s0 */
    S[5] = S[2] | S[0];

L_0082:
    /* +0x00c30 op=0x5e 2e 00 00 00 CALL_CF_INDEX: call native_binding[index=0x2e] via q1 table runtime: CF98 formatAllocString q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x2e, (void *)(uintptr_t)0x125fd3c0);

L_0083:
    /* +0x00c48 op=0x34 17 00 04 01 OR64: s4 = s23 | s0 */
    S[4] = S[23] | S[0];
...
L_0085:
    /* +0x00c78 op=0x34 16 00 04 00 OR64: s4 = s22 | s0 */
    S[4] = S[22] | S[0];
...
L_0087:
    /* +0x00ca8 op=0x34 15 00 04 01 OR64: s4 = s21 | s0 */
    S[4] = S[21] | S[0];
...
L_0089:
    /* +0x00cd8 op=0x34 14 00 04 01 OR64: s4 = s20 | s0 */
    S[4] = S[20] | S[0];
...
L_008b:
    /* +0x00d08 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_008d:
    /* +0x00d38 op=0x58 1e 04 08 00 LD64: s4 = *(uint64_t *)(s30 +0x8) */
    S[4] = *(uint64_t *)((uint8_t *)S[30] + 0x8);

L_008e:
    /* +0x00d50 op=0x5e 07 00 00 00 CALL_CF_INDEX: call native_binding[index=0x7] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x7, (void *)(uintptr_t)0x125fd3c0);

L_008f:
    /* +0x00d68 op=0x34 1e 00 1d 01 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];

L_0090:
    /* +0x00d80 op=0x58 1d 10 d0 00 LD64: s16 = *(uint64_t *)(s29 +0xd0) */
    S[16] = *(uint64_t *)((uint8_t *)S[29] + 0xd0);

L_0091:
    /* +0x00d98 op=0x58 1d 11 d8 00 LD64: s17 = *(uint64_t *)(s29 +0xd8) */
    S[17] = *(uint64_t *)((uint8_t *)S[29] + 0xd8);

L_0092:
    /* +0x00db0 op=0x58 1d 12 e0 00 LD64: s18 = *(uint64_t *)(s29 +0xe0) q1=0x12274848 */
    S[18] = *(uint64_t *)((uint8_t *)S[29] + 0xe0);

L_0093:
    /* +0x00dc8 op=0x58 1d 13 e8 00 LD64: s19 = *(uint64_t *)(s29 +0xe8) */
    S[19] = *(uint64_t *)((uint8_t *)S[29] + 0xe8);

L_0094:
    /* +0x00de0 op=0x58 1d 14 f0 00 LD64: s20 = *(uint64_t *)(s29 +0xf0) */
    S[20] = *(uint64_t *)((uint8_t *)S[29] + 0xf0);

L_0095:
    /* +0x00df8 op=0x58 1d 15 f8 00 LD64: s21 = *(uint64_t *)(s29 +0xf8) */
    S[21] = *(uint64_t *)((uint8_t *)S[29] + 0xf8);

L_0096:
    /* +0x00e10 op=0x58 1d 16 00 01 LD64: s22 = *(uint64_t *)(s29 +0x100) */
    S[22] = *(uint64_t *)((uint8_t *)S[29] + 0x100);

L_0097:
    /* +0x00e28 op=0x58 1d 17 08 01 LD64: s23 = *(uint64_t *)(s29 +0x108) */
    S[23] = *(uint64_t *)((uint8_t *)S[29] + 0x108);

L_0098:
    /* +0x00e40 op=0x58 1d 1e 10 01 LD64: s30 = *(uint64_t *)(s29 +0x110) */
    S[30] = *(uint64_t *)((uint8_t *)S[29] + 0x110);

L_0099:
    /* +0x00e58 op=0x58 1d 1f 18 01 LD64: s31 = *(uint64_t *)(s29 +0x118) */
    S[31] = *(uint64_t *)((uint8_t *)S[29] + 0x118);

L_009a:
    /* +0x00e70 op=0x85 1d 1d 20 01 ADD64_IMM16: s29 = s29 +0x120 q1=0x12274848 */
    S[29] = S[29] + 0x120;

L_009b:
    /* +0x00e88 op=0x5b 1f 00 00 00 RET: return/leave with s31 */
    return; /* RET s31 */
