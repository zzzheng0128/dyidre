; MetaSec managed bytecode decode: F31
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_thirdhop_bodies_20260905/350101_F31_0x6a9000_0x14d0.bin
...
000f  +0x00168  op=34  05 00 14 01  OR64             s20 = s5 | s0
...
0019  +0x00258  op=18  11 14 03 00  SHL32_IMM        s3 = (int32_t)(s20 << 0)
001a  +0x00270  op=b5  00 02 00 ff  ADD32_IMM16      s2 = int32(s0 -0x100)
001b  +0x00288  op=53  01 04 a1 01  LD_POOL_PTR      s4 = *(uint64_t *)q1 + 0x1a1 ; q1=0x125fd3a8 rt/so-mapped
001c  +0x002a0  op=34  03 00 05 00  OR64             s5 = s3 | s0
001d  +0x002b8  op=ae  12 13 0f 00  BR_EQ64          if (s18 == s19) goto record +45
001e  +0x002d0  op=10  0e 05 01 1f  ASR32_IMM        s1 = sign_extend_32((int32_t)s5 >> 31)
001f  +0x002e8  op=84  11 12 06 00  ADD64            s6 = s17 + s18
0020  +0x00300  op=85  12 12 01 00  ADD64_IMM16      s18 = s18 +0x1
0021  +0x00318  op=0e  00 01 01 18  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 24)
0022  +0x00330  op=b4  05 01 01 00  ADD32            s1 = int32(s5 + s1)
0023  +0x00348  op=b3  01 02 01 01  AND64            s1 = s1 & s2
0024  +0x00360  op=09  05 01 01 14  SUB32            s1 = sign_extend_32((uint32_t)s5 - (uint32_t)s1)
0025  +0x00378  op=b5  05 05 01 00  ADD32_IMM16      s5 = int32(s5 +0x1)
0026  +0x00390  op=84  04 01 01 14  ADD64            s1 = s4 + s1
0027  +0x003a8  op=59  01 01 00 00  LD8U             s1 = *(uint8_t *)(s1 +0x0)
0028  +0x003c0  op=0e  00 01 07 03  LSR32_IMM        s7 = sign_extend_32((uint32_t)s1 >> 3)
0029  +0x003d8  op=18  00 01 01 05  SHL32_IMM        s1 = (int32_t)(s1 << 5)
002a  +0x003f0  op=34  01 07 01 01  OR64             s1 = s1 | s7
...
0032  +0x004b0  op=53  04 07 a1 06  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0x6a1 ; q1=0x125fd3a8 rt/so-mapped
0033  +0x004c8  op=53  03 08 b1 06  LD_POOL_PTR      s8 = *(uint64_t *)q1 + 0x6b1 ; q1=0x125fd3a8 rt/so-mapped
0034  +0x004e0  op=ae  09 04 17 00  BR_EQ64          if (s9 == s4) goto record +76
0035  +0x004f8  op=10  0e 03 01 1f  ASR32_IMM        s1 = sign_extend_32((int32_t)s3 >> 31)
0036  +0x00510  op=84  02 09 0b 04  ADD64            s11 = s2 + s9
0037  +0x00528  op=85  09 0a 01 00  ADD64_IMM16      s10 = s9 +0x1
0038  +0x00540  op=84  05 09 09 00  ADD64            s9 = s5 + s9
0039  +0x00558  op=0e  0d 01 01 1c  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 28)
003a  +0x00570  op=b4  03 01 01 00  ADD32            s1 = int32(s3 + s1)
003b  +0x00588  op=b3  01 06 01 00  AND64            s1 = s1 & s6
003c  +0x005a0  op=09  03 01 01 14  SUB32            s1 = sign_extend_32((uint32_t)s3 - (uint32_t)s1)
003d  +0x005b8  op=b5  03 03 01 00  ADD32_IMM16      s3 = int32(s3 +0x1)
003e  +0x005d0  op=84  08 01 0c 14  ADD64            s12 = s8 + s1
003f  +0x005e8  op=84  07 01 01 04  ADD64            s1 = s7 + s1
0040  +0x00600  op=59  0c 0c 00 00  LD8U             s12 = *(uint8_t *)(s12 +0x0)
0041  +0x00618  op=59  01 01 00 00  LD8U             s1 = *(uint8_t *)(s1 +0x0)
0042  +0x00630  op=0e  0d 0c 0d 03  LSR32_IMM        s13 = sign_extend_32((uint32_t)s12 >> 3)
0043  +0x00648  op=18  00 0c 0c 05  SHL32_IMM        s12 = (int32_t)(s12 << 5)
0044  +0x00660  op=34  0c 0d 0c 01  OR64             s12 = s12 | s13
0045  +0x00678  op=26  0b 0c 00 00  ST8              *(s11 +0x0) = (uint8_t)s12
0046  +0x00690  op=0e  00 01 0b 03  LSR32_IMM        s11 = sign_extend_32((uint32_t)s1 >> 3)
0047  +0x006a8  op=18  10 01 01 05  SHL32_IMM        s1 = (int32_t)(s1 << 5)
...
004f  +0x00768  op=84  02 03 06 14  ADD64            s6 = s2 + s3
...
005f  +0x008e8  op=59  05 08 01 00  LD8U             s8 = *(uint8_t *)(s5 +0x1)
0060  +0x00900  op=59  05 0a fe ff  LD8U             s10 = *(uint8_t *)(s5 -0x2)
0061  +0x00918  op=59  05 0b 00 00  LD8U             s11 = *(uint8_t *)(s5 +0x0)
0062  +0x00930  op=59  05 09 ff ff  LD8U             s9 = *(uint8_t *)(s5 -0x1)
0063  +0x00948  op=59  05 0c 03 00  LD8U             s12 = *(uint8_t *)(s5 +0x3)
0064  +0x00960  op=59  05 0f fd ff  LD8U             s15 = *(uint8_t *)(s5 -0x3)
0065  +0x00978  op=59  05 0e 04 00  LD8U             s14 = *(uint8_t *)(s5 +0x4)
0066  +0x00990  op=59  05 18 02 00  LD8U             s24 = *(uint8_t *)(s5 +0x2)
...
0073  +0x00ac8  op=84  11 01 01 14  ADD64            s1 = s17 + s1
0074  +0x00ae0  op=84  11 09 14 00  ADD64            s20 = s17 + s9
...
0079  +0x00b58  op=84  11 0a 0f 00  ADD64            s15 = s17 + s10
007a  +0x00b70  op=84  11 0c 0a 04  ADD64            s10 = s17 + s12
007b  +0x00b88  op=84  11 07 0c 14  ADD64            s12 = s17 + s7
007c  +0x00ba0  op=84  11 0b 01 04  ADD64            s1 = s17 + s11
007d  +0x00bb8  op=84  11 0e 0b 04  ADD64            s11 = s17 + s14
...
0088  +0x00cc0  op=18  10 19 19 00  SHL32_IMM        s25 = (int32_t)(s25 << 0)
...
00a5  +0x00f78  op=02  17 18 18 00  XOR64            s24 = s24 ^ s23
...
00b0  +0x01080  op=84  10 12 12 00  ADD64            s18 = s16 + s18
00b1  +0x01098  op=84  10 13 13 00  ADD64            s19 = s16 + s19
...
00b9  +0x01158  op=84  10 15 0f 04  ADD64            s15 = s16 + s21
00ba  +0x01170  op=67  00 0d 0d 00  LSR64_IMM32PLUS  s13 = (uint64_t)s13 >> (0 + 32)
00bb  +0x01188  op=84  10 0d 0d 04  ADD64            s13 = s16 + s13
...
00c0  +0x01200  op=02  0d 0c 0c 00  XOR64            s12 = s12 ^ s13
...
00c4  +0x01260  op=02  0c 09 09 00  XOR64            s9 = s9 ^ s12
...
00ca  +0x012f0  op=02  09 0a 09 00  XOR64            s9 = s10 ^ s9
...
00cf  +0x01368  op=34  01 00 05 00  OR64             s5 = s1 | s0
