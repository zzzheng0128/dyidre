/*
 * Auto-generated linear C-like lift for 350.101 managed program F40.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_thirdhop_bodies_20260905/350101_F40_0x614c00_0x330.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F40_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0005:
    /* +0x00078 op=0x84 03 04 06 00 ADD64: s6 = s3 + s4 */
    S[6] = S[3] + S[4];

L_0006:
    /* +0x00090 op=0x84 02 04 01 14 ADD64: s1 = s2 + s4 */
    S[1] = S[2] + S[4];
...
L_0009:
    /* +0x000d8 op=0x73 13 07 07 02 ROR64_IMM: s7 = ror64(s7, 2) */
    S[7] = ror64(S[7], 2);

L_000a:
    /* +0x000f0 op=0x25 01 07 18 00 ST64: *(s1 +0x18) = s7 */
...
L_000c:
    /* +0x00120 op=0x73 13 07 07 02 ROR64_IMM: s7 = ror64(s7, 2) */
    S[7] = ror64(S[7], 2);
...
L_000f:
    /* +0x00168 op=0x73 11 07 07 02 ROR64_IMM: s7 = ror64(s7, 2) */
    S[7] = ror64(S[7], 2);

L_0010:
    /* +0x00180 op=0x25 01 07 f0 ff ST64: *(s1 -0x10) = s7 */
...
L_0012:
    /* +0x001b0 op=0x73 13 07 07 02 ROR64_IMM: s7 = ror64(s7, 2) */
    S[7] = ror64(S[7], 2);
...
L_0015:
    /* +0x001f8 op=0x73 13 07 07 02 ROR64_IMM: s7 = ror64(s7, 2) */
    S[7] = ror64(S[7], 2);
...
L_0018:
    /* +0x00240 op=0x73 01 07 07 02 ROR64_IMM: s7 = ror64(s7, 2) */
    S[7] = ror64(S[7], 2);

L_0019:
    /* +0x00258 op=0x25 01 07 00 00 ST64: *(s1 +0x0) = s7 */
...
L_001b:
    /* +0x00288 op=0x73 11 07 07 02 ROR64_IMM: s7 = ror64(s7, 2) */
    S[7] = ror64(S[7], 2);

L_001c:
    /* +0x002a0 op=0x25 01 07 10 00 ST64: *(s1 +0x10) = s7 */
    *(uint64_t *)((uint8_t *)S[1] + 0x10) = S[7];
...
L_001e:
    /* +0x002d0 op=0x73 01 06 06 02 ROR64_IMM: s6 = ror64(s6, 2) */
    S[6] = ror64(S[6], 2);
