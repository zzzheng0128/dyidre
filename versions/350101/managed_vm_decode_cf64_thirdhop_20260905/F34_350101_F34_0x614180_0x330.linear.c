...
L_0009:
    /* +0x000d8 op=0x72 01 07 07 16 ROL64_32MINUS_IMM: s7 = rol64(s7, 32 - 22) */
    S[7] = rol64(S[7], 32 - 22);

L_000a:
    /* +0x000f0 op=0x25 01 07 e8 ff ST64: *(s1 -0x18) = s7 */
...
L_000c:
    /* +0x00120 op=0x72 01 07 07 16 ROL64_32MINUS_IMM: s7 = rol64(s7, 32 - 22) */
    S[7] = rol64(S[7], 32 - 22);

L_000d:
    /* +0x00138 op=0x25 01 07 08 00 ST64: *(s1 +0x8) = s7 */
...
L_000f:
    /* +0x00168 op=0x72 01 07 07 16 ROL64_32MINUS_IMM: s7 = rol64(s7, 32 - 22) */
    S[7] = rol64(S[7], 32 - 22);

L_0010:
    /* +0x00180 op=0x25 01 07 e0 ff ST64: *(s1 -0x20) = s7 */
...
L_0012:
    /* +0x001b0 op=0x72 01 07 07 16 ROL64_32MINUS_IMM: s7 = rol64(s7, 32 - 22) */
    S[7] = rol64(S[7], 32 - 22);

L_0013:
    /* +0x001c8 op=0x25 01 07 10 00 ST64: *(s1 +0x10) = s7 */
...
L_0015:
    /* +0x001f8 op=0x72 01 07 07 16 ROL64_32MINUS_IMM: s7 = rol64(s7, 32 - 22) */
    S[7] = rol64(S[7], 32 - 22);

L_0016:
    /* +0x00210 op=0x25 01 07 f0 ff ST64: *(s1 -0x10) = s7 */
    *(uint64_t *)((uint8_t *)S[1] + (-0x10)) = S[7];
...
L_0018:
    /* +0x00240 op=0x72 01 07 07 16 ROL64_32MINUS_IMM: s7 = rol64(s7, 32 - 22) */
    S[7] = rol64(S[7], 32 - 22);

L_0019:
    /* +0x00258 op=0x25 01 07 18 00 ST64: *(s1 +0x18) = s7 */
    *(uint64_t *)((uint8_t *)S[1] + 0x18) = S[7];
...
L_001b:
    /* +0x00288 op=0x72 01 07 07 16 ROL64_32MINUS_IMM: s7 = rol64(s7, 32 - 22) */
    S[7] = rol64(S[7], 32 - 22);

L_001c:
    /* +0x002a0 op=0x25 01 07 f8 ff ST64: *(s1 -0x8) = s7 */
    *(uint64_t *)((uint8_t *)S[1] + (-0x8)) = S[7];
...
L_001e:
    /* +0x002d0 op=0x72 01 06 06 16 ROL64_32MINUS_IMM: s6 = rol64(s6, 32 - 22) */
    S[6] = rol64(S[6], 32 - 22);
