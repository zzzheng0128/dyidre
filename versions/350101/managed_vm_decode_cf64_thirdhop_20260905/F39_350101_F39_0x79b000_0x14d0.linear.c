/*
 * Auto-generated linear C-like lift for 350.101 managed program F39.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_thirdhop_bodies_20260905/350101_F39_0x79b000_0x14d0.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F39_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0019:
    /* +0x00258 op=0x18 00 14 03 00 SHL32_IMM: s3 = (int32_t)(s20 << 0) */
...
L_001b:
    /* +0x00288 op=0x53 03 04 a1 05 LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0x5a1 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x5a1;
...
L_001f:
    /* +0x002e8 op=0x84 11 12 06 04 ADD64: s6 = s17 + s18 */
    S[6] = S[17] + S[18];
...
L_0021:
    /* +0x00318 op=0x0e 00 01 01 18 LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 24) */
    S[1] = (int32_t)((uint32_t)S[1] >> 24);

L_0022:
    /* +0x00330 op=0xb4 05 01 01 02 ADD32: s1 = int32(s5 + s1) */
...
L_0024:
    /* +0x00360 op=0x09 05 01 01 14 SUB32: s1 = sign_extend_32((uint32_t)s5 - (uint32_t)s1) */
    S[1] = (int32_t)((uint32_t)S[5] - (uint32_t)S[1]);
...
L_0026:
    /* +0x00390 op=0x84 04 01 01 00 ADD64: s1 = s4 + s1 */
    S[1] = S[4] + S[1];
...
L_0028:
    /* +0x003c0 op=0x0e 0b 01 07 02 LSR32_IMM: s7 = sign_extend_32((uint32_t)s1 >> 2) */
    S[7] = (int32_t)((uint32_t)S[1] >> 2);

L_0029:
    /* +0x003d8 op=0x18 10 01 01 06 SHL32_IMM: s1 = (int32_t)(s1 << 6) */
    S[1] = (int32_t)((uint32_t)S[1] << 6);
...
L_0035:
    /* +0x004f8 op=0x10 0f 03 01 1f ASR32_IMM: s1 = sign_extend_32((int32_t)s3 >> 31) */
    S[1] = (int32_t)((int32_t)S[3] >> 31);

L_0036:
    /* +0x00510 op=0x84 02 09 0b 14 ADD64: s11 = s2 + s9 */
    S[11] = S[2] + S[9];
...
L_0038:
    /* +0x00540 op=0x84 05 09 09 00 ADD64: s9 = s5 + s9 */
    S[9] = S[5] + S[9];
...
L_0042:
    /* +0x00630 op=0x0e 00 0c 0d 02 LSR32_IMM: s13 = sign_extend_32((uint32_t)s12 >> 2) */
    S[13] = (int32_t)((uint32_t)S[12] >> 2);

L_0043:
    /* +0x00648 op=0x18 11 0c 0c 06 SHL32_IMM: s12 = (int32_t)(s12 << 6) */
    S[12] = (int32_t)((uint32_t)S[12] << 6);

L_0044:
    /* +0x00660 op=0x34 0c 0d 0c 00 OR64: s12 = s12 | s13 */
    S[12] = S[12] | S[13];
...
L_0046:
    /* +0x00690 op=0x0e 0d 01 0b 02 LSR32_IMM: s11 = sign_extend_32((uint32_t)s1 >> 2) */
    S[11] = (int32_t)((uint32_t)S[1] >> 2);

L_0047:
    /* +0x006a8 op=0x18 10 01 01 06 SHL32_IMM: s1 = (int32_t)(s1 << 6) */
    S[1] = (int32_t)((uint32_t)S[1] << 6);
...
L_0052:
    /* +0x007b0 op=0x02 06 01 01 01 XOR64: s1 = s1 ^ s6 */
    S[1] = S[1] ^ S[6];
...
L_005f:
    /* +0x008e8 op=0x59 05 08 00 00 LD8U: s8 = *(uint8_t *)(s5 +0x0) */
    S[8] = *(uint8_t *)((uint8_t *)S[5] + 0x0);

L_0060:
    /* +0x00900 op=0x59 05 0a 03 00 LD8U: s10 = *(uint8_t *)(s5 +0x3) */
    S[10] = *(uint8_t *)((uint8_t *)S[5] + 0x3);

L_0061:
    /* +0x00918 op=0x59 05 0b 01 00 LD8U: s11 = *(uint8_t *)(s5 +0x1) */
...
L_0063:
    /* +0x00948 op=0x59 05 0c fd ff LD8U: s12 = *(uint8_t *)(s5 -0x3) */
    S[12] = *(uint8_t *)((uint8_t *)S[5] + (-0x3));

L_0064:
    /* +0x00960 op=0x59 05 0f fe ff LD8U: s15 = *(uint8_t *)(s5 -0x2) */
    S[15] = *(uint8_t *)((uint8_t *)S[5] + (-0x2));

L_0065:
    /* +0x00978 op=0x59 05 0e ff ff LD8U: s14 = *(uint8_t *)(s5 -0x1) */
    S[14] = *(uint8_t *)((uint8_t *)S[5] + (-0x1));

L_0066:
    /* +0x00990 op=0x59 05 18 04 00 LD8U: s24 = *(uint8_t *)(s5 +0x4) */
    S[24] = *(uint8_t *)((uint8_t *)S[5] + 0x4);
...
L_0078:
    /* +0x00b40 op=0x02 0f 01 09 01 XOR64: s9 = s1 ^ s15 */
    S[9] = S[1] ^ S[15];

L_0079:
    /* +0x00b58 op=0x84 11 0a 0f 00 ADD64: s15 = s17 + s10 */
    S[15] = S[17] + S[10];
...
L_007c:
    /* +0x00ba0 op=0x84 11 0b 01 14 ADD64: s1 = s17 + s11 */
    S[1] = S[17] + S[11];
...
L_0093:
    /* +0x00dc8 op=0x84 11 12 12 00 ADD64: s18 = s17 + s18 */
    S[18] = S[17] + S[18];
...
L_00a3:
    /* +0x00f48 op=0x84 10 17 17 14 ADD64: s23 = s16 + s23 */
    S[23] = S[16] + S[23];
...
L_00b1:
    /* +0x01098 op=0x84 10 13 13 00 ADD64: s19 = s16 + s19 */
    S[19] = S[16] + S[19];
...
L_00b4:
    /* +0x010e0 op=0x84 10 16 16 14 ADD64: s22 = s16 + s22 */
    S[22] = S[16] + S[22];
...
L_00ca:
    /* +0x012f0 op=0x02 09 0a 09 00 XOR64: s9 = s10 ^ s9 */
    S[9] = S[10] ^ S[9];
