...
0009  +0x000d8  op=72  01 07 07 13  ROL64_32MINUS_IMM s7 = rol64(s7, 32 - 19)
000a  +0x000f0  op=25  01 07 f0 ff  ST64             *(s1 -0x10) = s7
000b  +0x00108  op=58  06 07 d0 ff  LD64             s7 = *(uint64_t *)(s6 -0x30)
000c  +0x00120  op=72  01 07 07 13  ROL64_32MINUS_IMM s7 = rol64(s7, 32 - 19)
000d  +0x00138  op=25  01 07 c8 ff  ST64             *(s1 -0x38) = s7
000e  +0x00150  op=58  06 07 d8 ff  LD64             s7 = *(uint64_t *)(s6 -0x28)
000f  +0x00168  op=72  01 07 07 13  ROL64_32MINUS_IMM s7 = rol64(s7, 32 - 19)
0010  +0x00180  op=25  01 07 00 00  ST64             *(s1 +0x0) = s7
0011  +0x00198  op=58  06 07 e0 ff  LD64             s7 = *(uint64_t *)(s6 -0x20)
0012  +0x001b0  op=72  01 07 07 13  ROL64_32MINUS_IMM s7 = rol64(s7, 32 - 19)
0013  +0x001c8  op=25  01 07 f8 ff  ST64             *(s1 -0x8) = s7
0014  +0x001e0  op=58  06 07 e8 ff  LD64             s7 = *(uint64_t *)(s6 -0x18)
0015  +0x001f8  op=72  01 07 07 13  ROL64_32MINUS_IMM s7 = rol64(s7, 32 - 19)
0016  +0x00210  op=25  01 07 d8 ff  ST64             *(s1 -0x28) = s7
0017  +0x00228  op=58  06 07 f0 ff  LD64             s7 = *(uint64_t *)(s6 -0x10)
0018  +0x00240  op=72  01 07 07 13  ROL64_32MINUS_IMM s7 = rol64(s7, 32 - 19)
0019  +0x00258  op=25  01 07 e0 ff  ST64             *(s1 -0x20) = s7
001a  +0x00270  op=58  06 07 f8 ff  LD64             s7 = *(uint64_t *)(s6 -0x8)
001b  +0x00288  op=72  01 07 07 13  ROL64_32MINUS_IMM s7 = rol64(s7, 32 - 19)
001c  +0x002a0  op=25  01 07 d0 ff  ST64             *(s1 -0x30) = s7
001d  +0x002b8  op=58  06 06 00 00  LD64             s6 = *(uint64_t *)(s6 +0x0)
001e  +0x002d0  op=72  01 06 06 13  ROL64_32MINUS_IMM s6 = rol64(s6, 32 - 19)
001f  +0x002e8  op=25  01 06 e8 ff  ST64             *(s1 -0x18) = s6
