...
L_001b:
    /* +0x00288 op=0x53 04 04 a1 03 LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0x3a1 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x3a1;
...
L_001e:
    /* +0x002d0 op=0x10 00 05 01 1f ASR32_IMM: s1 = sign_extend_32((int32_t)s5 >> 31) */
...
L_0028:
    /* +0x003c0 op=0x0e 0b 01 07 07 LSR32_IMM: s7 = sign_extend_32((uint32_t)s1 >> 7) */
    S[7] = (int32_t)((uint32_t)S[1] >> 7);

L_0029:
    /* +0x003d8 op=0x18 10 01 01 01 SHL32_IMM: s1 = (int32_t)(s1 << 1) */
    S[1] = (int32_t)((uint32_t)S[1] << 1);

L_002a:
    /* +0x003f0 op=0x34 01 07 01 00 OR64: s1 = s1 | s7 */
    S[1] = S[1] | S[7];
...
L_0033:
    /* +0x004c8 op=0x53 04 08 b1 06 LD_POOL_PTR: s8 = *(uint64_t *)q1 + 0x6b1 q1=0x125fd3a8 */
...
L_0039:
    /* +0x00558 op=0x0e 0b 01 01 1c LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 28) */
    S[1] = (int32_t)((uint32_t)S[1] >> 28);

L_003a:
    /* +0x00570 op=0xb4 03 01 01 12 ADD32: s1 = int32(s3 + s1) */
...
L_0042:
    /* +0x00630 op=0x0e 0b 0c 0d 07 LSR32_IMM: s13 = sign_extend_32((uint32_t)s12 >> 7) */
    S[13] = (int32_t)((uint32_t)S[12] >> 7);

L_0043:
    /* +0x00648 op=0x18 11 0c 0c 01 SHL32_IMM: s12 = (int32_t)(s12 << 1) */
    S[12] = (int32_t)((uint32_t)S[12] << 1);
...
L_0046:
    /* +0x00690 op=0x0e 00 01 0b 07 LSR32_IMM: s11 = sign_extend_32((uint32_t)s1 >> 7) */
    S[11] = (int32_t)((uint32_t)S[1] >> 7);

L_0047:
    /* +0x006a8 op=0x18 11 01 01 01 SHL32_IMM: s1 = (int32_t)(s1 << 1) */
    S[1] = (int32_t)((uint32_t)S[1] << 1);
...
L_005f:
    /* +0x008e8 op=0x59 05 08 fd ff LD8U: s8 = *(uint8_t *)(s5 -0x3) */
    S[8] = *(uint8_t *)((uint8_t *)S[5] + (-0x3));

L_0060:
    /* +0x00900 op=0x59 05 0a ff ff LD8U: s10 = *(uint8_t *)(s5 -0x1) */
    S[10] = *(uint8_t *)((uint8_t *)S[5] + (-0x1));

L_0061:
    /* +0x00918 op=0x59 05 0b 03 00 LD8U: s11 = *(uint8_t *)(s5 +0x3) */
...
L_0063:
    /* +0x00948 op=0x59 05 0c 01 00 LD8U: s12 = *(uint8_t *)(s5 +0x1) */
    S[12] = *(uint8_t *)((uint8_t *)S[5] + 0x1);
...
L_0066:
    /* +0x00990 op=0x59 05 18 00 00 LD8U: s24 = *(uint8_t *)(s5 +0x0) */
    S[24] = *(uint8_t *)((uint8_t *)S[5] + 0x0);
...
L_007b:
    /* +0x00b88 op=0x84 11 07 0c 00 ADD64: s12 = s17 + s7 */
    S[12] = S[17] + S[7];
...
L_008c:
    /* +0x00d20 op=0x84 02 01 01 14 ADD64: s1 = s2 + s1 */
    S[1] = S[2] + S[1];
...
L_00a5:
    /* +0x00f78 op=0x02 17 18 18 01 XOR64: s24 = s24 ^ s23 */
    S[24] = S[24] ^ S[23];
...
L_00b9:
    /* +0x01158 op=0x84 10 15 0f 00 ADD64: s15 = s16 + s21 */
    S[15] = S[16] + S[21];
