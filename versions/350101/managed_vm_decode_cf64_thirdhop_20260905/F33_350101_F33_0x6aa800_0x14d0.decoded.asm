; MetaSec managed bytecode decode: F33
...
001b  +0x00288  op=53  04 04 a1 02  LD_POOL_PTR      s4 = *(uint64_t *)q1 + 0x2a1 ; q1=0x125fd3a8 rt/so-mapped
001c  +0x002a0  op=34  03 00 05 01  OR64             s5 = s3 | s0
001d  +0x002b8  op=ae  12 13 0f 00  BR_EQ64          if (s18 == s19) goto record +45
001e  +0x002d0  op=10  0f 05 01 1f  ASR32_IMM        s1 = sign_extend_32((int32_t)s5 >> 31)
001f  +0x002e8  op=84  11 12 06 00  ADD64            s6 = s17 + s18
0020  +0x00300  op=85  12 12 01 00  ADD64_IMM16      s18 = s18 +0x1
0021  +0x00318  op=0e  0d 01 01 18  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 24)
...
0028  +0x003c0  op=0e  0d 01 07 06  LSR32_IMM        s7 = sign_extend_32((uint32_t)s1 >> 6)
0029  +0x003d8  op=18  10 01 01 02  SHL32_IMM        s1 = (int32_t)(s1 << 2)
...
0036  +0x00510  op=84  02 09 0b 00  ADD64            s11 = s2 + s9
0037  +0x00528  op=85  09 0a 01 00  ADD64_IMM16      s10 = s9 +0x1
0038  +0x00540  op=84  05 09 09 14  ADD64            s9 = s5 + s9
...
0042  +0x00630  op=0e  0d 0c 0d 06  LSR32_IMM        s13 = sign_extend_32((uint32_t)s12 >> 6)
0043  +0x00648  op=18  10 0c 0c 02  SHL32_IMM        s12 = (int32_t)(s12 << 2)
0044  +0x00660  op=34  0c 0d 0c 01  OR64             s12 = s12 | s13
0045  +0x00678  op=26  0b 0c 00 00  ST8              *(s11 +0x0) = (uint8_t)s12
0046  +0x00690  op=0e  0d 01 0b 06  LSR32_IMM        s11 = sign_extend_32((uint32_t)s1 >> 6)
0047  +0x006a8  op=18  11 01 01 02  SHL32_IMM        s1 = (int32_t)(s1 << 2)
0048  +0x006c0  op=34  01 0b 01 01  OR64             s1 = s1 | s11
0049  +0x006d8  op=26  09 01 00 00  ST8              *(s9 +0x0) = (uint8_t)s1
004a  +0x006f0  op=34  0a 00 09 01  OR64             s9 = s10 | s0
...
005c  +0x008a0  op=34  04 00 07 00  OR64             s7 = s4 | s0
...
0060  +0x00900  op=59  05 0a 00 00  LD8U             s10 = *(uint8_t *)(s5 +0x0)
0061  +0x00918  op=59  05 0b 04 00  LD8U             s11 = *(uint8_t *)(s5 +0x4)
0062  +0x00930  op=59  05 09 ff ff  LD8U             s9 = *(uint8_t *)(s5 -0x1)
0063  +0x00948  op=59  05 0c 03 00  LD8U             s12 = *(uint8_t *)(s5 +0x3)
0064  +0x00960  op=59  05 0f 02 00  LD8U             s15 = *(uint8_t *)(s5 +0x2)
0065  +0x00978  op=59  05 0e fd ff  LD8U             s14 = *(uint8_t *)(s5 -0x3)
0066  +0x00990  op=59  05 18 fe ff  LD8U             s24 = *(uint8_t *)(s5 -0x2)
0067  +0x009a8  op=84  11 03 12 00  ADD64            s18 = s17 + s3
...
0074  +0x00ae0  op=84  11 09 14 04  ADD64            s20 = s17 + s9
0075  +0x00af8  op=84  11 08 08 00  ADD64            s8 = s17 + s8
0076  +0x00b10  op=59  01 01 00 00  LD8U             s1 = *(uint8_t *)(s1 +0x0)
0077  +0x00b28  op=59  08 08 00 00  LD8U             s8 = *(uint8_t *)(s8 +0x0)
0078  +0x00b40  op=02  0f 01 09 00  XOR64            s9 = s1 ^ s15
...
007c  +0x00ba0  op=84  11 0b 01 00  ADD64            s1 = s17 + s11
...
0083  +0x00c48  op=02  0c 0a 18 01  XOR64            s24 = s10 ^ s12
...
00a3  +0x00f48  op=84  10 17 17 00  ADD64            s23 = s16 + s23
...
00af  +0x01068  op=84  10 18 18 14  ADD64            s24 = s16 + s24
00b0  +0x01080  op=84  10 12 12 04  ADD64            s18 = s16 + s18
00b1  +0x01098  op=84  10 13 13 14  ADD64            s19 = s16 + s19
...
00bd  +0x011b8  op=02  0d 0e 0d 01  XOR64            s13 = s14 ^ s13
...
00c1  +0x01218  op=34  19 00 0d 00  OR64             s13 = s25 | s0
...
00c7  +0x012a8  op=02  09 0b 09 01  XOR64            s9 = s11 ^ s9
