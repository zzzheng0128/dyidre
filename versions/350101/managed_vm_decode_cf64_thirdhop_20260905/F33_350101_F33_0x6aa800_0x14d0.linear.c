/*
 * Auto-generated linear C-like lift for 350.101 managed program F33.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_thirdhop_bodies_20260905/350101_F33_0x6aa800_0x14d0.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F33_350_linear_lift(ManagedFrame350 *frame)
{
...
L_000f:
    /* +0x00168 op=0x34 05 00 14 00 OR64: s20 = s5 | s0 */
    S[20] = S[5] | S[0];
...
L_0019:
    /* +0x00258 op=0x18 10 14 03 00 SHL32_IMM: s3 = (int32_t)(s20 << 0) */
...
L_001b:
    /* +0x00288 op=0x53 04 04 a1 02 LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0x2a1 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x2a1;

L_001c:
    /* +0x002a0 op=0x34 03 00 05 01 OR64: s5 = s3 | s0 */
    S[5] = S[3] | S[0];
...
L_001e:
    /* +0x002d0 op=0x10 0f 05 01 1f ASR32_IMM: s1 = sign_extend_32((int32_t)s5 >> 31) */
    S[1] = (int32_t)((int32_t)S[5] >> 31);

L_001f:
    /* +0x002e8 op=0x84 11 12 06 00 ADD64: s6 = s17 + s18 */
    S[6] = S[17] + S[18];
...
L_0021:
    /* +0x00318 op=0x0e 0d 01 01 18 LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 24) */
...
L_0023:
    /* +0x00348 op=0xb3 01 02 01 01 AND64: s1 = s1 & s2 */
    S[1] = S[1] & S[2];

L_0024:
    /* +0x00360 op=0x09 05 01 01 04 SUB32: s1 = sign_extend_32((uint32_t)s5 - (uint32_t)s1) */
    S[1] = (int32_t)((uint32_t)S[5] - (uint32_t)S[1]);
...
L_0028:
    /* +0x003c0 op=0x0e 0d 01 07 06 LSR32_IMM: s7 = sign_extend_32((uint32_t)s1 >> 6) */
    S[7] = (int32_t)((uint32_t)S[1] >> 6);

L_0029:
    /* +0x003d8 op=0x18 10 01 01 02 SHL32_IMM: s1 = (int32_t)(s1 << 2) */
...
L_0032:
    /* +0x004b0 op=0x53 04 07 a1 06 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x6a1 q1=0x125fd3a8 */
...
L_0035:
    /* +0x004f8 op=0x10 0e 03 01 1f ASR32_IMM: s1 = sign_extend_32((int32_t)s3 >> 31) */
    S[1] = (int32_t)((int32_t)S[3] >> 31);

L_0036:
    /* +0x00510 op=0x84 02 09 0b 00 ADD64: s11 = s2 + s9 */
    S[11] = S[2] + S[9];
...
L_0038:
    /* +0x00540 op=0x84 05 09 09 14 ADD64: s9 = s5 + s9 */
    S[9] = S[5] + S[9];

L_0039:
    /* +0x00558 op=0x0e 0d 01 01 1c LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 28) */
...
L_003b:
    /* +0x00588 op=0xb3 01 06 01 00 AND64: s1 = s1 & s6 */
    S[1] = S[1] & S[6];
...
L_003e:
    /* +0x005d0 op=0x84 08 01 0c 14 ADD64: s12 = s8 + s1 */
    S[12] = S[8] + S[1];

L_003f:
    /* +0x005e8 op=0x84 07 01 01 04 ADD64: s1 = s7 + s1 */
    S[1] = S[7] + S[1];
...
L_0042:
    /* +0x00630 op=0x0e 0d 0c 0d 06 LSR32_IMM: s13 = sign_extend_32((uint32_t)s12 >> 6) */
    S[13] = (int32_t)((uint32_t)S[12] >> 6);

L_0043:
    /* +0x00648 op=0x18 10 0c 0c 02 SHL32_IMM: s12 = (int32_t)(s12 << 2) */
...
L_0046:
    /* +0x00690 op=0x0e 0d 01 0b 06 LSR32_IMM: s11 = sign_extend_32((uint32_t)s1 >> 6) */
    S[11] = (int32_t)((uint32_t)S[1] >> 6);

L_0047:
    /* +0x006a8 op=0x18 11 01 01 02 SHL32_IMM: s1 = (int32_t)(s1 << 2) */
    S[1] = (int32_t)((uint32_t)S[1] << 2);

L_0048:
    /* +0x006c0 op=0x34 01 0b 01 01 OR64: s1 = s1 | s11 */
    S[1] = S[1] | S[11];
...
L_004f:
    /* +0x00768 op=0x84 02 03 06 04 ADD64: s6 = s2 + s3 */
    S[6] = S[2] + S[3];
...
L_0053:
    /* +0x007c8 op=0x84 10 03 06 00 ADD64: s6 = s16 + s3 */
    S[6] = S[16] + S[3];
...
L_005c:
    /* +0x008a0 op=0x34 04 00 07 00 OR64: s7 = s4 | s0 */
    S[7] = S[4] | S[0];
...
L_0060:
    /* +0x00900 op=0x59 05 0a 00 00 LD8U: s10 = *(uint8_t *)(s5 +0x0) */
    S[10] = *(uint8_t *)((uint8_t *)S[5] + 0x0);

L_0061:
    /* +0x00918 op=0x59 05 0b 04 00 LD8U: s11 = *(uint8_t *)(s5 +0x4) */
    S[11] = *(uint8_t *)((uint8_t *)S[5] + 0x4);

L_0062:
    /* +0x00930 op=0x59 05 09 ff ff LD8U: s9 = *(uint8_t *)(s5 -0x1) */
    S[9] = *(uint8_t *)((uint8_t *)S[5] + (-0x1));

L_0063:
    /* +0x00948 op=0x59 05 0c 03 00 LD8U: s12 = *(uint8_t *)(s5 +0x3) */
    S[12] = *(uint8_t *)((uint8_t *)S[5] + 0x3);

L_0064:
    /* +0x00960 op=0x59 05 0f 02 00 LD8U: s15 = *(uint8_t *)(s5 +0x2) */
    S[15] = *(uint8_t *)((uint8_t *)S[5] + 0x2);

L_0065:
    /* +0x00978 op=0x59 05 0e fd ff LD8U: s14 = *(uint8_t *)(s5 -0x3) */
    S[14] = *(uint8_t *)((uint8_t *)S[5] + (-0x3));

L_0066:
    /* +0x00990 op=0x59 05 18 fe ff LD8U: s24 = *(uint8_t *)(s5 -0x2) */
    S[24] = *(uint8_t *)((uint8_t *)S[5] + (-0x2));

L_0067:
    /* +0x009a8 op=0x84 11 03 12 00 ADD64: s18 = s17 + s3 */
    S[18] = S[17] + S[3];
...
L_0073:
    /* +0x00ac8 op=0x84 11 01 01 04 ADD64: s1 = s17 + s1 */
    S[1] = S[17] + S[1];

L_0074:
    /* +0x00ae0 op=0x84 11 09 14 04 ADD64: s20 = s17 + s9 */
    S[20] = S[17] + S[9];

L_0075:
    /* +0x00af8 op=0x84 11 08 08 00 ADD64: s8 = s17 + s8 */
    S[8] = S[17] + S[8];
...
L_007a:
    /* +0x00b70 op=0x84 11 0c 0a 04 ADD64: s10 = s17 + s12 */
    S[10] = S[17] + S[12];

L_007b:
    /* +0x00b88 op=0x84 11 07 0c 14 ADD64: s12 = s17 + s7 */
    S[12] = S[17] + S[7];
...
L_007d:
    /* +0x00bb8 op=0x84 11 0e 0b 04 ADD64: s11 = s17 + s14 */
    S[11] = S[17] + S[14];
...
L_0081:
    /* +0x00c18 op=0x84 11 13 01 00 ADD64: s1 = s17 + s19 */
    S[1] = S[17] + S[19];
...
L_0088:
    /* +0x00cc0 op=0x18 00 19 19 00 SHL32_IMM: s25 = (int32_t)(s25 << 0) */
...
L_008c:
    /* +0x00d20 op=0x84 02 01 01 00 ADD64: s1 = s2 + s1 */
    S[1] = S[2] + S[1];
...
L_008e:
    /* +0x00d50 op=0xb4 01 19 13 12 ADD32: s19 = int32(s1 + s25) */
...
L_0090:
    /* +0x00d80 op=0xb4 0d 12 0d 02 ADD32: s13 = int32(s13 + s18) */
...
L_0095:
    /* +0x00df8 op=0x02 0d 12 0d 01 XOR64: s13 = s18 ^ s13 */
    S[13] = S[18] ^ S[13];

L_0096:
    /* +0x00e10 op=0x7e 0d 06 0d 04 REM_U32: s13 = (int32_t)((uint32_t)s6 == 0 ? (uint32_t)s13 : (uint32_t)s13 % (uint32_t)s6) */
...
L_00a3:
    /* +0x00f48 op=0x84 10 17 17 00 ADD64: s23 = s16 + s23 */
    S[23] = S[16] + S[23];
...
L_00af:
    /* +0x01068 op=0x84 10 18 18 14 ADD64: s24 = s16 + s24 */
    S[24] = S[16] + S[24];

L_00b0:
    /* +0x01080 op=0x84 10 12 12 04 ADD64: s18 = s16 + s18 */
    S[18] = S[16] + S[18];

L_00b1:
    /* +0x01098 op=0x84 10 13 13 14 ADD64: s19 = s16 + s19 */
    S[19] = S[16] + S[19];

L_00b2:
    /* +0x010b0 op=0x84 10 14 14 00 ADD64: s20 = s16 + s20 */
    S[20] = S[16] + S[20];
...
L_00b6:
    /* +0x01110 op=0x02 16 0f 0f 01 XOR64: s15 = s15 ^ s22 */
    S[15] = S[15] ^ S[22];
...
L_00bb:
    /* +0x01188 op=0x84 10 0d 0d 00 ADD64: s13 = s16 + s13 */
    S[13] = S[16] + S[13];
...
L_00c0:
    /* +0x01200 op=0x02 0d 0c 0c 00 XOR64: s12 = s12 ^ s13 */
    S[12] = S[12] ^ S[13];
...
L_00c7:
    /* +0x012a8 op=0x02 09 0b 09 01 XOR64: s9 = s11 ^ s9 */
    S[9] = S[11] ^ S[9];
...
L_00d1:
    /* +0x01398 op=0x34 1e 00 1d 01 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];
