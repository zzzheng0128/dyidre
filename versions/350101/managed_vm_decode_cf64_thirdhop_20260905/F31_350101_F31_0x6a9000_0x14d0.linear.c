...
L_001b:
    /* +0x00288 op=0x53 01 04 a1 01 LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0x1a1 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x1a1;
...
L_0026:
    /* +0x00390 op=0x84 04 01 01 14 ADD64: s1 = s4 + s1 */
    S[1] = S[4] + S[1];
...
L_0028:
    /* +0x003c0 op=0x0e 00 01 07 03 LSR32_IMM: s7 = sign_extend_32((uint32_t)s1 >> 3) */
    S[7] = (int32_t)((uint32_t)S[1] >> 3);

L_0029:
    /* +0x003d8 op=0x18 00 01 01 05 SHL32_IMM: s1 = (int32_t)(s1 << 5) */
...
L_003c:
    /* +0x005a0 op=0x09 03 01 01 14 SUB32: s1 = sign_extend_32((uint32_t)s3 - (uint32_t)s1) */
    S[1] = (int32_t)((uint32_t)S[3] - (uint32_t)S[1]);
...
L_0042:
    /* +0x00630 op=0x0e 0d 0c 0d 03 LSR32_IMM: s13 = sign_extend_32((uint32_t)s12 >> 3) */
    S[13] = (int32_t)((uint32_t)S[12] >> 3);

L_0043:
    /* +0x00648 op=0x18 00 0c 0c 05 SHL32_IMM: s12 = (int32_t)(s12 << 5) */
    S[12] = (int32_t)((uint32_t)S[12] << 5);
...
L_0046:
    /* +0x00690 op=0x0e 00 01 0b 03 LSR32_IMM: s11 = sign_extend_32((uint32_t)s1 >> 3) */
    S[11] = (int32_t)((uint32_t)S[1] >> 3);

L_0047:
    /* +0x006a8 op=0x18 10 01 01 05 SHL32_IMM: s1 = (int32_t)(s1 << 5) */
    S[1] = (int32_t)((uint32_t)S[1] << 5);
...
L_004a:
    /* +0x006f0 op=0x34 0a 00 09 00 OR64: s9 = s10 | s0 */
    S[9] = S[10] | S[0];
...
L_0060:
    /* +0x00900 op=0x59 05 0a fe ff LD8U: s10 = *(uint8_t *)(s5 -0x2) */
    S[10] = *(uint8_t *)((uint8_t *)S[5] + (-0x2));
...
L_0065:
    /* +0x00978 op=0x59 05 0e 04 00 LD8U: s14 = *(uint8_t *)(s5 +0x4) */
    S[14] = *(uint8_t *)((uint8_t *)S[5] + 0x4);

L_0066:
    /* +0x00990 op=0x59 05 18 02 00 LD8U: s24 = *(uint8_t *)(s5 +0x2) */
...
L_0074:
    /* +0x00ae0 op=0x84 11 09 14 00 ADD64: s20 = s17 + s9 */
    S[20] = S[17] + S[9];
...
L_007c:
    /* +0x00ba0 op=0x84 11 0b 01 04 ADD64: s1 = s17 + s11 */
    S[1] = S[17] + S[11];
...
L_0083:
    /* +0x00c48 op=0x02 0c 0a 18 00 XOR64: s24 = s10 ^ s12 */
    S[24] = S[10] ^ S[12];
...
L_0088:
    /* +0x00cc0 op=0x18 10 19 19 00 SHL32_IMM: s25 = (int32_t)(s25 << 0) */
...
L_008e:
    /* +0x00d50 op=0xb4 01 19 13 02 ADD32: s19 = int32(s1 + s25) */
...
L_0090:
    /* +0x00d80 op=0xb4 0d 12 0d 12 ADD32: s13 = int32(s13 + s18) */
...
L_0093:
    /* +0x00dc8 op=0x84 11 12 12 04 ADD64: s18 = s17 + s18 */
    S[18] = S[17] + S[18];
...
L_00b0:
    /* +0x01080 op=0x84 10 12 12 00 ADD64: s18 = s16 + s18 */
    S[18] = S[16] + S[18];
...
L_00bb:
    /* +0x01188 op=0x84 10 0d 0d 04 ADD64: s13 = s16 + s13 */
    S[13] = S[16] + S[13];
...
L_00bd:
    /* +0x011b8 op=0x02 0d 0e 0d 00 XOR64: s13 = s14 ^ s13 */
    S[13] = S[14] ^ S[13];
...
L_00c1:
    /* +0x01218 op=0x34 19 00 0d 01 OR64: s13 = s25 | s0 */
    S[13] = S[25] | S[0];
...
L_00c4:
    /* +0x01260 op=0x02 0c 09 09 00 XOR64: s9 = s9 ^ s12 */
    S[9] = S[9] ^ S[12];
...
L_00cf:
    /* +0x01368 op=0x34 01 00 05 00 OR64: s5 = s1 | s0 */
    S[5] = S[1] | S[0];
