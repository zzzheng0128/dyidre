; MetaSec managed bytecode decode: F39
...
0019  +0x00258  op=18  00 14 03 00  SHL32_IMM        s3 = (int32_t)(s20 << 0)
001a  +0x00270  op=b5  00 02 00 ff  ADD32_IMM16      s2 = int32(s0 -0x100)
001b  +0x00288  op=53  03 04 a1 05  LD_POOL_PTR      s4 = *(uint64_t *)q1 + 0x5a1 ; q1=0x125fd3a8 rt/so-mapped
...
001f  +0x002e8  op=84  11 12 06 04  ADD64            s6 = s17 + s18
...
0022  +0x00330  op=b4  05 01 01 02  ADD32            s1 = int32(s5 + s1)
0023  +0x00348  op=b3  01 02 01 00  AND64            s1 = s1 & s2
...
0026  +0x00390  op=84  04 01 01 00  ADD64            s1 = s4 + s1
0027  +0x003a8  op=59  01 01 00 00  LD8U             s1 = *(uint8_t *)(s1 +0x0)
0028  +0x003c0  op=0e  0b 01 07 02  LSR32_IMM        s7 = sign_extend_32((uint32_t)s1 >> 2)
0029  +0x003d8  op=18  10 01 01 06  SHL32_IMM        s1 = (int32_t)(s1 << 6)
...
0042  +0x00630  op=0e  00 0c 0d 02  LSR32_IMM        s13 = sign_extend_32((uint32_t)s12 >> 2)
0043  +0x00648  op=18  11 0c 0c 06  SHL32_IMM        s12 = (int32_t)(s12 << 6)
0044  +0x00660  op=34  0c 0d 0c 00  OR64             s12 = s12 | s13
0045  +0x00678  op=26  0b 0c 00 00  ST8              *(s11 +0x0) = (uint8_t)s12
0046  +0x00690  op=0e  0d 01 0b 02  LSR32_IMM        s11 = sign_extend_32((uint32_t)s1 >> 2)
0047  +0x006a8  op=18  10 01 01 06  SHL32_IMM        s1 = (int32_t)(s1 << 6)
...
0052  +0x007b0  op=02  06 01 01 01  XOR64            s1 = s1 ^ s6
0053  +0x007c8  op=84  10 03 06 14  ADD64            s6 = s16 + s3
...
005f  +0x008e8  op=59  05 08 00 00  LD8U             s8 = *(uint8_t *)(s5 +0x0)
0060  +0x00900  op=59  05 0a 03 00  LD8U             s10 = *(uint8_t *)(s5 +0x3)
0061  +0x00918  op=59  05 0b 01 00  LD8U             s11 = *(uint8_t *)(s5 +0x1)
0062  +0x00930  op=59  05 09 02 00  LD8U             s9 = *(uint8_t *)(s5 +0x2)
0063  +0x00948  op=59  05 0c fd ff  LD8U             s12 = *(uint8_t *)(s5 -0x3)
0064  +0x00960  op=59  05 0f fe ff  LD8U             s15 = *(uint8_t *)(s5 -0x2)
0065  +0x00978  op=59  05 0e ff ff  LD8U             s14 = *(uint8_t *)(s5 -0x1)
0066  +0x00990  op=59  05 18 04 00  LD8U             s24 = *(uint8_t *)(s5 +0x4)
...
008c  +0x00d20  op=84  02 01 01 04  ADD64            s1 = s2 + s1
...
0095  +0x00df8  op=02  0d 12 0d 00  XOR64            s13 = s18 ^ s13
...
00b2  +0x010b0  op=84  10 14 14 04  ADD64            s20 = s16 + s20
00b3  +0x010c8  op=67  00 16 16 00  LSR64_IMM32PLUS  s22 = (uint64_t)s22 >> (0 + 32)
00b4  +0x010e0  op=84  10 16 16 14  ADD64            s22 = s16 + s22
...
00bb  +0x01188  op=84  10 0d 0d 14  ADD64            s13 = s16 + s13
...
00d1  +0x01398  op=34  1e 00 1d 00  OR64             s29 = s30 | s0
