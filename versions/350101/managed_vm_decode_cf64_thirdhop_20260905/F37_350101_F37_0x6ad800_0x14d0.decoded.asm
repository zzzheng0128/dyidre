; MetaSec managed bytecode decode: F37
...
001b  +0x00288  op=53  03 04 a1 04  LD_POOL_PTR      s4 = *(uint64_t *)q1 + 0x4a1 ; q1=0x125fd3a8 rt/so-mapped
...
0024  +0x00360  op=09  05 01 01 00  SUB32            s1 = sign_extend_32((uint32_t)s5 - (uint32_t)s1)
...
0028  +0x003c0  op=0e  0d 01 07 05  LSR32_IMM        s7 = sign_extend_32((uint32_t)s1 >> 5)
0029  +0x003d8  op=18  00 01 01 03  SHL32_IMM        s1 = (int32_t)(s1 << 3)
...
0035  +0x004f8  op=10  00 03 01 1f  ASR32_IMM        s1 = sign_extend_32((int32_t)s3 >> 31)
...
0039  +0x00558  op=0e  00 01 01 1c  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 28)
...
0042  +0x00630  op=0e  0b 0c 0d 05  LSR32_IMM        s13 = sign_extend_32((uint32_t)s12 >> 5)
0043  +0x00648  op=18  10 0c 0c 03  SHL32_IMM        s12 = (int32_t)(s12 << 3)
0044  +0x00660  op=34  0c 0d 0c 01  OR64             s12 = s12 | s13
0045  +0x00678  op=26  0b 0c 00 00  ST8              *(s11 +0x0) = (uint8_t)s12
0046  +0x00690  op=0e  0d 01 0b 05  LSR32_IMM        s11 = sign_extend_32((uint32_t)s1 >> 5)
0047  +0x006a8  op=18  10 01 01 03  SHL32_IMM        s1 = (int32_t)(s1 << 3)
...
0060  +0x00900  op=59  05 0a 04 00  LD8U             s10 = *(uint8_t *)(s5 +0x4)
0061  +0x00918  op=59  05 0b 00 00  LD8U             s11 = *(uint8_t *)(s5 +0x0)
0062  +0x00930  op=59  05 09 02 00  LD8U             s9 = *(uint8_t *)(s5 +0x2)
0063  +0x00948  op=59  05 0c fe ff  LD8U             s12 = *(uint8_t *)(s5 -0x2)
0064  +0x00960  op=59  05 0f fd ff  LD8U             s15 = *(uint8_t *)(s5 -0x3)
0065  +0x00978  op=59  05 0e 03 00  LD8U             s14 = *(uint8_t *)(s5 +0x3)
0066  +0x00990  op=59  05 18 ff ff  LD8U             s24 = *(uint8_t *)(s5 -0x1)
...
007b  +0x00b88  op=84  11 07 0c 04  ADD64            s12 = s17 + s7
...
0081  +0x00c18  op=84  11 13 01 04  ADD64            s1 = s17 + s19
...
0088  +0x00cc0  op=18  11 19 19 00  SHL32_IMM        s25 = (int32_t)(s25 << 0)
...
008e  +0x00d50  op=b4  01 19 13 00  ADD32            s19 = int32(s1 + s25)
...
00a3  +0x00f48  op=84  10 17 17 04  ADD64            s23 = s16 + s23
...
00b6  +0x01110  op=02  16 0f 0f 00  XOR64            s15 = s15 ^ s22
