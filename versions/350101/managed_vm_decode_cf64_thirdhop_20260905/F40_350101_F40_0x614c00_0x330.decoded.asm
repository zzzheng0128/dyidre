; MetaSec managed bytecode decode: F40
...
0009  +0x000d8  op=73  13 07 07 02  ROR64_IMM        s7 = ror64(s7, 2)
000a  +0x000f0  op=25  01 07 18 00  ST64             *(s1 +0x18) = s7
000b  +0x00108  op=58  06 07 e8 ff  LD64             s7 = *(uint64_t *)(s6 -0x18)
000c  +0x00120  op=73  13 07 07 02  ROR64_IMM        s7 = ror64(s7, 2)
000d  +0x00138  op=25  01 07 e8 ff  ST64             *(s1 -0x18) = s7
000e  +0x00150  op=58  06 07 f0 ff  LD64             s7 = *(uint64_t *)(s6 -0x10)
000f  +0x00168  op=73  11 07 07 02  ROR64_IMM        s7 = ror64(s7, 2)
0010  +0x00180  op=25  01 07 f0 ff  ST64             *(s1 -0x10) = s7
0011  +0x00198  op=58  06 07 f8 ff  LD64             s7 = *(uint64_t *)(s6 -0x8)
0012  +0x001b0  op=73  13 07 07 02  ROR64_IMM        s7 = ror64(s7, 2)
0013  +0x001c8  op=25  01 07 e0 ff  ST64             *(s1 -0x20) = s7
0014  +0x001e0  op=58  06 07 00 00  LD64             s7 = *(uint64_t *)(s6 +0x0)
0015  +0x001f8  op=73  13 07 07 02  ROR64_IMM        s7 = ror64(s7, 2)
0016  +0x00210  op=25  01 07 08 00  ST64             *(s1 +0x8) = s7
0017  +0x00228  op=58  06 07 08 00  LD64             s7 = *(uint64_t *)(s6 +0x8)
0018  +0x00240  op=73  01 07 07 02  ROR64_IMM        s7 = ror64(s7, 2)
0019  +0x00258  op=25  01 07 00 00  ST64             *(s1 +0x0) = s7
001a  +0x00270  op=58  06 07 10 00  LD64             s7 = *(uint64_t *)(s6 +0x10)
001b  +0x00288  op=73  11 07 07 02  ROR64_IMM        s7 = ror64(s7, 2)
001c  +0x002a0  op=25  01 07 10 00  ST64             *(s1 +0x10) = s7
001d  +0x002b8  op=58  06 06 18 00  LD64             s6 = *(uint64_t *)(s6 +0x18)
001e  +0x002d0  op=73  01 06 06 02  ROR64_IMM        s6 = ror64(s6, 2)
