...
0004  +0x00060  op=85  01 05 84 04  ADD64_IMM16      s5 = s1 +0x484
...
0008  +0x000c0  op=59  01 06 04 00  LD8U             s6 = *(uint8_t *)(s1 +0x4)
0009  +0x000d8  op=59  01 07 0c 00  LD8U             s7 = *(uint8_t *)(s1 +0xc)
000a  +0x000f0  op=59  01 08 08 00  LD8U             s8 = *(uint8_t *)(s1 +0x8)
000b  +0x00108  op=59  01 09 00 00  LD8U             s9 = *(uint8_t *)(s1 +0x0)
000c  +0x00120  op=84  05 06 06 14  ADD64            s6 = s5 + s6
000d  +0x00138  op=84  05 07 07 04  ADD64            s7 = s5 + s7
000e  +0x00150  op=84  05 08 08 00  ADD64            s8 = s5 + s8
000f  +0x00168  op=84  05 09 09 04  ADD64            s9 = s5 + s9
...
0015  +0x001f8  op=26  01 08 08 00  ST8              *(s1 +0x8) = (uint8_t)s8
0016  +0x00210  op=26  01 06 00 00  ST8              *(s1 +0x0) = (uint8_t)s6
0017  +0x00228  op=26  01 07 04 00  ST8              *(s1 +0x4) = (uint8_t)s7
