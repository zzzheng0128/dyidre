...
0010  +0x00180  op=59  04 01 03 00  LD8U             s1 = *(uint8_t *)(s4 +0x3)
0011  +0x00198  op=59  04 02 0b 00  LD8U             s2 = *(uint8_t *)(s4 +0xb)
0012  +0x001b0  op=59  04 03 0f 00  LD8U             s3 = *(uint8_t *)(s4 +0xf)
0013  +0x001c8  op=59  04 05 07 00  LD8U             s5 = *(uint8_t *)(s4 +0x7)
0014  +0x001e0  op=26  04 05 0f 00  ST8              *(s4 +0xf) = (uint8_t)s5
0015  +0x001f8  op=26  04 03 0b 00  ST8              *(s4 +0xb) = (uint8_t)s3
0016  +0x00210  op=26  04 02 03 00  ST8              *(s4 +0x3) = (uint8_t)s2
0017  +0x00228  op=26  04 01 07 00  ST8              *(s4 +0x7) = (uint8_t)s1
