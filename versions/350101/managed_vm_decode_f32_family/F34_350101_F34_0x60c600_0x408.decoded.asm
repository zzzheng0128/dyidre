...
000c  +0x00120  op=34  10 00 06 00  OR64             s6 = s16 | s0
000d  +0x00138  op=5e  8e 00 00 00  CALL_CF_INDEX    call native_binding[index=0x8e] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
0011  +0x00198  op=5e  8f 00 00 00  CALL_CF_INDEX    call native_binding[index=0x8f] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0012  +0x001b0  op=34  11 00 04 00  OR64             s4 = s17 | s0
0013  +0x001c8  op=5e  90 00 00 00  CALL_CF_INDEX    call native_binding[index=0x90] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
0017  +0x00228  op=5e  91 00 00 00  CALL_CF_INDEX    call native_binding[index=0x91] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
001b  +0x00288  op=5e  8e 00 00 00  CALL_CF_INDEX    call native_binding[index=0x8e] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
0021  +0x00318  op=5e  8e 00 00 00  CALL_CF_INDEX    call native_binding[index=0x8e] via q1 table ; q1=0x125fd3c0 rt/so-mapped
