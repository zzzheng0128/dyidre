...
L_0013:
    /* +0x001c8 op=0x34 13 00 02 00 OR64: s2 = s19 | s0 */
    S[2] = S[19] | S[0];
...
L_0019:
    /* +0x00258 op=0x84 02 03 05 04 ADD64: s5 = s2 + s3 */
    S[5] = S[2] + S[3];
...
L_0023:
    /* +0x00348 op=0x5e 8d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x8d] via q1 table q1=0x125fd3c0 */
    CALL_CF_INDEX(frame, 0x8d, (void *)(uintptr_t)0x125fd3c0);
