...
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_missing_20260904/350101_F3_0xfffffffffffe9780_0x270.bin
; records: 26  record_size=0x18
; slot base: qword slots=frame->buf+0x8100, f32=+0x8200, f64=+0x8280

0000  +0x00000  op=18  11 05 01 00  SHL32_IMM        s1 = (int32_t)(s5 << 0)
...
000b  +0x00108  op=02  01 02 01 00  XOR64            s1 = s2 ^ s1
