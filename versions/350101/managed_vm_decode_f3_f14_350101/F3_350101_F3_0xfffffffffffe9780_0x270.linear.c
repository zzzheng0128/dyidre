...
L_0000:
    /* +0x00000 op=0x18 11 05 01 00 SHL32_IMM: s1 = (int32_t)(s5 << 0) */
...
L_000b:
    /* +0x00108 op=0x02 01 02 01 00 XOR64: s1 = s2 ^ s1 */
    S[1] = S[2] ^ S[1];
...
L_0010:
    /* +0x00180 op=0x18 00 02 06 0b SHL32_IMM: s6 = (int32_t)(s2 << 11) */
...
L_0013:
    /* +0x001c8 op=0x02 02 06 02 00 XOR64: s2 = s6 ^ s2 */
    S[2] = S[6] ^ S[2];
...
L_0015:
    /* +0x001f8 op=0x36 01 00 02 00 NOR64: s2 = ~(s1 | s0) */
    S[2] = ~(S[1] | S[0]);
