...
000b  +0x00108  op=34  11 00 05 01  OR64             s5 = s17 | s0
000c  +0x00120  op=34  10 00 06 01  OR64             s6 = s16 | s0
000d  +0x00138  op=5e  94 00 00 00  CALL_CF_INDEX    call native_binding[index=0x94] via q1 table ; q1=0x125fd3c0 rt/so-mapped
000e  +0x00150  op=b5  00 12 01 00  ADD32_IMM16      s18 = int32(s0 +0x1)
000f  +0x00168  op=b5  00 13 02 00  ADD32_IMM16      s19 = int32(s0 +0x2)
0010  +0x00180  op=34  11 00 04 00  OR64             s4 = s17 | s0
0011  +0x00198  op=5e  95 00 00 00  CALL_CF_INDEX    call native_binding[index=0x95] via q1 table ; q1=0x125fd3c0 rt/so-mapped
0012  +0x001b0  op=34  11 00 04 01  OR64             s4 = s17 | s0
0013  +0x001c8  op=5e  96 00 00 00  CALL_CF_INDEX    call native_binding[index=0x96] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
0017  +0x00228  op=5e  97 00 00 00  CALL_CF_INDEX    call native_binding[index=0x97] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
001b  +0x00288  op=5e  94 00 00 00  CALL_CF_INDEX    call native_binding[index=0x94] via q1 table ; q1=0x125fd3c0 rt/so-mapped
...
0021  +0x00318  op=5e  94 00 00 00  CALL_CF_INDEX    call native_binding[index=0x94] via q1 table ; q1=0x125fd3c0 rt/so-mapped
