; MetaSec managed bytecode decode: F58
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F58_0x5e3800_0x3c0.bin
...
0003  +0x00048  op=53  04 07 78 07  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0x778 ; q1=0x125fd3a8 rt/so-mapped
...
000a  +0x000f0  op=34  02 00 18 01  OR64             s24 = s2 | s0
000b  +0x00108  op=b5  01 01 37 00  ADD32_IMM16      s1 = int32(s1 +0x37)
...
0020  +0x00300  op=84  05 0b 0b 04  ADD64            s11 = s5 + s11
