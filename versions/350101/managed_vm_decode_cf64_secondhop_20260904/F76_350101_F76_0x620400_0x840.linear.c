/*
 * Auto-generated linear C-like lift for 350.101 managed program F76.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F76_0x620400_0x840.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F76_350_linear_lift(ManagedFrame350 *frame)
{
...
L_001a:
    /* +0x00270 op=0x5e 6a 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6a] via q1 table q1=0x125fd360 */
...
L_002b:
    /* +0x00408 op=0x84 01 02 02 14 ADD64: s2 = s1 + s2 */
    S[2] = S[1] + S[2];
...
L_0050:
    /* +0x00780 op=0x5e 6a 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6a] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x6a, (void *)(uintptr_t)0x125fd360);
