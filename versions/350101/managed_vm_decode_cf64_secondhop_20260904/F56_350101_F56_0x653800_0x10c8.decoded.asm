; MetaSec managed bytecode decode: F56
...
0033  +0x004c8  op=18  11 0b 01 01  SHL32_IMM        s1 = (int32_t)(s11 << 1)
...
0046  +0x00690  op=5e  3a 00 00 00  CALL_CF_INDEX    call native_binding[index=0x3a] via q1 table ; q1=0x125fd360 rt/so-mapped
...
004b  +0x00708  op=5e  3a 00 00 00  CALL_CF_INDEX    call native_binding[index=0x3a] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0055  +0x007f8  op=b5  03 03 08 00  ADD32_IMM16      s3 = int32(s3 +0x8)
0056  +0x00810  op=b2  03 03 1f 00  AND64_IMM16      s3 = s3 & 0x1f
0057  +0x00828  op=34  03 04 04 01  OR64             s4 = s3 | s4
0058  +0x00840  op=09  01 03 05 04  SUB32            s5 = sign_extend_32((uint32_t)s1 - (uint32_t)s3)
...
005d  +0x008b8  op=84  06 09 01 00  ADD64            s1 = s6 + s9
...
006b  +0x00a08  op=0d  03 0a 01 11  BYTE_FROM_U32_SHIFT s3 = (uint8_t)((uint32_t)s10 >> (s1 & 31))
...
0070  +0x00a80  op=36  0c 00 0b 00  NOR64            s11 = ~(s12 | s0)
...
0090  +0x00d80  op=0e  0d 01 01 08  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 8)
...
00a8  +0x00fc0  op=34  1e 00 1d 00  OR64             s29 = s30 | s0
