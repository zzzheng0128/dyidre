 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F26_0x5cd000_0xfc0.bin
...
L_000c:
    /* +0x00120 op=0x53 04 01 28 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xe28 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe28;

L_000d:
    /* +0x00138 op=0x53 03 02 18 0e LD_POOL_PTR: s2 = *(uint64_t *)q1 + 0xe18 q1=0x125fd3a8 */
    S[2] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe18;

L_000e:
    /* +0x00150 op=0x53 03 03 08 0e LD_POOL_PTR: s3 = *(uint64_t *)q1 + 0xe08 q1=0x125fd3a8 */
    S[3] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe08;

L_000f:
    /* +0x00168 op=0x53 03 05 e8 0d LD_POOL_PTR: s5 = *(uint64_t *)q1 + 0xde8 q1=0x125fd3a8 */
    S[5] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xde8;
...
L_0011:
    /* +0x00198 op=0x53 03 04 f8 0d LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0xdf8 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xdf8;

L_0012:
    /* +0x001b0 op=0x53 04 06 d8 0d LD_POOL_PTR: s6 = *(uint64_t *)q1 + 0xdd8 q1=0x125fd3a8 */
    S[6] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xdd8;

L_0013:
    /* +0x001c8 op=0x53 04 07 c8 0d LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0xdc8 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xdc8;

L_0014:
    /* +0x001e0 op=0x53 01 08 78 0c LD_POOL_PTR: s8 = *(uint64_t *)q1 + 0xc78 q1=0x125fd3a8 */
    S[8] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xc78;
...
L_0016:
    /* +0x00210 op=0x58 05 14 00 00 LD64: s20 = *(uint64_t *)(s5 +0x0) */
    S[20] = *(uint64_t *)((uint8_t *)S[5] + 0x0);

L_0017:
    /* +0x00228 op=0x58 03 03 00 00 LD64: s3 = *(uint64_t *)(s3 +0x0) */
    S[3] = *(uint64_t *)((uint8_t *)S[3] + 0x0);

L_0018:
    /* +0x00240 op=0x58 02 02 00 00 LD64: s2 = *(uint64_t *)(s2 +0x0) */
    S[2] = *(uint64_t *)((uint8_t *)S[2] + 0x0);

L_0019:
    /* +0x00258 op=0x85 00 05 00 00 ADD64_IMM16: s5 = s0 +0x0 */
    S[5] = S[0] + 0x0;

L_001a:
    /* +0x00270 op=0x58 06 15 00 00 LD64: s21 = *(uint64_t *)(s6 +0x0) */
    S[21] = *(uint64_t *)((uint8_t *)S[6] + 0x0);

L_001b:
    /* +0x00288 op=0x58 08 12 00 00 LD64: s18 = *(uint64_t *)(s8 +0x0) */
    S[18] = *(uint64_t *)((uint8_t *)S[8] + 0x0);

L_001c:
    /* +0x002a0 op=0x58 07 16 00 00 LD64: s22 = *(uint64_t *)(s7 +0x0) */
    S[22] = *(uint64_t *)((uint8_t *)S[7] + 0x0);

L_001d:
    /* +0x002b8 op=0x58 04 13 00 00 LD64: s19 = *(uint64_t *)(s4 +0x0) */
    S[19] = *(uint64_t *)((uint8_t *)S[4] + 0x0);
...
L_001f:
    /* +0x002e8 op=0x25 1e 01 18 00 ST64: *(s30 +0x18) = s1 */
    *(uint64_t *)((uint8_t *)S[30] + 0x18) = S[1];

L_0020:
    /* +0x00300 op=0x53 04 01 38 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xe38 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe38;

L_0021:
    /* +0x00318 op=0x25 1e 03 08 00 ST64: *(s30 +0x8) = s3 */
    *(uint64_t *)((uint8_t *)S[30] + 0x8) = S[3];

L_0022:
    /* +0x00330 op=0x25 1e 02 10 00 ST64: *(s30 +0x10) = s2 */
    *(uint64_t *)((uint8_t *)S[30] + 0x10) = S[2];

L_0023:
    /* +0x00348 op=0x58 01 01 00 00 LD64: s1 = *(uint64_t *)(s1 +0x0) */
    S[1] = *(uint64_t *)((uint8_t *)S[1] + 0x0);

L_0024:
    /* +0x00360 op=0x25 1e 01 20 00 ST64: *(s30 +0x20) = s1 */
    *(uint64_t *)((uint8_t *)S[30] + 0x20) = S[1];

L_0025:
    /* +0x00378 op=0x53 01 01 48 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xe48 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe48;

L_0026:
    /* +0x00390 op=0x58 01 17 00 00 LD64: s23 = *(uint64_t *)(s1 +0x0) */
    S[23] = *(uint64_t *)((uint8_t *)S[1] + 0x0);

L_0027:
    /* +0x003a8 op=0x53 01 01 58 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xe58 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe58;
...
L_0039:
    /* +0x00558 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_003b:
    /* +0x00588 op=0x34 02 00 04 01 OR64: s4 = s2 | s0 */
    S[4] = S[2] | S[0];
...
L_003d:
    /* +0x005b8 op=0x34 12 00 06 00 OR64: s6 = s18 | s0 */
    S[6] = S[18] | S[0];
...
L_0040:
    /* +0x00600 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_0042:
    /* +0x00630 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_0045:
    /* +0x00678 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_0048:
    /* +0x006c0 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_004c:
    /* +0x00720 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_005a:
    /* +0x00870 op=0x34 12 00 04 01 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_005c:
    /* +0x008a0 op=0x5e 5c 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5c] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5c, (void *)(uintptr_t)0x125fd360);
...
L_005f:
    /* +0x008e8 op=0x5e 5d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5d] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5d, (void *)(uintptr_t)0x125fd360);
...
L_0062:
    /* +0x00930 op=0x5e 5d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5d] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5d, (void *)(uintptr_t)0x125fd360);
...
L_0065:
    /* +0x00978 op=0x5e 5d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5d] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5d, (void *)(uintptr_t)0x125fd360);
...
L_0068:
    /* +0x009c0 op=0x5e 5d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5d] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5d, (void *)(uintptr_t)0x125fd360);
...
L_006b:
    /* +0x00a08 op=0x5e 5d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5d] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5d, (void *)(uintptr_t)0x125fd360);
...
L_006f:
    /* +0x00a68 op=0x5e 5d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5d] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5d, (void *)(uintptr_t)0x125fd360);
...
L_0073:
    /* +0x00ac8 op=0x5e 5d 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5d] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5d, (void *)(uintptr_t)0x125fd360);
...
L_009f:
    /* +0x00ee8 op=0x34 02 00 04 00 OR64: s4 = s2 | s0 */
    S[4] = S[2] | S[0];
...
L_00a4:
    /* +0x00f60 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
