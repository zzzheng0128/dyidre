/*
 * Auto-generated linear C-like lift for 350.101 managed program F66.
...
void managed_F66_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0003:
    /* +0x00048 op=0x53 03 07 d0 07 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x7d0 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x7d0;
...
L_000b:
    /* +0x00108 op=0xb5 01 01 28 00 ADD32_IMM16: s1 = int32(s1 +0x28) */
    S[1] = (int32_t)((uint32_t)S[1] + 0x28);
...
L_000d:
    /* +0x00138 op=0x84 07 0b 01 14 ADD64: s1 = s7 + s11 */
    S[1] = S[7] + S[11];
...
L_0010:
    /* +0x00180 op=0x09 08 0c 0e 00 SUB32: s14 = sign_extend_32((uint32_t)s8 - (uint32_t)s12) */
...
L_0013:
    /* +0x001c8 op=0x6e 12 18 01 01 SHL64_IMM: s1 = s24 << 1 */
    S[1] = S[24] << 1;
...
L_001f:
    /* +0x002e8 op=0x6c 0e 0d 0e 11 SHL64_VAR: s14 = s13 << (s14 & 63) */
    S[14] = S[13] << (S[14] & 63);
...
L_0022:
    /* +0x00330 op=0xb3 0e 01 01 00 AND64: s1 = s14 & s1 */
    S[1] = S[14] & S[1];
