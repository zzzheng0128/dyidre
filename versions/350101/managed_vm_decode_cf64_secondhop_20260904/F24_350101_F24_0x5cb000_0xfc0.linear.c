 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F24_0x5cb000_0xfc0.bin
...
L_000c:
    /* +0x00120 op=0x53 03 01 e8 0c LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xce8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xce8;

L_000d:
    /* +0x00138 op=0x53 04 02 d8 0c LD_POOL_PTR: s2 = *(uint64_t *)q1 + 0xcd8 q1=0x125fd3a8 */
    S[2] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xcd8;

L_000e:
    /* +0x00150 op=0x53 03 03 c8 0c LD_POOL_PTR: s3 = *(uint64_t *)q1 + 0xcc8 q1=0x125fd3a8 */
    S[3] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xcc8;

L_000f:
    /* +0x00168 op=0x53 04 05 a8 0c LD_POOL_PTR: s5 = *(uint64_t *)q1 + 0xca8 q1=0x125fd3a8 */
    S[5] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xca8;
...
L_0011:
    /* +0x00198 op=0x53 01 04 b8 0c LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0xcb8 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xcb8;

L_0012:
    /* +0x001b0 op=0x53 01 06 98 0c LD_POOL_PTR: s6 = *(uint64_t *)q1 + 0xc98 q1=0x125fd3a8 */
    S[6] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xc98;

L_0013:
    /* +0x001c8 op=0x53 04 07 88 0c LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0xc88 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xc88;

L_0014:
    /* +0x001e0 op=0x53 03 08 78 0c LD_POOL_PTR: s8 = *(uint64_t *)q1 + 0xc78 q1=0x125fd3a8 */
...
L_001e:
    /* +0x002d0 op=0x34 05 00 06 01 OR64: s6 = s5 | s0 */
    S[6] = S[5] | S[0];
...
L_0020:
    /* +0x00300 op=0x53 01 01 f8 0c LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xcf8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xcf8;
...
L_0025:
    /* +0x00378 op=0x53 01 01 08 0d LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xd08 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd08;
...
L_0027:
    /* +0x003a8 op=0x53 03 01 18 0d LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xd18 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd18;
...
L_0029:
    /* +0x003d8 op=0x34 11 00 04 00 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_0050:
    /* +0x00780 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_005c:
    /* +0x008a0 op=0x5e 58 00 00 00 CALL_CF_INDEX: call native_binding[index=0x58] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x58, (void *)(uintptr_t)0x125fd360);
...
L_005e:
    /* +0x008d0 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];

L_005f:
    /* +0x008e8 op=0x5e 59 00 00 00 CALL_CF_INDEX: call native_binding[index=0x59] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x59, (void *)(uintptr_t)0x125fd360);
...
L_0062:
    /* +0x00930 op=0x5e 59 00 00 00 CALL_CF_INDEX: call native_binding[index=0x59] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x59, (void *)(uintptr_t)0x125fd360);
...
L_0065:
    /* +0x00978 op=0x5e 59 00 00 00 CALL_CF_INDEX: call native_binding[index=0x59] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x59, (void *)(uintptr_t)0x125fd360);
...
L_0068:
    /* +0x009c0 op=0x5e 59 00 00 00 CALL_CF_INDEX: call native_binding[index=0x59] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x59, (void *)(uintptr_t)0x125fd360);
...
L_006b:
    /* +0x00a08 op=0x5e 59 00 00 00 CALL_CF_INDEX: call native_binding[index=0x59] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x59, (void *)(uintptr_t)0x125fd360);
...
L_006f:
    /* +0x00a68 op=0x5e 59 00 00 00 CALL_CF_INDEX: call native_binding[index=0x59] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x59, (void *)(uintptr_t)0x125fd360);
...
L_0073:
    /* +0x00ac8 op=0x5e 59 00 00 00 CALL_CF_INDEX: call native_binding[index=0x59] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x59, (void *)(uintptr_t)0x125fd360);
...
L_0099:
    /* +0x00e58 op=0x34 11 00 04 00 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
