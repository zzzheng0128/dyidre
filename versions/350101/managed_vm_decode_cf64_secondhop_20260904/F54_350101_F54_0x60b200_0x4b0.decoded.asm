...
0009  +0x000d8  op=b5  01 01 02 00  ADD32_IMM16      s1 = int32(s1 +0x2)
...
0012  +0x001b0  op=34  09 00 0d 00  OR64             s13 = s9 | s0
...
0022  +0x00330  op=17  06 0c 0c 00  SHL32_VAR        s12 = (int32_t)((uint32_t)s12 << ((uint32_t)s6 & 31))
