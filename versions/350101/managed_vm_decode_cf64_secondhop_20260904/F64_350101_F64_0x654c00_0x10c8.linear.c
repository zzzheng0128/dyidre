/*
 * Auto-generated linear C-like lift for 350.101 managed program F64.
...
void managed_F64_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0010:
    /* +0x00180 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];
...
L_001a:
    /* +0x00270 op=0x53 04 07 90 09 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x990 q1=0x125fd3a8 */
...
L_001e:
    /* +0x002d0 op=0x1e 04 01 01 11 CMOVNZ64: s1 = (s1 != 0) ? s4 : 0 */
    S[1] = (S[1] != 0) ? S[4] : 0;
...
L_0022:
    /* +0x00330 op=0xb5 04 04 04 00 ADD32_IMM16: s4 = int32(s4 +0x4) */
    S[4] = (int32_t)((uint32_t)S[4] + 0x4);
...
L_0029:
    /* +0x003d8 op=0x34 08 00 0a 00 OR64: s10 = s8 | s0 */
    S[10] = S[8] | S[0];
...
L_0038:
    /* +0x00540 op=0x17 06 09 09 00 SHL32_VAR: s9 = (int32_t)((uint32_t)s9 << ((uint32_t)s6 & 31)) */
...
L_003a:
    /* +0x00570 op=0x36 0b 00 0a 00 NOR64: s10 = ~(s11 | s0) */
    S[10] = ~(S[11] | S[0]);
...
L_0046:
    /* +0x00690 op=0x5e 41 00 00 00 CALL_CF_INDEX: call native_binding[index=0x41] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x41, (void *)(uintptr_t)0x125fd360);
...
L_004b:
    /* +0x00708 op=0x5e 41 00 00 00 CALL_CF_INDEX: call native_binding[index=0x41] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x41, (void *)(uintptr_t)0x125fd360);
...
L_0055:
    /* +0x007f8 op=0xb5 03 03 15 00 ADD32_IMM16: s3 = int32(s3 +0x15) */
    S[3] = (int32_t)((uint32_t)S[3] + 0x15);
...
L_0058:
    /* +0x00840 op=0x09 01 03 05 00 SUB32: s5 = sign_extend_32((uint32_t)s1 - (uint32_t)s3) */
...
L_005c:
    /* +0x008a0 op=0x34 07 00 0b 01 OR64: s11 = s7 | s0 */
    S[11] = S[7] | S[0];

L_005d:
    /* +0x008b8 op=0x84 06 09 01 04 ADD64: s1 = s6 + s9 */
    S[1] = S[6] + S[9];
...
L_0064:
    /* +0x00960 op=0x34 04 00 0d 00 OR64: s13 = s4 | s0 */
    S[13] = S[4] | S[0];
...
L_0067:
    /* +0x009a8 op=0x18 11 0c 01 01 SHL32_IMM: s1 = (int32_t)(s12 << 1) */
...
L_0087:
    /* +0x00ca8 op=0x0e 00 01 01 08 LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 8) */
...
L_0090:
    /* +0x00d80 op=0x0e 00 01 01 08 LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 8) */
    S[1] = (int32_t)((uint32_t)S[1] >> 8);
...
L_0099:
    /* +0x00e58 op=0x0e 0b 01 01 08 LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 8) */
    S[1] = (int32_t)((uint32_t)S[1] >> 8);
