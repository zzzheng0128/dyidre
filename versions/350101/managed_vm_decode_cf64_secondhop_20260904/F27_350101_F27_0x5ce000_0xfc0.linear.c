/*
 * Auto-generated linear C-like lift for 350.101 managed program F27.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F27_0x5ce000_0xfc0.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F27_350_linear_lift(ManagedFrame350 *frame)
{
...
L_000c:
    /* +0x00120 op=0x53 04 01 c8 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xec8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xec8;

L_000d:
    /* +0x00138 op=0x53 03 02 b8 0e LD_POOL_PTR: s2 = *(uint64_t *)q1 + 0xeb8 q1=0x125fd3a8 */
    S[2] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xeb8;

L_000e:
    /* +0x00150 op=0x53 03 03 a8 0e LD_POOL_PTR: s3 = *(uint64_t *)q1 + 0xea8 q1=0x125fd3a8 */
    S[3] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xea8;

L_000f:
    /* +0x00168 op=0x53 03 05 88 0e LD_POOL_PTR: s5 = *(uint64_t *)q1 + 0xe88 q1=0x125fd3a8 */
    S[5] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe88;

L_0010:
    /* +0x00180 op=0x34 04 00 10 00 OR64: s16 = s4 | s0 */
    S[16] = S[4] | S[0];

L_0011:
    /* +0x00198 op=0x53 04 04 98 0e LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0xe98 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe98;

L_0012:
    /* +0x001b0 op=0x53 04 06 78 0e LD_POOL_PTR: s6 = *(uint64_t *)q1 + 0xe78 q1=0x125fd3a8 */
    S[6] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe78;

L_0013:
    /* +0x001c8 op=0x53 03 07 68 0e LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0xe68 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xe68;
...
L_0020:
    /* +0x00300 op=0x53 01 01 d8 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xed8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xed8;
...
L_0025:
    /* +0x00378 op=0x53 03 01 e8 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xee8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xee8;
...
L_0027:
    /* +0x003a8 op=0x53 04 01 f8 0e LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xef8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xef8;
...
L_005c:
    /* +0x008a0 op=0x5e 5e 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5e] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5e, (void *)(uintptr_t)0x125fd360);
...
L_005f:
    /* +0x008e8 op=0x5e 5f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5f, (void *)(uintptr_t)0x125fd360);
...
L_0062:
    /* +0x00930 op=0x5e 5f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5f, (void *)(uintptr_t)0x125fd360);
...
L_0065:
    /* +0x00978 op=0x5e 5f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5f, (void *)(uintptr_t)0x125fd360);
...
L_0068:
    /* +0x009c0 op=0x5e 5f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5f, (void *)(uintptr_t)0x125fd360);
...
L_006b:
    /* +0x00a08 op=0x5e 5f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5f, (void *)(uintptr_t)0x125fd360);
...
L_006f:
    /* +0x00a68 op=0x5e 5f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5f, (void *)(uintptr_t)0x125fd360);
...
L_0073:
    /* +0x00ac8 op=0x5e 5f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5f, (void *)(uintptr_t)0x125fd360);
