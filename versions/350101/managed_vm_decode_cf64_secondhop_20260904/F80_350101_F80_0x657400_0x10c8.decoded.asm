; MetaSec managed bytecode decode: F80
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F80_0x657400_0x10c8.bin
...
000e  +0x00150  op=34  05 00 10 00  OR64             s16 = s5 | s0
...
0022  +0x00330  op=b5  04 04 06 00  ADD32_IMM16      s4 = int32(s4 +0x6)
0023  +0x00348  op=b2  04 04 07 00  AND64_IMM16      s4 = s4 & 0x7
0024  +0x00360  op=34  04 05 05 00  OR64             s5 = s4 | s5
...
002c  +0x00420  op=18  11 0a 01 01  SHL32_IMM        s1 = (int32_t)(s10 << 1)
...
0030  +0x00480  op=34  05 00 0c 00  OR64             s12 = s5 | s0
...
0037  +0x00528  op=0d  04 09 01 01  BYTE_FROM_U32_SHIFT s4 = (uint8_t)((uint32_t)s9 >> (s1 & 31))
0038  +0x00540  op=17  06 09 09 07  SHL32_VAR        s9 = (int32_t)((uint32_t)s9 << ((uint32_t)s6 & 31))
...
0041  +0x00618  op=09  03 02 01 00  SUB32            s1 = sign_extend_32((uint32_t)s3 - (uint32_t)s2)
...
0046  +0x00690  op=5e  4f 00 00 00  CALL_CF_INDEX    call native_binding[index=0x4f] via q1 table ; q1=0x125fd360 rt/so-mapped
0047  +0x006a8  op=85  00 12 04 00  ADD64_IMM16      s18 = s0 +0x4
0048  +0x006c0  op=85  1e 05 58 00  ADD64_IMM16      s5 = s30 +0x58
0049  +0x006d8  op=34  11 00 04 00  OR64             s4 = s17 | s0
004a  +0x006f0  op=34  12 00 06 01  OR64             s6 = s18 | s0
004b  +0x00708  op=5e  4f 00 00 00  CALL_CF_INDEX    call native_binding[index=0x4f] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0051  +0x00798  op=53  03 06 d0 09  LD_POOL_PTR      s6 = *(uint64_t *)q1 + 0x9d0 ; q1=0x125fd3a8 rt/so-mapped
...
0055  +0x007f8  op=b5  03 03 17 00  ADD32_IMM16      s3 = int32(s3 +0x17)
...
0065  +0x00978  op=34  07 00 0c 01  OR64             s12 = s7 | s0
0066  +0x00990  op=ae  0d 00 04 00  BR_EQ64          if (s13 == s0) goto record +107
0067  +0x009a8  op=18  10 0c 01 01  SHL32_IMM        s1 = (int32_t)(s12 << 1)
...
006c  +0x00a20  op=17  05 0a 0a 00  SHL32_VAR        s10 = (int32_t)((uint32_t)s10 << ((uint32_t)s5 & 31))
...
007a  +0x00b70  op=02  03 01 01 00  XOR64            s1 = s1 ^ s3
...
0087  +0x00ca8  op=0e  0b 01 01 08  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 8)
