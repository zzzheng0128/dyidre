/*
 * Auto-generated linear C-like lift for 350.101 managed program F63.
...
void managed_F63_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0009:
    /* +0x000d8 op=0x34 1d 00 1e 00 OR64: s30 = s29 | s0 */
    S[30] = S[29] | S[0];
...
L_000b:
    /* +0x00108 op=0x34 06 00 10 01 OR64: s16 = s6 | s0 */
    S[16] = S[6] | S[0];
...
L_000e:
    /* +0x00150 op=0x34 05 00 11 00 OR64: s17 = s5 | s0 */
    S[17] = S[5] | S[0];
...
L_002b:
    /* +0x00408 op=0x5e 67 00 00 00 CALL_CF_INDEX: call native_binding[index=0x67] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x67, (void *)(uintptr_t)0x125fd360);
...
L_0031:
    /* +0x00498 op=0x5e 67 00 00 00 CALL_CF_INDEX: call native_binding[index=0x67] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x67, (void *)(uintptr_t)0x125fd360);
...
L_0038:
    /* +0x00540 op=0x34 11 00 05 00 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];

L_0039:
    /* +0x00558 op=0x34 10 00 06 00 OR64: s6 = s16 | s0 */
    S[6] = S[16] | S[0];
