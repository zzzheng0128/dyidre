; MetaSec managed bytecode decode: F76
...
0013  +0x001c8  op=84  10 01 04 04  ADD64            s4 = s16 + s1
...
001a  +0x00270  op=5e  6a 00 00 00  CALL_CF_INDEX    call native_binding[index=0x6a] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0047  +0x006a8  op=68  13 03 04 08  LSR64_IMM        s4 = (uint64_t)s3 >> 8
...
0050  +0x00780  op=5e  6a 00 00 00  CALL_CF_INDEX    call native_binding[index=0x6a] via q1 table ; q1=0x125fd360 rt/so-mapped
