; MetaSec managed bytecode decode: F83
...
000b  +0x00108  op=34  04 00 10 00  OR64             s16 = s4 | s0
...
001a  +0x00270  op=b4  01 14 14 02  ADD32            s20 = int32(s1 + s20)
...
001f  +0x002e8  op=34  12 00 06 00  OR64             s6 = s18 | s0
...
0022  +0x00330  op=5e  6c 00 00 00  CALL_CF_INDEX    call native_binding[index=0x6c] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0034  +0x004e0  op=84  11 12 11 04  ADD64            s17 = s17 + s18
...
003f  +0x005e8  op=5e  6c 00 00 00  CALL_CF_INDEX    call native_binding[index=0x6c] via q1 table ; q1=0x125fd360 rt/so-mapped
