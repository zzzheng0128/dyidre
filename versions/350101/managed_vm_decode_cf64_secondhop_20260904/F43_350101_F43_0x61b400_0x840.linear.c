...
L_001a:
    /* +0x00270 op=0x5e 62 00 00 00 CALL_CF_INDEX: call native_binding[index=0x62] via q1 table q1=0x125fd360 */
...
L_0047:
    /* +0x006a8 op=0x68 00 03 04 08 LSR64_IMM: s4 = (uint64_t)s3 >> 8 */
    S[4] = (uint64_t)S[3] >> 8;
...
L_0050:
    /* +0x00780 op=0x5e 62 00 00 00 CALL_CF_INDEX: call native_binding[index=0x62] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x62, (void *)(uintptr_t)0x125fd360);

L_0051:
    /* +0x00798 op=0x34 1e 00 1d 01 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];
