/*
 * Auto-generated linear C-like lift for 350.101 managed program F74.
...
void managed_F74_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0003:
    /* +0x00048 op=0x53 04 07 28 08 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x828 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x828;
...
L_0006:
    /* +0x00090 op=0x34 02 00 0a 00 OR64: s10 = s2 | s0 */
    S[10] = S[2] | S[0];
...
L_0009:
    /* +0x000d8 op=0x6e 12 0a 0b 03 SHL64_IMM: s11 = s10 << 3 */
    S[11] = S[10] << 3;

L_000a:
    /* +0x000f0 op=0x34 02 00 18 00 OR64: s24 = s2 | s0 */
    S[24] = S[2] | S[0];

L_000b:
    /* +0x00108 op=0xb5 01 01 26 00 ADD32_IMM16: s1 = int32(s1 +0x26) */
    S[1] = (int32_t)((uint32_t)S[1] + 0x26);
...
L_000d:
    /* +0x00138 op=0x84 07 0b 01 00 ADD64: s1 = s7 + s11 */
    S[1] = S[7] + S[11];

L_000e:
    /* +0x00150 op=0x34 0c 06 0f 01 OR64: s15 = s12 | s6 */
    S[15] = S[12] | S[6];
...
L_0010:
    /* +0x00180 op=0x09 08 0c 0e 14 SUB32: s14 = sign_extend_32((uint32_t)s8 - (uint32_t)s12) */
...
L_0017:
    /* +0x00228 op=0x34 02 00 19 00 OR64: s25 = s2 | s0 */
    S[25] = S[2] | S[0];
...
L_001d:
    /* +0x002b8 op=0x66 0c 0d 0c 13 LSR64_VAR: s12 = (uint64_t)s13 >> (s12 & 63) */
    S[12] = (uint64_t)S[13] >> (S[12] & 63);

L_001e:
    /* +0x002d0 op=0x02 19 09 01 00 XOR64: s1 = s9 ^ s25 */
    S[1] = S[9] ^ S[25];
...
L_0023:
    /* +0x00348 op=0xb3 18 0c 0c 00 AND64: s12 = s24 & s12 */
    S[12] = S[24] & S[12];

L_0024:
    /* +0x00360 op=0x34 01 0c 01 00 OR64: s1 = s1 | s12 */
    S[1] = S[1] | S[12];
