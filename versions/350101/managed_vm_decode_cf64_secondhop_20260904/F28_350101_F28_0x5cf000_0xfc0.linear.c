...
L_000c:
    /* +0x00120 op=0x53 01 01 68 0f LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xf68 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf68;

L_000d:
    /* +0x00138 op=0x53 01 02 58 0f LD_POOL_PTR: s2 = *(uint64_t *)q1 + 0xf58 q1=0x125fd3a8 */
    S[2] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf58;

L_000e:
    /* +0x00150 op=0x53 04 03 48 0f LD_POOL_PTR: s3 = *(uint64_t *)q1 + 0xf48 q1=0x125fd3a8 */
    S[3] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf48;

L_000f:
    /* +0x00168 op=0x53 04 05 28 0f LD_POOL_PTR: s5 = *(uint64_t *)q1 + 0xf28 q1=0x125fd3a8 */
    S[5] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf28;
...
L_0011:
    /* +0x00198 op=0x53 03 04 38 0f LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0xf38 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf38;

L_0012:
    /* +0x001b0 op=0x53 03 06 18 0f LD_POOL_PTR: s6 = *(uint64_t *)q1 + 0xf18 q1=0x125fd3a8 */
    S[6] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf18;

L_0013:
    /* +0x001c8 op=0x53 03 07 08 0f LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0xf08 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf08;
...
L_0020:
    /* +0x00300 op=0x53 04 01 78 0f LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xf78 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf78;
...
L_0025:
    /* +0x00378 op=0x53 01 01 88 0f LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xf88 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf88;
...
L_0027:
    /* +0x003a8 op=0x53 03 01 98 0f LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xf98 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xf98;
...
L_005c:
    /* +0x008a0 op=0x5e 60 00 00 00 CALL_CF_INDEX: call native_binding[index=0x60] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x60, (void *)(uintptr_t)0x125fd360);
...
L_005f:
    /* +0x008e8 op=0x5e 61 00 00 00 CALL_CF_INDEX: call native_binding[index=0x61] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x61, (void *)(uintptr_t)0x125fd360);
...
L_0062:
    /* +0x00930 op=0x5e 61 00 00 00 CALL_CF_INDEX: call native_binding[index=0x61] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x61, (void *)(uintptr_t)0x125fd360);
...
L_0065:
    /* +0x00978 op=0x5e 61 00 00 00 CALL_CF_INDEX: call native_binding[index=0x61] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x61, (void *)(uintptr_t)0x125fd360);
...
L_0068:
    /* +0x009c0 op=0x5e 61 00 00 00 CALL_CF_INDEX: call native_binding[index=0x61] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x61, (void *)(uintptr_t)0x125fd360);
...
L_006b:
    /* +0x00a08 op=0x5e 61 00 00 00 CALL_CF_INDEX: call native_binding[index=0x61] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x61, (void *)(uintptr_t)0x125fd360);
...
L_006f:
    /* +0x00a68 op=0x5e 61 00 00 00 CALL_CF_INDEX: call native_binding[index=0x61] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x61, (void *)(uintptr_t)0x125fd360);
...
L_0073:
    /* +0x00ac8 op=0x5e 61 00 00 00 CALL_CF_INDEX: call native_binding[index=0x61] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x61, (void *)(uintptr_t)0x125fd360);
...
L_009b:
    /* +0x00e88 op=0x18 00 02 01 00 SHL32_IMM: s1 = (int32_t)(s2 << 0) */
