/*
 * Auto-generated linear C-like lift for 350.101 managed program F58.
...
void managed_F58_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0003:
    /* +0x00048 op=0x53 04 07 78 07 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x778 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x778;
...
L_000b:
    /* +0x00108 op=0xb5 01 01 37 00 ADD32_IMM16: s1 = int32(s1 +0x37) */
    S[1] = (int32_t)((uint32_t)S[1] + 0x37);
