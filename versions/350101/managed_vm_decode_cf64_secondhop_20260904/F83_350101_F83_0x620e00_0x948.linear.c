/*
 * Auto-generated linear C-like lift for 350.101 managed program F83.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F83_0x620e00_0x948.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F83_350_linear_lift(ManagedFrame350 *frame)
{
...
L_000b:
    /* +0x00108 op=0x34 04 00 10 00 OR64: s16 = s4 | s0 */
    S[16] = S[4] | S[0];
...
L_001a:
    /* +0x00270 op=0xb4 01 14 14 02 ADD32: s20 = int32(s1 + s20) */
...
L_001f:
    /* +0x002e8 op=0x34 12 00 06 00 OR64: s6 = s18 | s0 */
    S[6] = S[18] | S[0];
...
L_0022:
    /* +0x00330 op=0x5e 6c 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6c] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x6c, (void *)(uintptr_t)0x125fd360);
...
L_0034:
    /* +0x004e0 op=0x84 11 12 11 04 ADD64: s17 = s17 + s18 */
    S[17] = S[17] + S[18];
...
L_003f:
    /* +0x005e8 op=0x5e 6c 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6c] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x6c, (void *)(uintptr_t)0x125fd360);
