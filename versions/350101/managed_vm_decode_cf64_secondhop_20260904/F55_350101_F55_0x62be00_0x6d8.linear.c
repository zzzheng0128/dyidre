/*
 * Auto-generated linear C-like lift for 350.101 managed program F55.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F55_0x62be00_0x6d8.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F55_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0010:
    /* +0x00180 op=0xb4 01 02 02 00 ADD32: s2 = int32(s1 + s2) */
...
L_001e:
    /* +0x002d0 op=0x13 10 13 01 00 CMP_LO64: s1 = ((uint64_t)s16 < (uint64_t)s19) ? 1 : 0 */
...
L_0027:
    /* +0x003a8 op=0x84 14 01 04 04 ADD64: s4 = s20 + s1 */
    S[4] = S[20] + S[1];
...
L_0029:
    /* +0x003d8 op=0x34 12 00 04 00 OR64: s4 = s18 | s0 */
    S[4] = S[18] | S[0];

L_002a:
    /* +0x003f0 op=0x34 14 00 05 01 OR64: s5 = s20 | s0 */
    S[5] = S[20] | S[0];

L_002b:
    /* +0x00408 op=0x5e 65 00 00 00 CALL_CF_INDEX: call native_binding[index=0x65] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x65, (void *)(uintptr_t)0x125fd360);

L_002c:
    /* +0x00420 op=0x64 10 13 10 02 SUB64: s16 = s16 - s19 */
    S[16] = S[16] - S[19];
...
L_0031:
    /* +0x00498 op=0x5e 65 00 00 00 CALL_CF_INDEX: call native_binding[index=0x65] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x65, (void *)(uintptr_t)0x125fd360);
