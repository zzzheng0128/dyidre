/*
 * Auto-generated linear C-like lift for 350.101 managed program F72.
...
void managed_F72_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0012:
    /* +0x001b0 op=0x34 14 00 06 00 OR64: s6 = s20 | s0 */
    S[6] = S[20] | S[0];
...
L_001a:
    /* +0x00270 op=0x53 01 07 90 09 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x990 q1=0x125fd3a8 */
...
L_001e:
    /* +0x002d0 op=0x1e 04 01 01 01 CMOVNZ64: s1 = (s1 != 0) ? s4 : 0 */
    S[1] = (S[1] != 0) ? S[4] : 0;
...
L_002c:
    /* +0x00420 op=0x18 00 0a 01 01 SHL32_IMM: s1 = (int32_t)(s10 << 1) */
...
L_0033:
    /* +0x004c8 op=0x18 10 0b 01 01 SHL32_IMM: s1 = (int32_t)(s11 << 1) */
...
L_0038:
    /* +0x00540 op=0x17 06 09 09 17 SHL32_VAR: s9 = (int32_t)((uint32_t)s9 << ((uint32_t)s6 & 31)) */
...
L_0041:
    /* +0x00618 op=0x09 03 02 01 14 SUB32: s1 = sign_extend_32((uint32_t)s3 - (uint32_t)s2) */
...
L_0046:
    /* +0x00690 op=0x5e 48 00 00 00 CALL_CF_INDEX: call native_binding[index=0x48] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x48, (void *)(uintptr_t)0x125fd360);
...
L_0049:
    /* +0x006d8 op=0x34 11 00 04 01 OR64: s4 = s17 | s0 */
    S[4] = S[17] | S[0];
...
L_004b:
    /* +0x00708 op=0x5e 48 00 00 00 CALL_CF_INDEX: call native_binding[index=0x48] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x48, (void *)(uintptr_t)0x125fd360);
...
L_0051:
    /* +0x00798 op=0x53 01 06 d0 09 LD_POOL_PTR: s6 = *(uint64_t *)q1 + 0x9d0 q1=0x125fd3a8 */
...
L_0055:
    /* +0x007f8 op=0xb5 03 03 18 00 ADD32_IMM16: s3 = int32(s3 +0x18) */
    S[3] = (int32_t)((uint32_t)S[3] + 0x18);
...
L_0057:
    /* +0x00828 op=0x34 03 04 04 00 OR64: s4 = s3 | s4 */
    S[4] = S[3] | S[4];
...
L_005a:
    /* +0x00870 op=0x6e 12 02 09 02 SHL64_IMM: s9 = s2 << 2 */
    S[9] = S[2] << 2;

L_005b:
    /* +0x00888 op=0x34 04 00 0c 00 OR64: s12 = s4 | s0 */
    S[12] = S[4] | S[0];
...
L_0060:
    /* +0x00900 op=0x18 00 0b 01 01 SHL32_IMM: s1 = (int32_t)(s11 << 1) */
    S[1] = (int32_t)((uint32_t)S[11] << 1);
...
L_0065:
    /* +0x00978 op=0x34 07 00 0c 00 OR64: s12 = s7 | s0 */
    S[12] = S[7] | S[0];
...
L_0072:
    /* +0x00ab0 op=0x34 0a 01 01 00 OR64: s1 = s10 | s1 */
    S[1] = S[10] | S[1];
...
L_007c:
    /* +0x00ba0 op=0x02 04 02 02 00 XOR64: s2 = s2 ^ s4 */
    S[2] = S[2] ^ S[4];
...
L_0080:
    /* +0x00c00 op=0x02 05 03 01 00 XOR64: s1 = s3 ^ s5 */
    S[1] = S[3] ^ S[5];
...
L_0083:
    /* +0x00c48 op=0x02 04 01 01 01 XOR64: s1 = s1 ^ s4 */
    S[1] = S[1] ^ S[4];
