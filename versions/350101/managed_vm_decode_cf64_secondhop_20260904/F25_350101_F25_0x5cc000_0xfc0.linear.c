/*
 * Auto-generated linear C-like lift for 350.101 managed program F25.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F25_0x5cc000_0xfc0.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F25_350_linear_lift(ManagedFrame350 *frame)
{
...
L_000c:
    /* +0x00120 op=0x53 01 01 88 0d LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xd88 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd88;

L_000d:
    /* +0x00138 op=0x53 03 02 78 0d LD_POOL_PTR: s2 = *(uint64_t *)q1 + 0xd78 q1=0x125fd3a8 */
    S[2] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd78;

L_000e:
    /* +0x00150 op=0x53 01 03 68 0d LD_POOL_PTR: s3 = *(uint64_t *)q1 + 0xd68 q1=0x125fd3a8 */
    S[3] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd68;

L_000f:
    /* +0x00168 op=0x53 01 05 48 0d LD_POOL_PTR: s5 = *(uint64_t *)q1 + 0xd48 q1=0x125fd3a8 */
    S[5] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd48;
...
L_0011:
    /* +0x00198 op=0x53 03 04 58 0d LD_POOL_PTR: s4 = *(uint64_t *)q1 + 0xd58 q1=0x125fd3a8 */
    S[4] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd58;

L_0012:
    /* +0x001b0 op=0x53 04 06 38 0d LD_POOL_PTR: s6 = *(uint64_t *)q1 + 0xd38 q1=0x125fd3a8 */
    S[6] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd38;

L_0013:
    /* +0x001c8 op=0x53 01 07 28 0d LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0xd28 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd28;
...
L_0020:
    /* +0x00300 op=0x53 04 01 98 0d LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xd98 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xd98;
...
L_0025:
    /* +0x00378 op=0x53 04 01 a8 0d LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xda8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xda8;
...
L_0027:
    /* +0x003a8 op=0x53 03 01 b8 0d LD_POOL_PTR: s1 = *(uint64_t *)q1 + 0xdb8 q1=0x125fd3a8 */
    S[1] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0xdb8;
...
L_005c:
    /* +0x008a0 op=0x5e 5a 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5a] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5a, (void *)(uintptr_t)0x125fd360);
...
L_005f:
    /* +0x008e8 op=0x5e 5b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5b, (void *)(uintptr_t)0x125fd360);
...
L_0062:
    /* +0x00930 op=0x5e 5b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5b, (void *)(uintptr_t)0x125fd360);
...
L_0065:
    /* +0x00978 op=0x5e 5b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5b, (void *)(uintptr_t)0x125fd360);
...
L_0068:
    /* +0x009c0 op=0x5e 5b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5b, (void *)(uintptr_t)0x125fd360);
...
L_006b:
    /* +0x00a08 op=0x5e 5b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5b, (void *)(uintptr_t)0x125fd360);
...
L_006f:
    /* +0x00a68 op=0x5e 5b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5b, (void *)(uintptr_t)0x125fd360);
...
L_0073:
    /* +0x00ac8 op=0x5e 5b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x5b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x5b, (void *)(uintptr_t)0x125fd360);
...
L_008c:
    /* +0x00d20 op=0x34 1e 00 1d 00 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];
