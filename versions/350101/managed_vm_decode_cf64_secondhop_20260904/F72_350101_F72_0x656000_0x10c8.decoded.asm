; MetaSec managed bytecode decode: F72
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F72_0x656000_0x10c8.bin
...
0012  +0x001b0  op=34  14 00 06 00  OR64             s6 = s20 | s0
...
001a  +0x00270  op=53  01 07 90 09  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0x990 ; q1=0x125fd3a8 rt/so-mapped
...
0031  +0x00498  op=34  08 00 0b 00  OR64             s11 = s8 | s0
0032  +0x004b0  op=ae  0c 00 04 00  BR_EQ64          if (s12 == s0) goto record +55
0033  +0x004c8  op=18  10 0b 01 01  SHL32_IMM        s1 = (int32_t)(s11 << 1)
...
0038  +0x00540  op=17  06 09 09 17  SHL32_VAR        s9 = (int32_t)((uint32_t)s9 << ((uint32_t)s6 & 31))
0039  +0x00558  op=b3  01 0a 01 00  AND64            s1 = s1 & s10
003a  +0x00570  op=36  0b 00 0a 01  NOR64            s10 = ~(s11 | s0)
003b  +0x00588  op=b3  09 0a 09 01  AND64            s9 = s9 & s10
003c  +0x005a0  op=34  09 01 01 01  OR64             s1 = s9 | s1
003d  +0x005b8  op=84  12 13 09 14  ADD64            s9 = s18 + s19
...
0041  +0x00618  op=09  03 02 01 14  SUB32            s1 = sign_extend_32((uint32_t)s3 - (uint32_t)s2)
...
0046  +0x00690  op=5e  48 00 00 00  CALL_CF_INDEX    call native_binding[index=0x48] via q1 table ; q1=0x125fd360 rt/so-mapped
...
004a  +0x006f0  op=34  12 00 06 01  OR64             s6 = s18 | s0
004b  +0x00708  op=5e  48 00 00 00  CALL_CF_INDEX    call native_binding[index=0x48] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0051  +0x00798  op=53  01 06 d0 09  LD_POOL_PTR      s6 = *(uint64_t *)q1 + 0x9d0 ; q1=0x125fd3a8 rt/so-mapped
...
0055  +0x007f8  op=b5  03 03 18 00  ADD32_IMM16      s3 = int32(s3 +0x18)
0056  +0x00810  op=b2  03 03 1f 00  AND64_IMM16      s3 = s3 & 0x1f
0057  +0x00828  op=34  03 04 04 00  OR64             s4 = s3 | s4
0058  +0x00840  op=09  01 03 05 14  SUB32            s5 = sign_extend_32((uint32_t)s1 - (uint32_t)s3)
0059  +0x00858  op=ae  02 12 1b 00  BR_EQ64          if (s2 == s18) goto record +117
005a  +0x00870  op=6e  12 02 09 02  SHL64_IMM        s9 = s2 << 2
005b  +0x00888  op=34  04 00 0c 00  OR64             s12 = s4 | s0
005c  +0x008a0  op=34  07 00 0b 00  OR64             s11 = s7 | s0
005d  +0x008b8  op=84  06 09 01 14  ADD64            s1 = s6 + s9
005e  +0x008d0  op=52  01 0a 00 00  LD32S            s10 = *(int32_t *)(s1 +0x0)
005f  +0x008e8  op=ae  0c 00 04 00  BR_EQ64          if (s12 == s0) goto record +100
0060  +0x00900  op=18  00 0b 01 01  SHL32_IMM        s1 = (int32_t)(s11 << 1)
...
006e  +0x00a50  op=84  08 09 09 14  ADD64            s9 = s8 + s9
006f  +0x00a68  op=b3  0b 01 01 01  AND64            s1 = s11 & s1
0070  +0x00a80  op=36  0c 00 0b 01  NOR64            s11 = ~(s12 | s0)
0071  +0x00a98  op=b3  0a 0b 0a 01  AND64            s10 = s10 & s11
0072  +0x00ab0  op=34  0a 01 01 00  OR64             s1 = s10 | s1
...
007c  +0x00ba0  op=02  04 02 02 00  XOR64            s2 = s2 ^ s4
...
0087  +0x00ca8  op=0e  0d 01 01 08  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 8)
...
0090  +0x00d80  op=0e  0b 01 01 08  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 8)
...
0099  +0x00e58  op=0e  0d 01 01 08  LSR32_IMM        s1 = sign_extend_32((uint32_t)s1 >> 8)
