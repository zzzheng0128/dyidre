; MetaSec managed bytecode decode: F26
...
000c  +0x00120  op=53  04 01 28 0e  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xe28 ; q1=0x125fd3a8 rt/so-mapped
000d  +0x00138  op=53  03 02 18 0e  LD_POOL_PTR      s2 = *(uint64_t *)q1 + 0xe18 ; q1=0x125fd3a8 rt/so-mapped
000e  +0x00150  op=53  03 03 08 0e  LD_POOL_PTR      s3 = *(uint64_t *)q1 + 0xe08 ; q1=0x125fd3a8 rt/so-mapped
000f  +0x00168  op=53  03 05 e8 0d  LD_POOL_PTR      s5 = *(uint64_t *)q1 + 0xde8 ; q1=0x125fd3a8 rt/so-mapped
0010  +0x00180  op=34  04 00 10 01  OR64             s16 = s4 | s0
0011  +0x00198  op=53  03 04 f8 0d  LD_POOL_PTR      s4 = *(uint64_t *)q1 + 0xdf8 ; q1=0x125fd3a8 rt/so-mapped
0012  +0x001b0  op=53  04 06 d8 0d  LD_POOL_PTR      s6 = *(uint64_t *)q1 + 0xdd8 ; q1=0x125fd3a8 rt/so-mapped
0013  +0x001c8  op=53  04 07 c8 0d  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0xdc8 ; q1=0x125fd3a8 rt/so-mapped
0014  +0x001e0  op=53  01 08 78 0c  LD_POOL_PTR      s8 = *(uint64_t *)q1 + 0xc78 ; q1=0x125fd3a8 rt/so-mapped
...
0020  +0x00300  op=53  04 01 38 0e  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xe38 ; q1=0x125fd3a8 rt/so-mapped
...
0025  +0x00378  op=53  01 01 48 0e  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xe48 ; q1=0x125fd3a8 rt/so-mapped
0026  +0x00390  op=58  01 17 00 00  LD64             s23 = *(uint64_t *)(s1 +0x0)
0027  +0x003a8  op=53  01 01 58 0e  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xe58 ; q1=0x125fd3a8 rt/so-mapped
...
0045  +0x00678  op=34  12 00 04 00  OR64             s4 = s18 | s0
...
005c  +0x008a0  op=5e  5c 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5c] via q1 table ; q1=0x125fd360 rt/so-mapped
005d  +0x008b8  op=58  15 05 00 00  LD64             s5 = *(uint64_t *)(s21 +0x0)
005e  +0x008d0  op=34  12 00 04 01  OR64             s4 = s18 | s0
005f  +0x008e8  op=5e  5d 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5d] via q1 table ; q1=0x125fd360 rt/so-mapped
0060  +0x00900  op=58  14 05 00 00  LD64             s5 = *(uint64_t *)(s20 +0x0)
0061  +0x00918  op=58  15 04 00 00  LD64             s4 = *(uint64_t *)(s21 +0x0)
0062  +0x00930  op=5e  5d 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5d] via q1 table ; q1=0x125fd360 rt/so-mapped
0063  +0x00948  op=58  13 05 00 00  LD64             s5 = *(uint64_t *)(s19 +0x0)
0064  +0x00960  op=58  14 04 00 00  LD64             s4 = *(uint64_t *)(s20 +0x0)
0065  +0x00978  op=5e  5d 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5d] via q1 table ; q1=0x125fd360 rt/so-mapped
0066  +0x00990  op=58  17 05 00 00  LD64             s5 = *(uint64_t *)(s23 +0x0)
0067  +0x009a8  op=58  13 04 00 00  LD64             s4 = *(uint64_t *)(s19 +0x0)
0068  +0x009c0  op=5e  5d 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5d] via q1 table ; q1=0x125fd360 rt/so-mapped
0069  +0x009d8  op=58  11 05 00 00  LD64             s5 = *(uint64_t *)(s17 +0x0)
006a  +0x009f0  op=58  17 04 00 00  LD64             s4 = *(uint64_t *)(s23 +0x0)
006b  +0x00a08  op=5e  5d 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5d] via q1 table ; q1=0x125fd360 rt/so-mapped
...
006f  +0x00a68  op=5e  5d 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5d] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0073  +0x00ac8  op=5e  5d 00 00 00  CALL_CF_INDEX    call native_binding[index=0x5d] via q1 table ; q1=0x125fd360 rt/so-mapped
...
009f  +0x00ee8  op=34  02 00 04 00  OR64             s4 = s2 | s0
