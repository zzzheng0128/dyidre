; MetaSec managed bytecode decode: F59
...
0022  +0x00330  op=5e  66 00 00 00  CALL_CF_INDEX    call native_binding[index=0x66] via q1 table ; q1=0x125fd360 rt/so-mapped
...
003e  +0x005d0  op=34  10 00 04 00  OR64             s4 = s16 | s0
003f  +0x005e8  op=5e  66 00 00 00  CALL_CF_INDEX    call native_binding[index=0x66] via q1 table ; q1=0x125fd360 rt/so-mapped
