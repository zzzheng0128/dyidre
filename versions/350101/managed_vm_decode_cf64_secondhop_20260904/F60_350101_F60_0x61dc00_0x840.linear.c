/*
 * Auto-generated linear C-like lift for 350.101 managed program F60.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F60_0x61dc00_0x840.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F60_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0008:
    /* +0x000c0 op=0x34 04 00 10 01 OR64: s16 = s4 | s0 */
    S[16] = S[4] | S[0];
...
L_000b:
    /* +0x00108 op=0x84 04 01 01 04 ADD64: s1 = s4 + s1 */
    S[1] = S[4] + S[1];
...
L_0013:
    /* +0x001c8 op=0x84 10 01 04 00 ADD64: s4 = s16 + s1 */
    S[4] = S[16] + S[1];
...
L_0015:
    /* +0x001f8 op=0x09 01 03 01 14 SUB32: s1 = sign_extend_32((uint32_t)s1 - (uint32_t)s3) */
...
L_001a:
    /* +0x00270 op=0x5e 66 00 00 00 CALL_CF_INDEX: call native_binding[index=0x66] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x66, (void *)(uintptr_t)0x125fd360);
...
L_0022:
    /* +0x00330 op=0x09 01 02 01 00 SUB32: s1 = sign_extend_32((uint32_t)s1 - (uint32_t)s2) */
...
L_0028:
    /* +0x003c0 op=0x18 00 02 02 03 SHL32_IMM: s2 = (int32_t)(s2 << 3) */
...
L_002b:
    /* +0x00408 op=0x84 01 02 02 04 ADD64: s2 = s1 + s2 */
    S[2] = S[1] + S[2];

L_002c:
    /* +0x00420 op=0x13 02 01 01 0f CMP_LO64: s1 = ((uint64_t)s2 < (uint64_t)s1) ? 1 : 0 */
...
L_003c:
    /* +0x005a0 op=0x84 10 11 01 14 ADD64: s1 = s16 + s17 */
    S[1] = S[16] + S[17];
...
L_0047:
    /* +0x006a8 op=0x68 03 03 04 08 LSR64_IMM: s4 = (uint64_t)s3 >> 8 */
    S[4] = (uint64_t)S[3] >> 8;
...
L_004a:
    /* +0x006f0 op=0x68 03 03 04 10 LSR64_IMM: s4 = (uint64_t)s3 >> 16 */
    S[4] = (uint64_t)S[3] >> 16;

L_004b:
    /* +0x00708 op=0x68 13 03 03 18 LSR64_IMM: s3 = (uint64_t)s3 >> 24 */
    S[3] = (uint64_t)S[3] >> 24;
...
L_0050:
    /* +0x00780 op=0x5e 66 00 00 00 CALL_CF_INDEX: call native_binding[index=0x66] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x66, (void *)(uintptr_t)0x125fd360);
