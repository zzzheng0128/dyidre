; MetaSec managed bytecode decode: F66
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F66_0x5e3c00_0x3c0.bin
...
0003  +0x00048  op=53  03 07 d0 07  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0x7d0 ; q1=0x125fd3a8 rt/so-mapped
...
0019  +0x00258  op=6e  12 19 01 01  SHL64_IMM        s1 = s25 << 1
...
001f  +0x002e8  op=6c  0e 0d 0e 11  SHL64_VAR        s14 = s13 << (s14 & 63)
0020  +0x00300  op=84  05 0b 0b 14  ADD64            s11 = s5 + s11
0021  +0x00318  op=85  0a 0a 01 00  ADD64_IMM16      s10 = s10 +0x1
0022  +0x00330  op=b3  0e 01 01 00  AND64            s1 = s14 & s1
