; MetaSec managed bytecode decode: F67
...
000c  +0x00120  op=18  11 06 14 00  SHL32_IMM        s20 = (int32_t)(s6 << 0)
...
0010  +0x00180  op=84  10 01 04 00  ADD64            s4 = s16 + s1
...
001d  +0x002b8  op=34  11 00 05 00  OR64             s5 = s17 | s0
...
0021  +0x00318  op=34  10 00 04 00  OR64             s4 = s16 | s0
0022  +0x00330  op=5e  68 00 00 00  CALL_CF_INDEX    call native_binding[index=0x68] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0033  +0x004c8  op=09  14 13 14 04  SUB32            s20 = sign_extend_32((uint32_t)s20 - (uint32_t)s19)
...
003b  +0x00588  op=34  11 00 05 01  OR64             s5 = s17 | s0
...
003f  +0x005e8  op=5e  68 00 00 00  CALL_CF_INDEX    call native_binding[index=0x68] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0054  +0x007e0  op=34  10 00 04 00  OR64             s4 = s16 | s0
0055  +0x007f8  op=34  11 00 05 01  OR64             s5 = s17 | s0
0056  +0x00810  op=34  12 00 06 00  OR64             s6 = s18 | s0
