/*
 * Auto-generated linear C-like lift for 350.101 managed program F42.
...
void managed_F42_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0001:
    /* +0x00018 op=0x25 1d 1f 38 00 ST64: *(s29 +0x38) = s31 q1=0x314604 */
...
L_0004:
    /* +0x00060 op=0x25 1d 13 20 00 ST64: *(s29 +0x20) = s19 q1=0x19 */
...
L_0006:
    /* +0x00090 op=0x25 1d 11 10 00 ST64: *(s29 +0x10) = s17 q1=0x39314606 */
...
L_0008:
    /* +0x000c0 op=0x34 1d 00 1e 00 OR64: s30 = s29 | s0 */
    S[30] = S[29] | S[0];

L_0009:
    /* +0x000d8 op=0x52 04 02 60 00 LD32S: s2 = *(int32_t *)(s4 +0x60) q1=0x1c */
    S[2] = *(int32_t *)((uint8_t *)S[4] + 0x60);

L_000a:
    /* +0x000f0 op=0x34 05 00 11 01 OR64: s17 = s5 | s0 */
    S[17] = S[5] | S[0];

L_000b:
    /* +0x00108 op=0x34 04 00 10 01 OR64: s16 = s4 | s0 q1=0x364604 */
    S[16] = S[4] | S[0];
...
L_000e:
    /* +0x00150 op=0x6d 00 02 01 00 SHL64_IMM32PLUS: s1 = s2 << (0 + 32) q1=0x190000001f */
    S[1] = S[2] << (0 + 32);
...
L_0010:
    /* +0x00180 op=0x84 10 01 04 04 ADD64: s4 = s16 + s1 q1=0x394604 */
    S[4] = S[16] + S[1];
...
L_0013:
    /* +0x001c8 op=0x13 14 13 01 00 CMP_LO64: s1 = ((uint64_t)s20 < (uint64_t)s19) ? 1 : 0 q1=0x22 */
...
L_0015:
    /* +0x001f8 op=0x6d 00 14 01 00 SHL64_IMM32PLUS: s1 = s20 << (0 + 32) q1=0x32314606 */
    S[1] = S[20] << (0 + 32);

L_0016:
    /* +0x00210 op=0x34 11 00 05 00 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];
...
L_001a:
    /* +0x00270 op=0xb4 01 14 14 02 ADD32: s20 = int32(s1 + s20) q1=0x35314606 */
...
L_001d:
    /* +0x002b8 op=0x34 11 00 05 01 OR64: s5 = s17 | s0 q1=0x28 */
    S[5] = S[17] | S[0];
...
L_001f:
    /* +0x002e8 op=0x34 12 00 06 01 OR64: s6 = s18 | s0 q1=0x38314606 */
    S[6] = S[18] | S[0];
...
L_0022:
    /* +0x00330 op=0x5e 62 00 00 00 CALL_CF_INDEX: call native_binding[index=0x62] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x62, (void *)(uintptr_t)0x125fd360);
...
L_0024:
    /* +0x00360 op=0x85 01 02 00 02 ADD64_IMM16: s2 = s1 +0x200 q1=0x33324606 */
    S[2] = S[1] + 0x200;
...
L_0027:
    /* +0x003a8 op=0xa7 01 00 0b 00 BR_NE64: if (s1 != s0) goto record +51 q1=0x2e */
...
L_0029:
    /* +0x003d8 op=0x85 01 01 01 00 ADD64_IMM16: s1 = s1 +0x1 q1=0x33344606 */
    S[1] = S[1] + 0x1;
...
L_002c:
    /* +0x00420 op=0x58 10 01 48 00 LD64: s1 = *(uint64_t *)(s16 +0x48) q1=0x1e00000031 */
...
L_002e:
    /* +0x00450 op=0x25 10 01 48 00 ST64: *(s16 +0x48) = s1 q1=0x37344606 */
...
L_0031:
    /* +0x00498 op=0x85 01 01 01 00 ADD64_IMM16: s1 = s1 +0x1 q1=0x34 */
    S[1] = S[1] + 0x1;
...
L_0033:
    /* +0x004c8 op=0x09 14 13 14 00 SUB32: s20 = sign_extend_32((uint32_t)s20 - (uint32_t)s19) q1=0x30354606 */
...
L_0036:
    /* +0x00510 op=0x85 00 13 40 00 ADD64_IMM16: s19 = s0 +0x40 q1=0x37 */
    S[19] = S[0] + 0x40;
...
L_0038:
    /* +0x00540 op=0x14 14 01 40 00 CMP_LO_IMM64: s1 = ((uint64_t)s20 < (uint64_t)64) ? 1 : 0 q1=0x34354606 */
...
L_003a:
    /* +0x00570 op=0x34 10 00 04 01 OR64: s4 = s16 | s0 */
    S[4] = S[16] | S[0];

L_003b:
    /* +0x00588 op=0x34 11 00 05 01 OR64: s5 = s17 | s0 q1=0x3a */
    S[5] = S[17] | S[0];

L_003c:
    /* +0x005a0 op=0x34 13 00 06 01 OR64: s6 = s19 | s0 */
    S[6] = S[19] | S[0];
...
L_003f:
    /* +0x005e8 op=0x5e 62 00 00 00 CALL_CF_INDEX: call native_binding[index=0x62] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x62, (void *)(uintptr_t)0x125fd360);

L_0040:
    /* +0x00600 op=0x58 10 01 58 00 LD64: s1 = *(uint64_t *)(s16 +0x58) q1=0x3d */
    S[1] = *(uint64_t *)((uint8_t *)S[16] + 0x58);
...
L_0042:
    /* +0x00630 op=0x14 01 01 00 fe CMP_LO_IMM64: s1 = ((uint64_t)s1 < (uint64_t)-512) ? 1 : 0 q1=0x30364606 */
    S[1] = ((uint64_t)S[1] < (uint64_t)(-0x200)) ? 1 : 0;
...
L_0045:
    /* +0x00678 op=0x58 10 01 50 00 LD64: s1 = *(uint64_t *)(s16 +0x50) q1=0x40 */
    S[1] = *(uint64_t *)((uint8_t *)S[16] + 0x50);
...
L_0047:
    /* +0x006a8 op=0x25 10 01 50 00 ST64: *(s16 +0x50) = s1 q1=0x34364606 */
    *(uint64_t *)((uint8_t *)S[16] + 0x50) = S[1];
...
L_004a:
    /* +0x006f0 op=0x85 01 01 01 00 ADD64_IMM16: s1 = s1 +0x1 q1=0x2300000043 */
    S[1] = S[1] + 0x1;
...
L_004c:
    /* +0x00720 op=0xa7 01 00 03 00 BR_NE64: if (s1 != s0) goto record +80 q1=0x37364606 */
    if (S[1] != S[0]) goto L_0050;
...
L_004f:
    /* +0x00768 op=0x25 10 01 40 00 ST64: *(s16 +0x40) = s1 q1=0x46 */
    *(uint64_t *)((uint8_t *)S[16] + 0x40) = S[1];
...
L_0051:
    /* +0x00798 op=0xb5 14 14 c0 ff ADD32_IMM16: s20 = int32(s20 -0x40) q1=0x31374606 */
...
L_0054:
    /* +0x007e0 op=0x34 10 00 04 00 OR64: s4 = s16 | s0 q1=0x49 */
    S[4] = S[16] | S[0];

L_0055:
    /* +0x007f8 op=0x34 11 00 05 00 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];

L_0056:
    /* +0x00810 op=0x34 12 00 06 01 OR64: s6 = s18 | s0 q1=0x34374606 */
    S[6] = S[18] | S[0];
...
L_0059:
    /* +0x00858 op=0x34 1e 00 1d 00 OR64: s29 = s30 | s0 q1=0x4c */
    S[29] = S[30] | S[0];
...
L_005b:
    /* +0x00888 op=0x58 1d 11 10 00 LD64: s17 = *(uint64_t *)(s29 +0x10) q1=0x38374606 */
...
L_005e:
    /* +0x008d0 op=0x58 1d 14 28 00 LD64: s20 = *(uint64_t *)(s29 +0x28) q1=0x4f */
...
L_0060:
    /* +0x00900 op=0x58 1d 1f 38 00 LD64: s31 = *(uint64_t *)(s29 +0x38) q1=0x38324606 */
