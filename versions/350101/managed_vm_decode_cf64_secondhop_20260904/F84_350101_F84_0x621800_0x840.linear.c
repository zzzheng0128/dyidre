/*
 * Auto-generated linear C-like lift for 350.101 managed program F84.
...
void managed_F84_350_linear_lift(ManagedFrame350 *frame)
{
...
L_001a:
    /* +0x00270 op=0x5e 6c 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6c] via q1 table q1=0x125fd360 */
...
L_0020:
    /* +0x00300 op=0x84 10 01 04 00 ADD64: s4 = s16 + s1 */
    S[4] = S[16] + S[1];
...
L_0022:
    /* +0x00330 op=0x09 01 02 01 04 SUB32: s1 = sign_extend_32((uint32_t)s1 - (uint32_t)s2) */
...
L_004b:
    /* +0x00708 op=0x68 00 03 03 18 LSR64_IMM: s3 = (uint64_t)s3 >> 24 */
    S[3] = (uint64_t)S[3] >> 24;
...
L_0050:
    /* +0x00780 op=0x5e 6c 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6c] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x6c, (void *)(uintptr_t)0x125fd360);
