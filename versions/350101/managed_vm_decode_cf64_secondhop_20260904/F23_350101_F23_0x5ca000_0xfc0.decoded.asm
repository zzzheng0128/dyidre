; MetaSec managed bytecode decode: F23
...
000c  +0x00120  op=53  01 01 48 0c  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xc48 ; q1=0x125fd3a8 rt/so-mapped
000d  +0x00138  op=34  04 00 10 01  OR64             s16 = s4 | s0
000e  +0x00150  op=53  03 04 18 0c  LD_POOL_PTR      s4 = *(uint64_t *)q1 + 0xc18 ; q1=0x125fd3a8 rt/so-mapped
000f  +0x00168  op=53  04 02 38 0c  LD_POOL_PTR      s2 = *(uint64_t *)q1 + 0xc38 ; q1=0x125fd3a8 rt/so-mapped
0010  +0x00180  op=53  01 03 28 0c  LD_POOL_PTR      s3 = *(uint64_t *)q1 + 0xc28 ; q1=0x125fd3a8 rt/so-mapped
0011  +0x00198  op=53  03 05 08 0c  LD_POOL_PTR      s5 = *(uint64_t *)q1 + 0xc08 ; q1=0x125fd3a8 rt/so-mapped
0012  +0x001b0  op=53  04 06 f8 0b  LD_POOL_PTR      s6 = *(uint64_t *)q1 + 0xbf8 ; q1=0x125fd3a8 rt/so-mapped
0013  +0x001c8  op=53  01 07 e8 0b  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0xbe8 ; q1=0x125fd3a8 rt/so-mapped
0014  +0x001e0  op=53  04 08 d8 0b  LD_POOL_PTR      s8 = *(uint64_t *)q1 + 0xbd8 ; q1=0x125fd3a8 rt/so-mapped
0015  +0x001f8  op=58  01 01 00 00  LD64             s1 = *(uint64_t *)(s1 +0x0)
0016  +0x00210  op=58  04 04 00 00  LD64             s4 = *(uint64_t *)(s4 +0x0)
0017  +0x00228  op=58  05 13 00 00  LD64             s19 = *(uint64_t *)(s5 +0x0)
0018  +0x00240  op=58  03 03 00 00  LD64             s3 = *(uint64_t *)(s3 +0x0)
0019  +0x00258  op=58  02 02 00 00  LD64             s2 = *(uint64_t *)(s2 +0x0)
001a  +0x00270  op=85  00 05 00 00  ADD64_IMM16      s5 = s0 +0x0
001b  +0x00288  op=58  06 14 00 00  LD64             s20 = *(uint64_t *)(s6 +0x0)
001c  +0x002a0  op=58  08 16 00 00  LD64             s22 = *(uint64_t *)(s8 +0x0)
001d  +0x002b8  op=58  07 15 00 00  LD64             s21 = *(uint64_t *)(s7 +0x0)
001e  +0x002d0  op=34  05 00 06 00  OR64             s6 = s5 | s0
001f  +0x002e8  op=25  1e 01 20 00  ST64             *(s30 +0x20) = s1
0020  +0x00300  op=53  04 01 58 0c  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xc58 ; q1=0x125fd3a8 rt/so-mapped
0021  +0x00318  op=25  1e 04 08 00  ST64             *(s30 +0x8) = s4
0022  +0x00330  op=25  1e 03 10 00  ST64             *(s30 +0x10) = s3
0023  +0x00348  op=25  1e 02 18 00  ST64             *(s30 +0x18) = s2
0024  +0x00360  op=58  01 17 00 00  LD64             s23 = *(uint64_t *)(s1 +0x0)
0025  +0x00378  op=53  01 01 78 0c  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xc78 ; q1=0x125fd3a8 rt/so-mapped
0026  +0x00390  op=58  01 12 00 00  LD64             s18 = *(uint64_t *)(s1 +0x0)
0027  +0x003a8  op=53  04 01 68 0c  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xc68 ; q1=0x125fd3a8 rt/so-mapped
...
0042  +0x00630  op=34  12 00 04 00  OR64             s4 = s18 | s0
...
005a  +0x00870  op=34  12 00 04 00  OR64             s4 = s18 | s0
005b  +0x00888  op=25  01 02 00 00  ST64             *(s1 +0x0) = s2
005c  +0x008a0  op=5e  56 00 00 00  CALL_CF_INDEX    call native_binding[index=0x56] via q1 table ; q1=0x125fd360 rt/so-mapped
005d  +0x008b8  op=58  15 05 00 00  LD64             s5 = *(uint64_t *)(s21 +0x0)
005e  +0x008d0  op=34  12 00 04 01  OR64             s4 = s18 | s0
005f  +0x008e8  op=5e  57 00 00 00  CALL_CF_INDEX    call native_binding[index=0x57] via q1 table ; q1=0x125fd360 rt/so-mapped
0060  +0x00900  op=58  14 05 00 00  LD64             s5 = *(uint64_t *)(s20 +0x0)
0061  +0x00918  op=58  15 04 00 00  LD64             s4 = *(uint64_t *)(s21 +0x0)
0062  +0x00930  op=5e  57 00 00 00  CALL_CF_INDEX    call native_binding[index=0x57] via q1 table ; q1=0x125fd360 rt/so-mapped
0063  +0x00948  op=58  13 05 00 00  LD64             s5 = *(uint64_t *)(s19 +0x0)
0064  +0x00960  op=58  14 04 00 00  LD64             s4 = *(uint64_t *)(s20 +0x0)
0065  +0x00978  op=5e  57 00 00 00  CALL_CF_INDEX    call native_binding[index=0x57] via q1 table ; q1=0x125fd360 rt/so-mapped
0066  +0x00990  op=58  17 05 00 00  LD64             s5 = *(uint64_t *)(s23 +0x0)
0067  +0x009a8  op=58  13 04 00 00  LD64             s4 = *(uint64_t *)(s19 +0x0)
0068  +0x009c0  op=5e  57 00 00 00  CALL_CF_INDEX    call native_binding[index=0x57] via q1 table ; q1=0x125fd360 rt/so-mapped
0069  +0x009d8  op=58  11 05 00 00  LD64             s5 = *(uint64_t *)(s17 +0x0)
006a  +0x009f0  op=58  17 04 00 00  LD64             s4 = *(uint64_t *)(s23 +0x0)
006b  +0x00a08  op=5e  57 00 00 00  CALL_CF_INDEX    call native_binding[index=0x57] via q1 table ; q1=0x125fd360 rt/so-mapped
...
006f  +0x00a68  op=5e  57 00 00 00  CALL_CF_INDEX    call native_binding[index=0x57] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0073  +0x00ac8  op=5e  57 00 00 00  CALL_CF_INDEX    call native_binding[index=0x57] via q1 table ; q1=0x125fd360 rt/so-mapped
...
009b  +0x00e88  op=18  10 02 01 00  SHL32_IMM        s1 = (int32_t)(s2 << 0)
...
00a4  +0x00f60  op=34  11 00 04 00  OR64             s4 = s17 | s0
