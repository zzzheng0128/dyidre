...
0009  +0x000d8  op=b5  01 01 1b 00  ADD32_IMM16      s1 = int32(s1 +0x1b)
...
0010  +0x00180  op=6e  02 02 0b 02  SHL64_IMM        s11 = s2 << 2
0011  +0x00198  op=34  05 00 0e 01  OR64             s14 = s5 | s0
0012  +0x001b0  op=34  09 00 0d 01  OR64             s13 = s9 | s0
0013  +0x001c8  op=84  08 0b 01 14  ADD64            s1 = s8 + s11
...
001a  +0x00270  op=34  05 00 0f 00  OR64             s15 = s5 | s0
...
0026  +0x00390  op=36  0e 00 0d 00  NOR64            s13 = ~(s14 | s0)
