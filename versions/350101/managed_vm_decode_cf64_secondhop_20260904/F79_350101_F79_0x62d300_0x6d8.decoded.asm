; MetaSec managed bytecode decode: F79
...
000f  +0x00168  op=18  10 10 02 00  SHL32_IMM        s2 = (int32_t)(s16 << 0)
...
002b  +0x00408  op=5e  6b 00 00 00  CALL_CF_INDEX    call native_binding[index=0x6b] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0030  +0x00480  op=34  11 00 05 00  OR64             s5 = s17 | s0
0031  +0x00498  op=5e  6b 00 00 00  CALL_CF_INDEX    call native_binding[index=0x6b] via q1 table ; q1=0x125fd360 rt/so-mapped
...
003b  +0x00588  op=84  12 01 01 14  ADD64            s1 = s18 + s1
