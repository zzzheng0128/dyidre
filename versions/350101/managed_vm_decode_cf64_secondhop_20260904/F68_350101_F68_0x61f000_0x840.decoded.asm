; MetaSec managed bytecode decode: F68
...
001a  +0x00270  op=5e  68 00 00 00  CALL_CF_INDEX    call native_binding[index=0x68] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0050  +0x00780  op=5e  68 00 00 00  CALL_CF_INDEX    call native_binding[index=0x68] via q1 table ; q1=0x125fd360 rt/so-mapped
