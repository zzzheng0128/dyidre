/*
 * Auto-generated linear C-like lift for 350.101 managed program F67.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F67_0x61e600_0x948.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F67_350_linear_lift(ManagedFrame350 *frame)
{
...
L_000c:
    /* +0x00120 op=0x18 11 06 14 00 SHL32_IMM: s20 = (int32_t)(s6 << 0) */
...
L_0010:
    /* +0x00180 op=0x84 10 01 04 00 ADD64: s4 = s16 + s1 */
    S[4] = S[16] + S[1];
...
L_001d:
    /* +0x002b8 op=0x34 11 00 05 00 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];
...
L_0021:
    /* +0x00318 op=0x34 10 00 04 00 OR64: s4 = s16 | s0 */
    S[4] = S[16] | S[0];

L_0022:
    /* +0x00330 op=0x5e 68 00 00 00 CALL_CF_INDEX: call native_binding[index=0x68] via q1 table q1=0x125fd360 */
...
L_0033:
    /* +0x004c8 op=0x09 14 13 14 04 SUB32: s20 = sign_extend_32((uint32_t)s20 - (uint32_t)s19) */
...
L_003b:
    /* +0x00588 op=0x34 11 00 05 01 OR64: s5 = s17 | s0 */
    S[5] = S[17] | S[0];
...
L_003f:
    /* +0x005e8 op=0x5e 68 00 00 00 CALL_CF_INDEX: call native_binding[index=0x68] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x68, (void *)(uintptr_t)0x125fd360);
...
L_0054:
    /* +0x007e0 op=0x34 10 00 04 00 OR64: s4 = s16 | s0 */
    S[4] = S[16] | S[0];
...
L_0056:
    /* +0x00810 op=0x34 12 00 06 00 OR64: s6 = s18 | s0 */
    S[6] = S[18] | S[0];
