; MetaSec managed bytecode decode: F24
...
000c  +0x00120  op=53  03 01 e8 0c  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xce8 ; q1=0x125fd3a8 rt/so-mapped
000d  +0x00138  op=53  04 02 d8 0c  LD_POOL_PTR      s2 = *(uint64_t *)q1 + 0xcd8 ; q1=0x125fd3a8 rt/so-mapped
000e  +0x00150  op=53  03 03 c8 0c  LD_POOL_PTR      s3 = *(uint64_t *)q1 + 0xcc8 ; q1=0x125fd3a8 rt/so-mapped
000f  +0x00168  op=53  04 05 a8 0c  LD_POOL_PTR      s5 = *(uint64_t *)q1 + 0xca8 ; q1=0x125fd3a8 rt/so-mapped
0010  +0x00180  op=34  04 00 10 01  OR64             s16 = s4 | s0
0011  +0x00198  op=53  01 04 b8 0c  LD_POOL_PTR      s4 = *(uint64_t *)q1 + 0xcb8 ; q1=0x125fd3a8 rt/so-mapped
0012  +0x001b0  op=53  01 06 98 0c  LD_POOL_PTR      s6 = *(uint64_t *)q1 + 0xc98 ; q1=0x125fd3a8 rt/so-mapped
0013  +0x001c8  op=53  04 07 88 0c  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0xc88 ; q1=0x125fd3a8 rt/so-mapped
...
0020  +0x00300  op=53  01 01 f8 0c  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xcf8 ; q1=0x125fd3a8 rt/so-mapped
...
0025  +0x00378  op=53  01 01 08 0d  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xd08 ; q1=0x125fd3a8 rt/so-mapped
0026  +0x00390  op=58  01 17 00 00  LD64             s23 = *(uint64_t *)(s1 +0x0)
0027  +0x003a8  op=53  03 01 18 0d  LD_POOL_PTR      s1 = *(uint64_t *)q1 + 0xd18 ; q1=0x125fd3a8 rt/so-mapped
0028  +0x003c0  op=58  01 11 00 00  LD64             s17 = *(uint64_t *)(s1 +0x0)
0029  +0x003d8  op=34  11 00 04 00  OR64             s4 = s17 | s0
...
0048  +0x006c0  op=34  12 00 04 00  OR64             s4 = s18 | s0
...
0050  +0x00780  op=34  12 00 04 00  OR64             s4 = s18 | s0
...
005c  +0x008a0  op=5e  58 00 00 00  CALL_CF_INDEX    call native_binding[index=0x58] via q1 table ; q1=0x125fd360 rt/so-mapped
005d  +0x008b8  op=58  15 05 00 00  LD64             s5 = *(uint64_t *)(s21 +0x0)
005e  +0x008d0  op=34  12 00 04 00  OR64             s4 = s18 | s0
005f  +0x008e8  op=5e  59 00 00 00  CALL_CF_INDEX    call native_binding[index=0x59] via q1 table ; q1=0x125fd360 rt/so-mapped
0060  +0x00900  op=58  14 05 00 00  LD64             s5 = *(uint64_t *)(s20 +0x0)
0061  +0x00918  op=58  15 04 00 00  LD64             s4 = *(uint64_t *)(s21 +0x0)
0062  +0x00930  op=5e  59 00 00 00  CALL_CF_INDEX    call native_binding[index=0x59] via q1 table ; q1=0x125fd360 rt/so-mapped
0063  +0x00948  op=58  13 05 00 00  LD64             s5 = *(uint64_t *)(s19 +0x0)
0064  +0x00960  op=58  14 04 00 00  LD64             s4 = *(uint64_t *)(s20 +0x0)
0065  +0x00978  op=5e  59 00 00 00  CALL_CF_INDEX    call native_binding[index=0x59] via q1 table ; q1=0x125fd360 rt/so-mapped
0066  +0x00990  op=58  17 05 00 00  LD64             s5 = *(uint64_t *)(s23 +0x0)
0067  +0x009a8  op=58  13 04 00 00  LD64             s4 = *(uint64_t *)(s19 +0x0)
0068  +0x009c0  op=5e  59 00 00 00  CALL_CF_INDEX    call native_binding[index=0x59] via q1 table ; q1=0x125fd360 rt/so-mapped
0069  +0x009d8  op=58  11 05 00 00  LD64             s5 = *(uint64_t *)(s17 +0x0)
006a  +0x009f0  op=58  17 04 00 00  LD64             s4 = *(uint64_t *)(s23 +0x0)
006b  +0x00a08  op=5e  59 00 00 00  CALL_CF_INDEX    call native_binding[index=0x59] via q1 table ; q1=0x125fd360 rt/so-mapped
...
006f  +0x00a68  op=5e  59 00 00 00  CALL_CF_INDEX    call native_binding[index=0x59] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0073  +0x00ac8  op=5e  59 00 00 00  CALL_CF_INDEX    call native_binding[index=0x59] via q1 table ; q1=0x125fd360 rt/so-mapped
