/*
 * Auto-generated linear C-like lift for 350.101 managed program F79.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F79_0x62d300_0x6d8.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F79_350_linear_lift(ManagedFrame350 *frame)
{
...
L_002b:
    /* +0x00408 op=0x5e 6b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x6b, (void *)(uintptr_t)0x125fd360);
...
L_0031:
    /* +0x00498 op=0x5e 6b 00 00 00 CALL_CF_INDEX: call native_binding[index=0x6b] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x6b, (void *)(uintptr_t)0x125fd360);
...
L_003b:
    /* +0x00588 op=0x84 12 01 01 14 ADD64: s1 = s18 + s1 */
    S[1] = S[18] + S[1];
