/*
 * Auto-generated linear C-like lift for 350.101 managed program F59.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F59_0x61d200_0x948.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F59_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0022:
    /* +0x00330 op=0x5e 66 00 00 00 CALL_CF_INDEX: call native_binding[index=0x66] via q1 table q1=0x125fd360 */
...
L_003e:
    /* +0x005d0 op=0x34 10 00 04 00 OR64: s4 = s16 | s0 */
    S[4] = S[16] | S[0];

L_003f:
    /* +0x005e8 op=0x5e 66 00 00 00 CALL_CF_INDEX: call native_binding[index=0x66] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x66, (void *)(uintptr_t)0x125fd360);
