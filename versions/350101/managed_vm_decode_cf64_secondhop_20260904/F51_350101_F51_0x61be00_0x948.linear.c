 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F51_0x61be00_0x948.bin
...
L_0010:
    /* +0x00180 op=0x84 10 01 04 04 ADD64: s4 = s16 + s1 */
    S[4] = S[16] + S[1];
...
L_0022:
    /* +0x00330 op=0x5e 64 00 00 00 CALL_CF_INDEX: call native_binding[index=0x64] via q1 table q1=0x125fd360 */
...
L_003f:
    /* +0x005e8 op=0x5e 64 00 00 00 CALL_CF_INDEX: call native_binding[index=0x64] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x64, (void *)(uintptr_t)0x125fd360);
