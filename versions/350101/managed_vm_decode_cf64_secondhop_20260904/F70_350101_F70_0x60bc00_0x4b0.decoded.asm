; MetaSec managed bytecode decode: F70
...
0009  +0x000d8  op=b5  01 01 12 00  ADD32_IMM16      s1 = int32(s1 +0x12)
...
001d  +0x002b8  op=18  11 0e 01 01  SHL32_IMM        s1 = (int32_t)(s14 << 1)
...
0023  +0x00348  op=84  0a 0b 0b 14  ADD64            s11 = s10 + s11
