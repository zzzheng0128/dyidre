/*
 * Auto-generated linear C-like lift for 350.101 managed program F80.
...
void managed_F80_350_linear_lift(ManagedFrame350 *frame)
{
...
L_000f:
    /* +0x00168 op=0x34 04 00 11 01 OR64: s17 = s4 | s0 */
    S[17] = S[4] | S[0];
...
L_0011:
    /* +0x00198 op=0x34 13 00 05 00 OR64: s5 = s19 | s0 */
    S[5] = S[19] | S[0];
...
L_0020:
    /* +0x00300 op=0x34 01 03 03 00 OR64: s3 = s1 | s3 */
    S[3] = S[1] | S[3];
...
L_0022:
    /* +0x00330 op=0xb5 04 04 06 00 ADD32_IMM16: s4 = int32(s4 +0x6) */
    S[4] = (int32_t)((uint32_t)S[4] + 0x6);
...
L_0024:
    /* +0x00360 op=0x34 04 05 05 00 OR64: s5 = s4 | s5 */
    S[5] = S[4] | S[5];

L_0025:
    /* +0x00378 op=0x09 01 04 06 14 SUB32: s6 = sign_extend_32((uint32_t)s1 - (uint32_t)s4) */
...
L_0027:
    /* +0x003a8 op=0x84 07 13 01 04 ADD64: s1 = s7 + s19 */
    S[1] = S[7] + S[19];
...
L_002c:
    /* +0x00420 op=0x18 11 0a 01 01 SHL32_IMM: s1 = (int32_t)(s10 << 1) */
...
L_0030:
    /* +0x00480 op=0x34 05 00 0c 00 OR64: s12 = s5 | s0 */
    S[12] = S[5] | S[0];

L_0031:
    /* +0x00498 op=0x34 08 00 0b 00 OR64: s11 = s8 | s0 */
    S[11] = S[8] | S[0];
...
L_0033:
    /* +0x004c8 op=0x18 00 0b 01 01 SHL32_IMM: s1 = (int32_t)(s11 << 1) */
...
L_0037:
    /* +0x00528 op=0x0d 04 09 01 01 BYTE_FROM_U32_SHIFT: s4 = (uint8_t)((uint32_t)s9 >> (s1 & 31)) */
...
L_0039:
    /* +0x00558 op=0xb3 01 0a 01 00 AND64: s1 = s1 & s10 */
    S[1] = S[1] & S[10];
...
L_003b:
    /* +0x00588 op=0xb3 09 0a 09 01 AND64: s9 = s9 & s10 */
    S[9] = S[9] & S[10];
...
L_003d:
    /* +0x005b8 op=0x84 12 13 09 14 ADD64: s9 = s18 + s19 */
    S[9] = S[18] + S[19];
...
L_0041:
    /* +0x00618 op=0x09 03 02 01 00 SUB32: s1 = sign_extend_32((uint32_t)s3 - (uint32_t)s2) */
...
L_0046:
    /* +0x00690 op=0x5e 4f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x4f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x4f, (void *)(uintptr_t)0x125fd360);
...
L_004a:
    /* +0x006f0 op=0x34 12 00 06 01 OR64: s6 = s18 | s0 */
    S[6] = S[18] | S[0];

L_004b:
    /* +0x00708 op=0x5e 4f 00 00 00 CALL_CF_INDEX: call native_binding[index=0x4f] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x4f, (void *)(uintptr_t)0x125fd360);
...
L_0051:
    /* +0x00798 op=0x53 03 06 d0 09 LD_POOL_PTR: s6 = *(uint64_t *)q1 + 0x9d0 q1=0x125fd3a8 */
...
L_0055:
    /* +0x007f8 op=0xb5 03 03 17 00 ADD32_IMM16: s3 = int32(s3 +0x17) */
    S[3] = (int32_t)((uint32_t)S[3] + 0x17);
...
L_0058:
    /* +0x00840 op=0x09 01 03 05 14 SUB32: s5 = sign_extend_32((uint32_t)s1 - (uint32_t)s3) */
...
L_005d:
    /* +0x008b8 op=0x84 06 09 01 14 ADD64: s1 = s6 + s9 */
    S[1] = S[6] + S[9];
...
L_0067:
    /* +0x009a8 op=0x18 10 0c 01 01 SHL32_IMM: s1 = (int32_t)(s12 << 1) */
...
L_006b:
    /* +0x00a08 op=0x0d 03 0a 01 00 BYTE_FROM_U32_SHIFT: s3 = (uint8_t)((uint32_t)s10 >> (s1 & 31)) */
    S[3] = (uint8_t)((uint32_t)S[10] >> (S[1] & 31));

L_006c:
    /* +0x00a20 op=0x17 05 0a 0a 00 SHL32_VAR: s10 = (int32_t)((uint32_t)s10 << ((uint32_t)s5 & 31)) */
...
L_006e:
    /* +0x00a50 op=0x84 08 09 09 14 ADD64: s9 = s8 + s9 */
    S[9] = S[8] + S[9];

L_006f:
    /* +0x00a68 op=0xb3 0b 01 01 00 AND64: s1 = s11 & s1 */
    S[1] = S[11] & S[1];

L_0070:
    /* +0x00a80 op=0x36 0c 00 0b 01 NOR64: s11 = ~(s12 | s0) */
    S[11] = ~(S[12] | S[0]);

L_0071:
    /* +0x00a98 op=0xb3 0a 0b 0a 00 AND64: s10 = s10 & s11 */
    S[10] = S[10] & S[11];
...
L_007a:
    /* +0x00b70 op=0x02 03 01 01 00 XOR64: s1 = s1 ^ s3 */
    S[1] = S[1] ^ S[3];
...
L_0087:
    /* +0x00ca8 op=0x0e 0b 01 01 08 LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 8) */
...
L_0090:
    /* +0x00d80 op=0x0e 0b 01 01 08 LSR32_IMM: s1 = sign_extend_32((uint32_t)s1 >> 8) */
    S[1] = (int32_t)((uint32_t)S[1] >> 8);
...
L_00a8:
    /* +0x00fc0 op=0x34 1e 00 1d 01 OR64: s29 = s30 | s0 */
    S[29] = S[30] | S[0];
