/*
 * Auto-generated linear C-like lift for 350.101 managed program F50.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F50_0x5e3400_0x3c0.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F50_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0002:
    /* +0x00030 op=0xb5 00 06 c0 ff ADD32_IMM16: s6 = int32(s0 -0x40) q1=0x766e6506 */
    S[6] = (int32_t)((uint32_t)S[0] + (-0x40));

L_0003:
    /* +0x00048 op=0x53 04 07 20 07 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x720 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x720;
...
L_0007:
    /* +0x000a8 op=0xae 0a 03 1f 00 BR_EQ64: if (s10 == s3) goto record +39 q1=0x100000001 */
...
L_0009:
    /* +0x000d8 op=0x6e 02 0a 0b 03 SHL64_IMM: s11 = s10 << 3 */
    S[11] = S[10] << 3;

L_000a:
    /* +0x000f0 op=0x34 02 00 18 00 OR64: s24 = s2 | s0 q1=0x766e6506 */
    S[24] = S[2] | S[0];

L_000b:
    /* +0x00108 op=0xb5 01 01 34 00 ADD32_IMM16: s1 = int32(s1 +0x34) q1=0x32464306 */
    S[1] = (int32_t)((uint32_t)S[1] + 0x34);
...
L_000f:
    /* +0x00168 op=0x58 01 0d 00 00 LD64: s13 = *(uint64_t *)(s1 +0x0) q1=0x400000007 */
...
L_0011:
    /* +0x00198 op=0x34 0f 00 19 01 OR64: s25 = s15 | s0 */
    S[25] = S[15] | S[0];

L_0012:
    /* +0x001b0 op=0xae 19 00 04 00 BR_EQ64: if (s25 == s0) goto record +23 q1=0x766e6506 */
    if (S[25] == S[0]) goto L_0017;

L_0013:
    /* +0x001c8 op=0x6e 00 18 01 01 SHL64_IMM: s1 = s24 << 1 q1=0x3031464308 */
    S[1] = S[24] << 1;
...
L_0017:
    /* +0x00228 op=0x34 02 00 19 01 OR64: s25 = s2 | s0 q1=0x700000008 */
    S[25] = S[2] | S[0];
...
L_0019:
    /* +0x00258 op=0x6e 02 19 01 01 SHL64_IMM: s1 = s25 << 1 */
    S[1] = S[25] << 1;

L_001a:
    /* +0x00270 op=0xb5 0f 0f 01 00 ADD32_IMM16: s15 = int32(s15 +0x1) q1=0x766e6506 */
    S[15] = (int32_t)((uint32_t)S[15] + 0x1);

L_001b:
    /* +0x00288 op=0x33 01 19 01 00 OR_IMM16: s25 = s1 | 0x1 q1=0x36464306 */
    S[25] = S[1] | 0x1;
...
L_001d:
    /* +0x002b8 op=0x66 0c 0d 0c 11 LSR64_VAR: s12 = (uint64_t)s13 >> (s12 & 63) */
...
L_001f:
    /* +0x002e8 op=0x6c 0e 0d 0e 00 SHL64_VAR: s14 = s13 << (s14 & 63) q1=0xa00000001 */
    S[14] = S[13] << (S[14] & 63);

L_0020:
    /* +0x00300 op=0x84 05 0b 0b 14 ADD64: s11 = s5 + s11 */
    S[11] = S[5] + S[11];
...
L_0022:
    /* +0x00330 op=0xb3 0e 01 01 01 AND64: s1 = s14 & s1 q1=0x766e6506 */
    S[1] = S[14] & S[1];

L_0023:
    /* +0x00348 op=0xb3 18 0c 0c 00 AND64: s12 = s24 & s12 q1=0x7970636d656d0c */
    S[12] = S[24] & S[12];
...
L_0027:
    /* +0x003a8 op=0x5b 1f 00 00 00 RET: return/leave with s31 q1=0xd0000000a */
    return; /* RET s31 */
