; MetaSec managed bytecode decode: F74
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F74_0x5e4000_0x3c0.bin
...
0002  +0x00030  op=b5  00 06 c0 ff  ADD32_IMM16      s6 = int32(s0 -0x40)
0003  +0x00048  op=53  04 07 28 08  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0x828 ; q1=0x125fd3a8 rt/so-mapped
0004  +0x00060  op=b5  00 08 40 00  ADD32_IMM16      s8 = int32(s0 +0x40)
0005  +0x00078  op=85  00 09 ff ff  ADD64_IMM16      s9 = s0 -0x1
0006  +0x00090  op=34  02 00 0a 00  OR64             s10 = s2 | s0
0007  +0x000a8  op=ae  0a 03 1f 00  BR_EQ64          if (s10 == s3) goto record +39
0008  +0x000c0  op=52  04 01 40 01  LD32S            s1 = *(int32_t *)(s4 +0x140)
0009  +0x000d8  op=6e  12 0a 0b 03  SHL64_IMM        s11 = s10 << 3
000a  +0x000f0  op=34  02 00 18 00  OR64             s24 = s2 | s0
000b  +0x00108  op=b5  01 01 26 00  ADD32_IMM16      s1 = int32(s1 +0x26)
000c  +0x00120  op=b2  01 0c 3f 00  AND64_IMM16      s12 = s1 & 0x3f
000d  +0x00138  op=84  07 0b 01 00  ADD64            s1 = s7 + s11
000e  +0x00150  op=34  0c 06 0f 01  OR64             s15 = s12 | s6
000f  +0x00168  op=58  01 0d 00 00  LD64             s13 = *(uint64_t *)(s1 +0x0)
0010  +0x00180  op=09  08 0c 0e 14  SUB32            s14 = sign_extend_32((uint32_t)s8 - (uint32_t)s12)
0011  +0x00198  op=34  0f 00 19 01  OR64             s25 = s15 | s0
0012  +0x001b0  op=ae  19 00 04 00  BR_EQ64          if (s25 == s0) goto record +23
0013  +0x001c8  op=6e  00 18 01 01  SHL64_IMM        s1 = s24 << 1
...
0022  +0x00330  op=b3  0e 01 01 01  AND64            s1 = s14 & s1
0023  +0x00348  op=b3  18 0c 0c 00  AND64            s12 = s24 & s12
