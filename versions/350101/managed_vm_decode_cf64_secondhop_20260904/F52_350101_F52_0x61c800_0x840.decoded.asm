...
; source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F52_0x61c800_0x840.bin
...
0015  +0x001f8  op=09  01 03 01 04  SUB32            s1 = sign_extend_32((uint32_t)s1 - (uint32_t)s3)
...
001a  +0x00270  op=5e  64 00 00 00  CALL_CF_INDEX    call native_binding[index=0x64] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0020  +0x00300  op=84  10 01 04 14  ADD64            s4 = s16 + s1
0021  +0x00318  op=b5  00 01 20 00  ADD32_IMM16      s1 = int32(s0 +0x20)
0022  +0x00330  op=09  01 02 01 00  SUB32            s1 = sign_extend_32((uint32_t)s1 - (uint32_t)s2)
...
004a  +0x006f0  op=68  13 03 04 10  LSR64_IMM        s4 = (uint64_t)s3 >> 16
...
004f  +0x00768  op=34  10 00 04 00  OR64             s4 = s16 | s0
0050  +0x00780  op=5e  64 00 00 00  CALL_CF_INDEX    call native_binding[index=0x64] via q1 table ; q1=0x125fd360 rt/so-mapped
