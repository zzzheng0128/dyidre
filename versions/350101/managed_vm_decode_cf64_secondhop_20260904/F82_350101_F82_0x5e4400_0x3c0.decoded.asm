; MetaSec managed bytecode decode: F82
...
0003  +0x00048  op=53  03 07 40 0b  LD_POOL_PTR      s7 = *(uint64_t *)q1 + 0xb40 ; q1=0x125fd3a8 rt/so-mapped
...
0009  +0x000d8  op=6e  00 0a 0b 03  SHL64_IMM        s11 = s10 << 3
000a  +0x000f0  op=34  02 00 18 01  OR64             s24 = s2 | s0
000b  +0x00108  op=b5  01 01 03 00  ADD32_IMM16      s1 = int32(s1 +0x3)
