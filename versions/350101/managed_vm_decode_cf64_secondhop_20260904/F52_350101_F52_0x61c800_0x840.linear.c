...
L_000b:
    /* +0x00108 op=0x84 04 01 01 14 ADD64: s1 = s4 + s1 */
    S[1] = S[4] + S[1];
...
L_0013:
    /* +0x001c8 op=0x84 10 01 04 14 ADD64: s4 = s16 + s1 */
    S[4] = S[16] + S[1];
...
L_0015:
    /* +0x001f8 op=0x09 01 03 01 04 SUB32: s1 = sign_extend_32((uint32_t)s1 - (uint32_t)s3) */
...
L_001a:
    /* +0x00270 op=0x5e 64 00 00 00 CALL_CF_INDEX: call native_binding[index=0x64] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x64, (void *)(uintptr_t)0x125fd360);
...
L_0020:
    /* +0x00300 op=0x84 10 01 04 14 ADD64: s4 = s16 + s1 */
    S[4] = S[16] + S[1];
...
L_004a:
    /* +0x006f0 op=0x68 13 03 04 10 LSR64_IMM: s4 = (uint64_t)s3 >> 16 */
    S[4] = (uint64_t)S[3] >> 16;
...
L_004f:
    /* +0x00768 op=0x34 10 00 04 00 OR64: s4 = s16 | s0 */
    S[4] = S[16] | S[0];

L_0050:
    /* +0x00780 op=0x5e 64 00 00 00 CALL_CF_INDEX: call native_binding[index=0x64] via q1 table q1=0x125fd360 */
    CALL_CF_INDEX(frame, 0x64, (void *)(uintptr_t)0x125fd360);
