; MetaSec managed bytecode decode: F55
...
001e  +0x002d0  op=13  10 13 01 00  CMP_LO64         s1 = ((uint64_t)s16 < (uint64_t)s19) ? 1 : 0
...
0027  +0x003a8  op=84  14 01 04 04  ADD64            s4 = s20 + s1
0028  +0x003c0  op=5e  0e 00 00 00  CALL_CF_INDEX    call native_binding[index=0xe] via q1 table ; q1=0x125fd360 rt/so-mapped
0029  +0x003d8  op=34  12 00 04 00  OR64             s4 = s18 | s0
002a  +0x003f0  op=34  14 00 05 01  OR64             s5 = s20 | s0
002b  +0x00408  op=5e  65 00 00 00  CALL_CF_INDEX    call native_binding[index=0x65] via q1 table ; q1=0x125fd360 rt/so-mapped
002c  +0x00420  op=64  10 13 10 02  SUB64            s16 = s16 - s19
...
002f  +0x00468  op=34  12 00 04 01  OR64             s4 = s18 | s0
0030  +0x00480  op=34  11 00 05 01  OR64             s5 = s17 | s0
0031  +0x00498  op=5e  65 00 00 00  CALL_CF_INDEX    call native_binding[index=0x65] via q1 table ; q1=0x125fd360 rt/so-mapped
