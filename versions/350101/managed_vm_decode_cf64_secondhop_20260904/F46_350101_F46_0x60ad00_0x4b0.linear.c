 ...
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F46_0x60ad00_0x4b0.bin
...
L_0009:
    /* +0x000d8 op=0xb5 01 01 1b 00 ADD32_IMM16: s1 = int32(s1 +0x1b) */
    S[1] = (int32_t)((uint32_t)S[1] + 0x1b);
...
L_0010:
    /* +0x00180 op=0x6e 02 02 0b 02 SHL64_IMM: s11 = s2 << 2 */
    S[11] = S[2] << 2;
...
L_0013:
    /* +0x001c8 op=0x84 08 0b 01 14 ADD64: s1 = s8 + s11 */
    S[1] = S[8] + S[11];
...
L_001a:
    /* +0x00270 op=0x34 05 00 0f 00 OR64: s15 = s5 | s0 */
    S[15] = S[5] | S[0];
...
L_0026:
    /* +0x00390 op=0x36 0e 00 0d 00 NOR64: s13 = ~(s14 | s0) */
    S[13] = ~(S[14] | S[0]);
