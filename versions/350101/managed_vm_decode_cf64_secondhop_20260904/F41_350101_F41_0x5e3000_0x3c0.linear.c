/*
 * Auto-generated linear C-like lift for 350.101 managed program F41.
...
void managed_F41_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0002:
    /* +0x00030 op=0xb5 00 06 c0 ff ADD32_IMM16: s6 = int32(s0 -0x40) q1=0x12274848 */
    S[6] = (int32_t)((uint32_t)S[0] + (-0x40));

L_0003:
    /* +0x00048 op=0x53 03 07 c8 06 LD_POOL_PTR: s7 = *(uint64_t *)q1 + 0x6c8 q1=0x125fd3a8 */
    S[7] = *(uint64_t *)(uintptr_t)0x125fd3a8 + 0x6c8;
...
L_000a:
    /* +0x000f0 op=0x34 02 00 18 01 OR64: s24 = s2 | s0 q1=0x12274848 */
    S[24] = S[2] | S[0];

L_000b:
    /* +0x00108 op=0xb5 01 01 12 00 ADD32_IMM16: s1 = int32(s1 +0x12) */
    S[1] = (int32_t)((uint32_t)S[1] + 0x12);
...
L_0012:
    /* +0x001b0 op=0xae 19 00 04 00 BR_EQ64: if (s25 == s0) goto record +23 q1=0x12274848 */
    if (S[25] == S[0]) goto L_0017;

L_0013:
    /* +0x001c8 op=0x6e 02 18 01 01 SHL64_IMM: s1 = s24 << 1 */
    S[1] = S[24] << 1;
...
L_0019:
    /* +0x00258 op=0x6e 00 19 01 01 SHL64_IMM: s1 = s25 << 1 */
    S[1] = S[25] << 1;

L_001a:
    /* +0x00270 op=0xb5 0f 0f 01 00 ADD32_IMM16: s15 = int32(s15 +0x1) q1=0x12274848 */
...
L_0022:
    /* +0x00330 op=0xb3 0e 01 01 01 AND64: s1 = s14 & s1 q1=0x12274848 */
    S[1] = S[14] & S[1];
