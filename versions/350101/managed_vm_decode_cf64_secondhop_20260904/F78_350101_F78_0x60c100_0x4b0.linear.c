/*
 * Auto-generated linear C-like lift for 350.101 managed program F78.
 * Source: /Users/freeman/project/douyin/unidbg/unidbg-android/target/managed_program_dumps_350101_cf64_secondhop_bodies_20260904/350101_F78_0x60c100_0x4b0.bin
 * This is a mechanical lift, not cleaned structured C.
 */
#include <stdint.h>

void managed_F78_350_linear_lift(ManagedFrame350 *frame)
{
...
L_0005:
    /* +0x00078 op=0x53 01 08 80 08 LD_POOL_PTR: s8 = *(uint64_t *)q1 + 0x880 q1=0x125fd3a8 */
...
L_0009:
    /* +0x000d8 op=0xb5 01 01 11 00 ADD32_IMM16: s1 = int32(s1 +0x11) */
    S[1] = (int32_t)((uint32_t)S[1] + 0x11);
...
L_000c:
    /* +0x00120 op=0x34 03 01 05 01 OR64: s5 = s3 | s1 */
    S[5] = S[3] | S[1];
...
L_000e:
    /* +0x00150 op=0x09 01 03 06 00 SUB32: s6 = sign_extend_32((uint32_t)s1 - (uint32_t)s3) */
...
L_0011:
    /* +0x00198 op=0x34 05 00 0e 00 OR64: s14 = s5 | s0 */
    S[14] = S[5] | S[0];
...
L_0013:
    /* +0x001c8 op=0x84 08 0b 01 04 ADD64: s1 = s8 + s11 */
    S[1] = S[8] + S[11];
...
L_001d:
    /* +0x002b8 op=0x18 00 0e 01 01 SHL32_IMM: s1 = (int32_t)(s14 << 1) */
...
L_0021:
    /* +0x00318 op=0x0d 03 0c 01 11 BYTE_FROM_U32_SHIFT: s3 = (uint8_t)((uint32_t)s12 >> (s1 & 31)) */
    S[3] = (uint8_t)((uint32_t)S[12] >> (S[1] & 31));

L_0022:
    /* +0x00330 op=0x17 06 0c 0c 07 SHL32_VAR: s12 = (int32_t)((uint32_t)s12 << ((uint32_t)s6 & 31)) */
    S[12] = (int32_t)((uint32_t)S[12] << ((uint32_t)S[6] & 31));

L_0023:
    /* +0x00348 op=0x84 0a 0b 0b 00 ADD64: s11 = s10 + s11 */
    S[11] = S[10] + S[11];
...
L_0025:
    /* +0x00378 op=0xb3 0d 01 01 01 AND64: s1 = s13 & s1 */
    S[1] = S[13] & S[1];
...
L_0028:
    /* +0x003c0 op=0x34 0c 01 01 01 OR64: s1 = s12 | s1 */
    S[1] = S[12] | S[1];
