...
0010  +0x00180  op=84  10 01 04 04  ADD64            s4 = s16 + s1
...
0022  +0x00330  op=5e  64 00 00 00  CALL_CF_INDEX    call native_binding[index=0x64] via q1 table ; q1=0x125fd360 rt/so-mapped
...
003f  +0x005e8  op=5e  64 00 00 00  CALL_CF_INDEX    call native_binding[index=0x64] via q1 table ; q1=0x125fd360 rt/so-mapped
