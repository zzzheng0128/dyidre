...
0015  +0x001f8  op=09  01 02 01 14  SUB32            s1 = sign_extend_32((uint32_t)s1 - (uint32_t)s2)
...
002b  +0x00408  op=5e  63 00 00 00  CALL_CF_INDEX    call native_binding[index=0x63] via q1 table ; q1=0x125fd360 rt/so-mapped
...
0031  +0x00498  op=5e  63 00 00 00  CALL_CF_INDEX    call native_binding[index=0x63] via q1 table ; q1=0x125fd360 rt/so-mapped
