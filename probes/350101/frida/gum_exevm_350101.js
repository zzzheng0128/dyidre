...
(function () {
    ...
    function loadGumTrace() {
        ...
        var gumModule;
        try {
            gumModule = Module.load(GUMTRACE_SO, 2, false);
        } catch (e) {
        ...
        try {
            ...
            var gumModule = Module.load(GUMTRACE_SO, 2, false);
            gumModule.getExportByName("init");
    ...
    function waitForTargetModule() {
        ...
        // 兜底：轮询模块加载（System.loadLibrary 可能不走 dlopen）
