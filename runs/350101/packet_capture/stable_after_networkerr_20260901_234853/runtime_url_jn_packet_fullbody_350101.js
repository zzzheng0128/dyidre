globalThis.METASEC_PACKET_CONFIG = {
  "taskName": "stable_after_networkerr_20260901_234853",
  "filterAll": false,
  "captureBodies": true,
...
(function () {
  ...
  function readBytesHex(p, len) {
    try {
      var q = ptr(p);
      if (q.isNull()) return "";
      var ab = q.readByteArray(Number(len || 32));
      if (!ab) return "";
  ...
  function stdStringDebug(p) {
    try {
      ...
      var marker = 0;
      try { marker = s.add(0x17).readU8(); } catch (_) {}
      var p0 = "0";
      var p8 = "0";
      var p16 = "0";
      try { p0 = pointerText(s.readPointer()); } catch (_) {}
      try { p8 = pointerText(s.add(8).readPointer()); } catch (_) {}
      try { p16 = pointerText(s.add(16).readPointer()); } catch (_) {}
      var heap = "";
      try { heap = readCStringSafe(s.readPointer(), 96); } catch (_) {}
      return "out=" + s +
