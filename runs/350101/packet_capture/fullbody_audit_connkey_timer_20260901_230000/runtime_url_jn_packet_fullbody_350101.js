globalThis.METASEC_PACKET_CONFIG = {
  "taskName": "fullbody_audit_connkey_timer_20260901_230000",
  "filterAll": true,
  "captureBodies": true,
...
(function () {
  ...
  var options = {
    ...
    skipWeakerDuplicateUrl: cfg.skipWeakerDuplicateUrl === undefined ? true : !!cfg.skipWeakerDuplicateUrl,
        ...
        try {
          ...
          if (options.captureResponseBody) {
            ...
            if (count > 0) {
              ...
              var req = matchConnection(conn) || ensureRequestForConnection(conn, url, "read") || matchUrl(url) || ensureRequestForUrl(url, "read");
              if (req) {
      ...
      if (options.hookConnections) {
        ...
        try {
          ...
          getOutputStream.impl = function () {
            ...
            try {
              var url = urlFromConnection(this);
              var req = matchConnection(this) || ensureRequestForConnection(this, url, "getOutputStream");
