globalThis.METASEC_PACKET_CONFIG = {
  "taskName": "nativejn_convdebug_20260901_234701",
  "filterAll": false,
  "captureBodies": true,
    ...
    try {
      ...
      Interceptor.attach(convAddr, {
        onEnter: function (args) {
          ...
          this.out = ptr(args[2]);
          this.jniText = readJStringDirect(args[0], args[1], "sscronet.converter." + site);
          if (this.jniText) state.stats.nativeJNDirectStringReads++;
