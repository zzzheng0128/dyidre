globalThis.METASEC_PROBE_CONFIG = {"mode": "packet-capture", "packet": {"uploadUrl": "http://127.0.0.1:8891/up/dy/packets", "version": "35.1.0", "taskName": "e2e_get_token", "maxBodyBytes": 4194304}};
...
function installModuleHooks(m) {
    ...
    try {
        if (typeof Java !== "undefined" && typeof Java.setStealth === "function" &&
    ...
    function hookCronetStreams() {
        try {
            ...
            write.impl = function (bytes, off, len) {
                ...
                try {
                    ...
                    var req = matchUrl(urlFromConnection(conn), currentThreadInfo());
        ...
        try {
            ...
            disconnect.impl = function () {
                try {
                    var req = matchUrl(urlFromConnection(this), currentThreadInfo());
                    if (req) {
