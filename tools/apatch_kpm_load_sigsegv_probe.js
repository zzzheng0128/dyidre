...
// lightweight SIGSEGV/fault observer KPM.  This intentionally does not touch
// wxshadow.kpm or hide-so.kpm.

const KPM_PATH = '/data/local/tmp/sigsegv-probe.kpm';
const KPM_NAME = 'sigsegv-probe';

function log(msg) {
  console.log('[apatch-kpm-load-sigsegv] ' + msg);
}
